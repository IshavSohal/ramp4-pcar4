import { iU as commonjsGlobal, iV as getDefaultExportFromCjs, bB as FixtureInstance, fF as useExportStore, he as markRaw, hf as useAppbarStore } from './main-9f9fefa2.js';
import { f as fabric } from './fabric-116d6a80.js';
import { _ as _sfc_main } from './screen.vue_vue_type_script_setup_true_lang-d362829f.js';
  ...
  async make(canvas, panelWidth) {
    ...
    if (selectedState.footnote && exportFootnoteFixture) {
      fbFootnote = await exportFootnoteFixture.make({
        ...
        // Magic number prevents weird vertical offset between timestamp/footer
