...
import { bG as defineComponent, bH as useI18n, bI as inject, bJ as ref, bK as onMounted, bL as onBeforeUnmount, bM as computed, bN as resolveComponent, bO as resolveDirective, bP as openBlock, bQ as createBlock, bR as withCtx, bS as createTextVNode, bT as toDisplayString, bU as unref, bV as createVNode, bW as withDirectives, bX as createElementBlock, bY as Fragment, bZ as renderList, b_ as defineAsyncComponent } from './main-c2ed9af5.js';
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const legendHeader = defineAsyncComponent(() => __vitePreload(() => import('./header-d0646f24.js'),true?["./header-d0646f24.js","./main-c2ed9af5.js","./preload-helper-a4975f27.js","./main-3acb0f78.css","./header-09bac5de.css"]:void 0,import.meta.url));
    const legendItem = defineAsyncComponent(() => __vitePreload(() => import('./item-6afb43a8.js'),true?["./item-6afb43a8.js","./main-c2ed9af5.js","./preload-helper-a4975f27.js","./main-3acb0f78.css","./marked.esm-4889c960.js","./item-2f08bd79.css"]:void 0,import.meta.url));
    const { t } = useI18n();
