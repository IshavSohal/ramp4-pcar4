import { hX as K, bh as D } from "./main-DMlkVTzO.js";
import { y as X } from "./DoubleArray-CLlpNm2K.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-BJSP4i_U.js";
import { n as Z, s as ee } from "./vec3-WWiYV0HW.js";
import "./sphere-Bky2ifyA.js";
import "./I3SUtil-BNFVV5pM.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-D2wAIIT-.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-DMlkVTzO.js").then((d) => d.qK), import("./main-DMlkVTzO.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-BQJRSpAH.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-4Hvbl_-N.js.map
