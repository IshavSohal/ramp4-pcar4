import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-DMlkVTzO.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-BsK34SQI.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-CNTOW_lc.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-fwKjR-dX.js")).default, n = (await import("./index-ByPg0yV1.js")).default, a = (await import("./index-Cgh5cgoA.js")).default, w = (await import("./index-Ct-9LK3y.js")).default, p = (await import("./index-DHYkK2Mh.js")).default, r = (await import("./index-NlIQOiV_.js")).default, b = (await import("./index-DtCqqK27.js")).default;
...
//# sourceMappingURL=index-DVN-Bqdb.js.map
