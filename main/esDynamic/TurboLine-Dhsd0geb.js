import { af as le, hX as ue } from "./main-DMlkVTzO.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-D20YBfEu.js").then((i) => i.l) : await import("./libtess-B2KwlK4-.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-Dhsd0geb.js.map
