import { hX as T } from "./main-DV_EzzVs.js";
...
function y() {
  return new Promise((t) => import("./lyr3DWorker-k4IJNMcN.js").then((r) => r.l).then(({ default: r }) => {
...
//# sourceMappingURL=Lyr3DWorker-CblONmvi.js.map
