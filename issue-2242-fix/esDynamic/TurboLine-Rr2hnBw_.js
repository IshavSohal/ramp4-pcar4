import { af as le, hX as ue } from "./main-DV_EzzVs.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-ZCNTnTJO.js").then((i) => i.l) : await import("./libtess-BuD6LcTn.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-Rr2hnBw_.js.map
