import { am as m, au as d, a2 as u, K as w, s as p } from "./main-DV_EzzVs.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-DszwOB7Q.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-J9z2Tam5.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-CCuzBgMw.js.map
