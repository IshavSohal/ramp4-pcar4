import { hX as K, bh as D } from "./main-DV_EzzVs.js";
import { y as X } from "./DoubleArray-BU6p8CJJ.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-DlmYj42Y.js";
import { n as Z, s as ee } from "./vec3-Ba39VSv4.js";
import "./sphere-BK8jxICP.js";
import "./I3SUtil-3AM9Utj1.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-Dz0pfJdE.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-DV_EzzVs.js").then((d) => d.qK), import("./main-DV_EzzVs.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-C9Hviwdb.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-CD-OnSef.js.map
