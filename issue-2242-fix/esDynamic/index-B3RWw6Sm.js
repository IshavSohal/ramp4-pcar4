import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-DV_EzzVs.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-DTG2tMk2.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-DywCiUzH.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-ajym6Iv3.js")).default, n = (await import("./index-CsCRI6Mq.js")).default, a = (await import("./index-CMYFs4AP.js")).default, w = (await import("./index-B5838Ib4.js")).default, p = (await import("./index-DmhiTZtJ.js")).default, r = (await import("./index-DPbPjJRk.js")).default, b = (await import("./index-DPOjLgZh.js")).default;
...
//# sourceMappingURL=index-B3RWw6Sm.js.map
