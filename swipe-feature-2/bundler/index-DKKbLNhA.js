import { defineComponent as S, inject as B, useTemplateRef as A, ref as u, computed as m, onBeforeMount as R, onMounted as M, onBeforeUnmount as P, resolveDirective as T, openBlock as k, createElementBlock as z, createElementVNode as g, normalizeStyle as H, withDirectives as N, unref as F, vModelText as O } from "vue";
import { F as _, a as V, G as h, _ as W } from "./main-CHB78utI.js";
import "pinia";
import "vue-i18n";
import "screenfull";
...
import "svg.js";
import "tiny-emitter";
const D = { class: "swipe-container" }, G = ["id", "aria-valuenow", "aria-label", "content"], U = ["swipe-position", "view"], Y = /* @__PURE__ */ S({
  __name: "swipe",
  props: {
    fixture: {
      type: _,
  ...
  setup(b) {
    const o = B("iApi"), d = V(), t = A("slider"), c = u(45), v = u(0), p = u(0), f = u(50), y = u(), i = u(), x = m(() => {
    ...
    }), $ = m(() => `${v.value}px`), C = m(() => `${-v.value / 2 - 18}px`);
    R(() => {
    ...
    return P(() => {
      ...
      return k(), z("div", D, [
        g("div", {
          class: "verticalLine",
          style: H({ left: x.value, height: $.value, bottom: C.value })
        }, null, 4),
        N(g("input", {
...
}), j = /* @__PURE__ */ W(Y, [["__scopeId", "data-v-762c0bab"]]);
class Re extends _ {
  async added() {
