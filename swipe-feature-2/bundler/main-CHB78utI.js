...
import { ref as h, computed as P, markRaw as ee, defineComponent as O, inject as ge, reactive as Ae, watch as xt, onBeforeUnmount as dt, resolveDirective as k, withDirectives as M, openBlock as v, createElementBlock as w, withKeys as ns, withModifiers as Xt, onMounted as Ye, normalizeClass as ae, normalizeStyle as Ci, createVNode as oe, Transition as Oi, withCtx as ie, createBlock as W, resolveDynamicComponent as ls, mergeProps as cs, useCssVars as us, TransitionGroup as ki, Fragment as je, renderList as ht, unref as I, nextTick as $t, renderSlot as ke, createElementVNode as m, vShow as ps, resolveComponent as Q, createTextVNode as at, toDisplayString as B, createCommentVNode as U, onUpdated as ds, Teleport as hs, getCurrentInstance as fs, useTemplateRef as di, createApp as Mi, toRaw as Se, h as ms, render as Bt, defineAsyncComponent as ys } from "vue";
...
import { applyConverter as Is } from "@terraformer/spatial";
import ne from "proj4";
import { debounce as It, throttle as it } from "throttle-debounce";
import { createI18n as _s, useI18n as Y } from "vue-i18n";
...
class Ue extends de {
  ...
  static fromESRI(e, t) {
    return new Ue(t, e.paths[0], _.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    return new Pi({
      paths: [this.toArray()],
  ...
  static fromGeoJSON(e, t) {
    return new Ue(t, e.coordinates, _.fromGeoJSON(e.crs), !0);
  }
  toGeoJSON() {
...
class re extends Je {
  ...
  constructor(e, t, i, s) {
    super(e, t.sr || i), s ? this.rawArray = re.arrayDeepCopy(t) : this.rawArray = re.parsePolygon(t);
  }
  addLinearRings(e) {
...
class Ce extends Je {
  ...
  static fromESRI(e, t) {
    return new Ce(t, [e.rings], _.fromESRI(e.spatialReference), !0);
  }
  toESRI() {
    const e = [];
...
class De extends Oe {
  ...
  constructor(e) {
    if (e = e || { style: Re.CIRCLE }, super(), this._style = e.style || Re.CIRCLE, e.style === Re.ICON) {
      const t = e;
      this._icon = t.icon || "", this._height = Oe.convToPoints(t.height) || 16.5, this._width = Oe.convToPoints(t.width) || 16.5, this._size = 0, this._colour = new Me(), this._outline = new _e(), this._path = "";
    } else {
      const t = e;
      this._size = Oe.convToPoints(t.size) || 12, this._colour = new Me(t.colour ?? "#ffffff40"), this._outline = new _e(t.outline), this._path = this._style === Re.PATH && t.path || "", this._height = 0, this._width = 0, this._icon = "";
    }
...
class yt extends Oe {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new Me(e.fill.colour), this._fillStyle = e.fill.style || Ui.SOLID, this._outlineStyle = new _e(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
...
class Ds {
  ...
  async projectGeoJson(e, t, i) {
    let s, o;
    if (t ? s = this.normalizeProj(t) : s = _.parseGeoJsonCrs(e.crs), i ? o = this.normalizeProj(i) : o = Fs, o === s)
      return e;
  ...
  async projectExtent(e, t) {
    ...
    const a = new re("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), g = Math.min.apply(null, u), f = Math.max.apply(null, u);
    return G.fromParams(t.id + "_projected", p, g, d, f, l.sr);
  }
}
class Gs {
  // useful functions
...
const Lt = z("appbar", () => {
  ...
  function n(p, d) {
    ...
    const g = t.value.findIndex((f) => f === p.id);
  ...
  function c(p) {
    ...
    if (r.value = d, p.mapLayer) {
      const g = t.value.filter((f) => f !== p.id);
      t.value = g;
    }
  }
  function u(p) {
  ...
  function n(c, u) {
    ...
    if (d.length) {
      const g = d[0];
      u.forEach((f) => {
        const y = d.includes(f) ? f : g;
        i.value[f] = p[y], s.value[f] = y;
      });
    } else
  ...
  function i(a) {
    if (r.value = { ...r.value, [a.id]: ee(a) }, a.id in e.value)
...
const Rt = z("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Rt(), t = ge("iApi"), i = P(() => e.maptipPoint), s = P(() => e.maptipInstance), o = P(() => e.content), a = Ae([]), l = h(!1);
    a.push(
      xt(i, () => {
        if (i.value) {
...
const Zs = ["data-cy"], Wi = /* @__PURE__ */ O({
    ...
    return (n, c) => {
      ...
      return v(), w("div", {
        ...
        oe(Oi, {
          ...
          default: ie(() => [
            M((v(), W(ls(r.panel.route.screen), cs({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  function K() {
    ...
    for (let Ne = n.value.length - 1; Ne >= 0; Ne--) {
      const et = n.value[Ne];
      let Le = et.width || he;
      if (s.value ? Le = S : Le += Xe, et.id === "grid" && (Le = Math.max(Math.min(Le, S), ui)), (S >= Le && !s.value || R.length === 0) && (S -= Le, R.unshift(et)), et.id === "grid" && S < ui)
        break;
    }
    if (r.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(r.value) && !s.value) {
      let Ne;
      for (let pi = 0; pi < R.length - 1 && S < (r.value.width || he) + Xe; pi++)
        Ne = R.shift(), S += Ne.width || he;
      S >= (r.value.width || he) ? R.unshift(r.value) : e.value || (Ne = R.shift(), R.unshift(r.value));
  ...
  function Ft(S, R) {
    const he = n.value.indexOf(S), Xe = R === "right" ? 1 : -1;
  ...
  setup(r) {
    ...
    return (u, p) => (v(), W(ki, {
      ...
      default: ie(() => [
        (v(!0), w(je, null, ht(a(I(t).screenSize), (d) => (v(), W(Wi, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Qs = /* @__PURE__ */ Pe(Ks, [["__scopeId", "data-v-068bb8d9"]]), Xs = ["content", "aria-label"], ii = /* @__PURE__ */ O({
...
}), er = { class: "h-full flex flex-col" }, tr = { class: "w-full flex mb-6" }, ir = ["content", "aria-label"], sr = /* @__PURE__ */ O({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(r) {
    ...
    return (o, a) => {
      ...
      return v(), W(l, { panel: r.panel }, {
        header: ie(() => [
          at(B(I(t)("notifications.title")), 1)
        ]),
        content: ie(() => [
          m("div", er, [
            m("div", tr, [
  ...
  setup(r) {
    ...
    return (n, c) => {
      ...
      return M((v(), w("li", {
        ...
        content: I(t)(s.value ? "notifications.controls.collapse" : "notifications.controls.expand"),
        onClick: c[1] || (c[1] = (p) => s.value = !s.value)
      }, [
        m("div", ar, [
          m("span", null, [
            at(B(o[r.notification.type]) + " ", 1),
            m("span", nr, B(r.notification.message), 1)
          ]),
        ...
        r.notification.messageList && s.value ? (v(), w("div", cr, [
          (v(!0), w(je, null, ht(r.notification.messageList, (p, d) => (v(), w("p", {
    ...
    return (l, n) => {
      ...
      return v(), w("div", null, [
        a.value.length > 0 ? M((v(), w("ul", {
          ...
          (v(!0), w(je, null, ht(a.value, (d, g) => (v(), w(je, {
            key: d.message + g
          }, [
            g > 0 ? (v(), w("div", dr)) : U("", !0),
            M(oe(ur, {
...
}, gr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, vr = { class: "pb-8 border-b border-gray-600" }, br = { class: "absolute flex right-3 top-3" }, Ar = ["content", "aria-label"], wr = /* @__PURE__ */ O({
      ...
      return v(), W(ii, {
        ...
        header: ie(() => [
          m("div", fr, [
            ...
            i.value && i.value > 0 ? (v(), w("span", yr, B(i.value), 1)) : U("", !0)
          ])
        ]),
        default: ie((c) => [
          m("div", gr, [
            m("div", null, [
              m("h4", vr, B(I(t)("notifications.title")), 1),
              m("div", br, [
                M((v(), w("button", {
                  type: "button",
                  onClick: s,
...
}), Er = /* @__PURE__ */ Pe(wr, [["__scopeId", "data-v-3623a7d2"]]), xr = { class: "flex hover:text-white" }, Sr = ["aria-label"], Ir = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, _r = ["aria-label", "content"], Tr = { class: "pb-8 border-b border-gray-600 mb-10" }, Lr = { class: "absolute right-5 top-5" }, Rr = { class: "select-text" }, $r = { class: "font-bold cursor-text" }, Cr = { class: "text-sm cursor-text" }, Or = { class: "text-sm cursor-text" }, kr = /* @__PURE__ */ O({
        ...
        default: ie((g) => [
          m("div", Ir, [
            m("div", null, [
              ...
              m("div", Rr, [
                m("div", null, [
                  m("span", $r, B(s.value), 1),
                  m("span", Cr, " [" + B(o.value) + "] ", 1)
                ]),
                m("div", null, [
                  m("span", Or, B(a.value), 1)
                ]),
...
}, zr = ["aria-pressed", "aria-label", "content"], Vr = { class: "relative top-1 text-sm sm:text-base" }, qr = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, jr = ["onClick"], Wr = {
  key: 0,
  class: "sr-only"
}, Hr = /* @__PURE__ */ O({
  __name: "map-caption",
  setup(r) {
    const e = Ge(), t = pe(), { t: i } = Y(), s = ge("iApi"), o = P(() => e.scale), a = P(() => e.attribution), l = P(() => e.coords), n = P(() => e.langtoggle), c = P(() => t.config.map), u = h([]), p = Ae([]);
    p.push(
      xt(c, (A) => {
    ...
    return (A, b) => {
      ...
      return v(), w("div", Pr, [
        ...
        a.value?.text.disabled ? U("", !0) : M((v(), w("span", Gr, [
        ...
        m("div", Ur, [
          l.value?.disabled ? U("", !0) : M((v(), w("div", Br, [
          ...
          o.value?.disabled ? U("", !0) : M((v(), w("button", {
            key: 1,
            type: "button",
          ...
          n.value?.disabled ? U("", !0) : (v(), W($, {
            ...
            header: ie(() => [
              m("span", qr, B(I(i)("map.language.short")), 1)
            ]),
            default: ie(() => [
              (v(!0), w(je, null, ht(u.value, (F, K) => (v(), w("a", {
                key: `${F}-${K}`,
                class: ae(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": F === I(s).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (Qe) => g(F)
              }, [
                at(B(I(i)("map.language." + F)) + " ", 1),
                F === I(s).$i18n.locale.value ? (v(), w("span", Wr, B(I(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, jr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (o, a) => {
      ...
      return M((v(), w("button", {
        ...
        s.value && s.value > 0 ? (v(), w("span", Jr, B(s.value), 1)) : U("", !0)
      ], 8, Yr)), [
        [l]
      ]);
    };
  }
}), Kr = /* @__PURE__ */ Pe(Zr, [["__scopeId", "data-v-a451db5c"]]), Qr = { class: "flex items-center mb-20" }, Xr = { class: "text-xl" }, eo = /* @__PURE__ */ O({
    ...
    return (c, u) => {
      ...
      return i.value ? (v(), w("div", {
        ...
        m("div", {
          ...
          m("div", Qr, [
            m("h2", Xr, B(I(t)("keyboardInstructions.title")), 1),
            oe(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (v(!0), w(je, null, ht(s.value, (d) => (v(), w("p", {
      ...
      m("div", io, [
        ...
        m("div", so, [
          m("button", {
            ...
            onClick: l
          }, B(I(o)("keyboardInstructions.open")), 1)
        ]),
        oe(eo),
        ...
        a.value ? U("", !0) : (v(), W(Kr, { key: 0 })),
        oe(Hr, { class: "z-30" })
      ]),
      I(t).started ? (v(), W(Ys, { key: 0 })) : (v(), w("div", ro, u[1] || (u[1] = [
        m("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (v(!0), w(je, null, ht(n(), (p) => (v(), W(hs, {
...
}), ao = /* @__PURE__ */ Pe(oo, [["__scopeId", "data-v-7a1e48c2"]]), no = O({
  name: "App",
  components: { Shell: ao },
  setup() {
    const r = fs();
...
const po = /* @__PURE__ */ Pe(no, [["render", uo]]), xe = "focus-list", Ve = "focus-item", ho = "focus-icon", fo = "focus-container", ct = `[${xe}],[${fo}]`, bt = "truncate-text", At = "show-truncate", ot = "focused", Zt = `button,input,select,a,textarea,[contenteditable],[${xe}],[${ho}],[tabIndex]`, mo = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(xe, !0), new yo(r, e.value);
  },
  updated(r) {
    Ji(r);
  }
...
const Ao = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && qt.push(new wo(r));
  },
  beforeUnmount(r) {
    qt = qt.filter((e) => e.element === r ? (e.removeEventListeners(), !1) : !0);
  }
};
class wo {
  element;
...
const _o = ["content"], To = {
  ...
  setup(r, { expose: e }) {
    ...
    e({ el: a });
    const c = r, u = P(() => o?.fixture.get("appbar") ? s.temporary : []), p = P(() => i.mobileView), d = P(() => i.reorderable), g = (b) => b.scrollHeight > b.clientHeight, f = () => !p.value && !c.panel.teleport, y = (b) => {
    ...
    return Ye(() => {
      ...
      const T = Q("back"), N = Q("panel-options-menu"), F = Q("left"), K = Q("right"), Qe = Q("pin"), Pt = Q("expand"), Nt = Q("minimize"), Ft = Q("close"), Dt = k("truncate"), Gt = k("focus-item"), S = k("tippy");
      return M((v(), w("div", {
        ...
        r.header ? (v(), w("header", To, [
          oe(T, {
            class: ae(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (R) => r.panel.close())
          }, null, 8, ["class"]),
          M((v(), w("h2", Lo, [
            b.$slots.header ? ke(b.$slots, "header", { key: 0 }) : (v(), w("div", Ro, B(I(t)(r.panel.alertName)), 1))
          ])), [
            [Dt]
          ]),
          ...
          m("div", {
            ...
            r.panel.teleport ? U("", !0) : (v(), w("div", $o, [
              d.value ? (v(), W(F, {
                key: 0,
        ...
        r.content ? (v(), w("div", {
          ...
          b.$slots.content ? ke(b.$slots, "content", { key: 0 }) : A.value ? (v(), w("div", {
            key: 1,
            innerHTML: A.value.innerHTML
          }, null, 8, Co)) : U("", !0)
        ], 512)) : U("", !0),
        r.footer ? M((v(), w("div", Oo, [
          ke(b.$slots, "footer")
        ])), [
          [Gt]
        ]) : U("", !0)
...
}), Mo = { class: "relative" }, Po = ["content", "aria-label"], No = ["transform"], Fo = /* @__PURE__ */ O({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), Bo = { class: "relative" }, zo = ["content", "aria-label"], Vo = /* @__PURE__ */ O({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), qo = { class: "w-32 h-32" }, jo = ["content", "aria-label"], Wo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), ta = { class: "relative" }, ia = ["content", "aria-label"], sa = /* @__PURE__ */ O({
  __name: "left",
  props: {
    active: Boolean
  },
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return v(), W(a, {
        ...
        default: ie(() => [
          I(t).isFullscreen ? (v(), w("svg", aa, o[0] || (o[0] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, da = ["content", "aria-label"], ha = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, ma = ["aria-label", "content"], ya = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(r) {
    const e = ge("iApi"), t = r, i = () => e?.event.emit(E.APPBAR_BUTTON_CLICK, t.buttonId);
    return (s, o) => {
...
}), ga = /* @__PURE__ */ Pe(ya, [["__scopeId", "data-v-f0341fec"]]), va = z("areas-of-interest", () => ({ areas: h([]) })), ba = z("export", () => {
  const r = h({
    title: !0,
    map: !0,
    mapElements: !0,
...
class Si {
   ...
   */
  query(e) {
    return _a(this.config, e.toUpperCase()).onComplete.then((t) => {
      let i = [];
...
const Pa = z("legend", () => {
  ...
  function o(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof _i) && !(n.item instanceof Fe)) {
...
var se = /* @__PURE__ */ ((r) => (r[r.UPLOAD = 0] = "UPLOAD", r[r.FORMAT = 1] = "FORMAT", r[r.CONFIGURE = 2] = "CONFIGURE", r))(se || {});
const Ba = z("wizard", () => {
  const r = {
    id: "Placeholder",
    layerType: x.UNKNOWN,
  ...
  function n(c) {
    switch (l.value) {
      case se.UPLOAD:
        ...
        break;
      case se.FORMAT:
        c === se.UPLOAD ? (o.value && (t.value = "", o.value = null), i.value = "", l.value = se.UPLOAD) : c === se.CONFIGURE && (l.value = se.CONFIGURE);
        break;
      case se.CONFIGURE:
        c === se.UPLOAD ? (t.value = "", i.value = "", o.value = null, s.value = !0, a.value = {
          config: r,
          configOptions: []
        }, l.value = se.UPLOAD) : c === se.FORMAT && (a.value = {
          config: r,
          configOptions: []
        }, s.value = !0, l.value = se.FORMAT);
        break;
    }
  }
  return {
...
class za {
  ...
  constructor(e, t, i) {
    ...
    const s = Va(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new Dn(this), this.panel = new Gn(this), this.geo = new Nn(this), this.dev = new jn(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new rr(this), this._isFullscreen = Ee.isEnabled && !!this.$vApp.$root && Ee.isFullscreen && Ee.element === this.$vApp.$root.$el, Ee.isEnabled && Ee.onchange(() => {
  ...
  initialize(e, t, i) {
    ...
    if (t?.configs !== void 0) {
      ...
      this.ui.getZoomIcon = () => g, this.ui.formatNumber = (f) => this.ui.suppressNumberLocalization ? f.toString() : this.$i18n.n(f, "number"), this.ui.escapeHtml = (f) => {
        const y = {
          "<": "&lt;",
          ">": "&gt;",
          '"': "&quot;",
   ...
   */
  reloadWorker(e, t) {
    const i = st(this.$vApp.$pinia), s = Te(this.$vApp.$pinia), o = pe(this.$vApp.$pinia), a = ye(this.$vApp.$pinia), l = Ie(this.$vApp.$pinia), n = Yt(this.$vApp.$pinia), c = !!e;
    ...
    if (e ? (e.logo ? e.logo.disabled ? s.logo.disabled = !0 : (s.logo.altText = e.logo.altText || i.altText, s.logo.link = e.logo.link || i.link, s.logo.value = e.logo.value || i.value) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value), e.text ? e.text.disabled ? s.text.disabled = !0 : s.text.value = e.text.value || t.value : s.text.value = t.value, Ge(this.$vApp.$pinia).setAttribution(s)) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value, s.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      if (n) {
        const c = n.baseLayers.map((u) => new Promise((p) => {
          let d = 0;
          const g = a / l, f = setInterval(function() {
            u.loaded && !u.loadError ? (clearInterval(f), p(u)) : d > g && (clearInterval(f), p(null)), d++;
          }, l);
        })).toArray();
...
class Ha extends qa {
   ...
   */
  constructor(e) {
    super(e, "main"), this.maptip = new ja(e), this.caption = new Wa(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, s) => {
      if (this.esriMap || (this.noMapErr(), s()), e.initiationState !== D.INITIATING && e.initiationState !== D.INITIATED && e.layerState !== q.ERROR && e.initiate(), e.mapLayer && t === void 0) {
      ...
      let l = 0;
      const n = setInterval(() => {
        l += 250, l >= e.expectedTime.fail || e.layerState === q.ERROR ? (clearInterval(n), e.lastCancel < a && console.error(`Failed to add layer: ${e.id}.`), s()) : e.initiationState === D.INITIATED && (e.esriLayer || !e.mapLayer) && (clearInterval(n), e.mapLayer ? this.insertToEsriMap(e) : e.onLoad(), i());
      }, 250);
    });
  }
  /**
  ...
  */
  ...
  runIdentify(e) {
    ...
    t.some((c) => c.identifyMode === X.HYBRID || c.identifyMode === X.SYMBOLIC) && (s = this.symbolIdentify(i.screenX, i.screenY));
    const o = {
      geometry: i.mapPoint,
      hitTest: s
...
class on extends J {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    s || (s = _.parseGeoJsonCrs(e.crs)), a.renderer = await C.RendererFromJson(c.renderer), a.fields = (a.fields || []).concat(
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, o = {
    ...
    if (o.features = o.features.concat(d.features), d.features.length < t - i) {
      ...
      return a && o.features.length > 0 && o.features[0].geometry.type === V.POINT && o.features.forEach((g) => {
        ...
        g.properties.rvInternalCoordX = f[0], g.properties.rvInternalCoordY = f[1];
      }), o;
  }
  /**
...
class ln extends J {
  ...
  async loadLayerMetadata(e) {
    ...
    if (o.name = s.name || "", o.currentVersion = s.currentVersion || -1, o.minScale = s.effectiveMinScale || s.minScale || 0, o.maxScale = s.effectiveMaxScale || s.maxScale || 0, o.extent = s.extent ? G.fromArcServer(s.extent, "layer_extent") : void 0, o.defaultVisibility = s.defaultVisibility ?? !0, o.canModifyLayer = s.canModifyLayer ?? !0, s.type === "Feature Layer" || s.type === "Table") {
      if (o.dataFormat = te.ESRI_FEATURE, o.displayField = s.displayField || "", Array.isArray(s.fields)) {
        const a = await Promise.all(
          s.fields.map((n) => C.FieldFromJson(n))
        );
        o.fields = a.map((n) => ({
          name: n.name,
          alias: n.alias,
    ...
    if (t.getGeom) {
      ...
      if (u)
        ...
        if (d.features.length) {
          const g = d.features[0], f = this.$iApi.geo.geom.geomEsriToRamp(g.geometry);
  ...
  onLoadActions() {
    ...
    const o = [], a = (n, c) => {
      ...
      if (n.sublayers && n.sublayers.length > 0) {
        ...
        c.findChildByIdx(u) || c.children.push(g), n.sublayers.reverse().forEach((f) => {
          a(f, g);
        });
      } else {
...
class es extends Xi {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = te.ESRI_FEATURE, this.layerFormat = me.NOLAYER, this.drawState = ue.NOT_VISUAL, this.attribs = new ts(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
...
class Mn extends J {
  ...
  async symbolToSvg(e) {
    ...
    const o = tt(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
      ...
      "picture-fill"() {
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(f).then((N) => {
          const F = o.pattern(
            y,
            A,
            (K) => (
  ...
  async mapServerLegendToRenderer(e, t) {
    ...
    if (typeof i < "u") {
      ...
      const o = await C.RendererFromJson(s);
...
const Fn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-SqQQ9nQI.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-Brc90Gep.js"), "../fixtures/basemap/index.ts": () => import("./index-B5nh8xk6.js"), "../fixtures/crosshairs/index.ts": () => import("./index-CC9brC8a.js"), "../fixtures/details/index.ts": () => import("./index-BAFIfGRB.js"), "../fixtures/export-footnote/index.ts": () => import("./index-BFSAGbSN.js"), "../fixtures/export-legend/index.ts": () => import("./index-DTyICp_9.js"), "../fixtures/export-map/index.ts": () => import("./index-Cib_1G8i.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-CbnoumH2.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-92P35ah0.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-DMK3ZHe_.js"), "../fixtures/export-title/index.ts": () => import("./index-Df69Y7CT.js"), "../fixtures/export/index.ts": () => import("./index-nkH-e1Gn.js"), "../fixtures/extentguard/index.ts": () => import("./index-CpJBg05h.js"), "../fixtures/gazebo/index.ts": () => import("./index-QYor4VmT.js"), "../fixtures/geosearch/index.ts": () => import("./index-DHb-rM6o.js"), "../fixtures/grid/index.ts": () => import("./index-xZrqEvrg.js"), "../fixtures/help/index.ts": () => import("./index-CWZ9sucK.js"), "../fixtures/hilight/index.ts": () => import("./index-DqlhE-Wq.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-CnRBAfw7.js"), "../fixtures/legend/index.ts": () => import("./index-uEyXzWJS.js"), "../fixtures/mapnav/index.ts": () => import("./index-C0AZIrQH.js"), "../fixtures/metadata/index.ts": () => import("./index-DnRNdRb0.js"), "../fixtures/northarrow/index.ts": () => import("./index-CUBxpoEd.js"), "../fixtures/overviewmap/index.ts": () => import("./index-ac-nwzWZ.js"), "../fixtures/panguard/index.ts": () => import("./index-ByBHoBak.js"), "../fixtures/scrollguard/index.ts": () => import("./index-DrZoiM8w.js"), "../fixtures/settings/index.ts": () => import("./index-CS_XixMU.js"), "../fixtures/snowman/index.ts": () => import("./index-CnVvcuqv.js"), "../fixtures/swipe/index.ts": () => import("./index-DKKbLNhA.js"), "../fixtures/wizard/index.ts": () => import("./index-CiLuPPk9.js") });
class Dn extends J {
  /**
...
const Vn = /* @__PURE__ */ Pe(Bn, [["render", zn], ["__scopeId", "data-v-a3c61802"]]), qn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-D3fVILrL.js"), "../fixtures/basemap/screen.vue": () => import("./screen-DMrppMN6.js"), "../fixtures/export/screen.vue": () => import("./screen-BD0VeuNv.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-BLS5CjPk.js"), "../fixtures/grid/screen.vue": () => import("./screen-DcA5bAzJ.js"), "../fixtures/help/screen.vue": () => import("./screen-piCc_pY-.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-Cmc7Ngs7.js"), "../fixtures/legend/screen.vue": () => import("./screen-Cc4imd1X.js"), "../fixtures/metadata/screen.vue": () => import("./screen-i2q-RQrG.js"), "../fixtures/settings/screen.vue": () => import("./screen-D_yGuHcH.js"), "../fixtures/wizard/screen.vue": () => import("./screen-TpDKpCVQ.js") });
class Et extends J {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (Bs(t) || Us(t))
      ...
      let s;
      typeof t == "string" ? s = qn[`../fixtures/${t}`]() : s = t();
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Wed May 28 13:39:34 2025 -0400", hash: "8d51cc02071b57110216d48547a234dfd4d22f7a" };
console.info(
...
const Gl = (r, e, t) => new za(r, e, t), ut = new Gs();
export {
  j as $,
  Mr as A,
  yt as B,
