import { TinyEmitter as rs } from "tiny-emitter";
import { defineStore as z, createPinia as os } from "pinia";
import { ref as h, computed as O, markRaw as re, defineComponent as C, inject as we, reactive as ve, watch as Et, onBeforeUnmount as ut, resolveDirective as M, withDirectives as P, openBlock as g, createElementBlock as A, withKeys as as, withModifiers as Qt, onMounted as He, normalizeClass as ae, normalizeStyle as $i, createVNode as oe, Transition as Ci, withCtx as te, createBlock as W, resolveDynamicComponent as ns, mergeProps as ls, useCssVars as cs, TransitionGroup as Oi, Fragment as je, renderList as pt, unref as _, nextTick as Rt, renderSlot as Oe, createElementVNode as f, vShow as us, resolveComponent as Q, createTextVNode as rt, toDisplayString as B, createCommentVNode as U, onUpdated as ps, Teleport as ds, getCurrentInstance as hs, useTemplateRef as pi, createApp as ki, toRaw as xe, h as fs, render as Ut, defineAsyncComponent as ms } from "vue";
import xt from "@arcgis/core/Color";
import dt from "@arcgis/core/config";
import di from "@arcgis/core/geometry/Extent";
...
class k {
  ...
  // --- Components ---
  static async Swipe(e) {
    const t = await import("@arcgis/core/widgets/Swipe.js");
    return Reflect.construct(t.default, [e]);
  }
  static async Collection() {
    const e = await import("@arcgis/core/core/Collection");
    return Reflect.construct(e.default, []);
  }
}
class I {
...
class $e extends Ye {
  ...
  static parseMultiPolygon(e) {
    ...
    if (e instanceof se)
      return [e.toArray()];
    if (e instanceof ge || e instanceof de)
...
class G extends Ye {
  ...
  static fromArcServer(e, t) {
    return G.fromESRI(di.fromJSON(e), t);
  }
...
class Fe extends Ce {
  ...
  constructor(e) {
    if (e = e || { style: Te.CIRCLE }, super(), this._style = e.style || Te.CIRCLE, e.style === Te.ICON) {
      ...
      const t = e;
      this._size = Ce.convToPoints(t.size) || 12, this._colour = new ke(t.colour ?? "#ffffff40"), this._outline = new _e(t.outline), this._path = this._style === Te.PATH && t.path || "", this._height = 0, this._width = 0, this._icon = "";
    }
...
class _e extends Ce {
  ...
  constructor(e) {
    ...
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new ke(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || Di.ROUND, this._join = e.join || Fi.ROUND;
  }
...
class mt extends Ce {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new ke(e.fill.colour), this._fillStyle = e.fill.style || Gi.SOLID, this._outlineStyle = new _e(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new xt(this.fillColour.rgba), i = new Es();
...
class It {
   ...
   */
  updateQuery(e) {
    const t = Pi.all([{}, this.queryMap, e]);
...
class Fs {
  ...
  async projectGeoJson(e, t, i) {
    let s, o;
    if (t ? s = this.normalizeProj(t) : s = I.parseGeoJsonCrs(e.crs), i ? o = this.normalizeProj(i) : o = Ns, o === s)
      return e;
    await this.checkProjBomber([s, o]);
    const a = ne(s, o).forward;
    return Ss.applyConverter(e, a);
  }
  /**
  ...
  async projectExtent(e, t) {
    const i = (y, w, v) => {
      ...
      if (v === 1)
        return [y, $, w];
      if (v > 1) {
        const L = i(y, $, v - 1), N = i($, w, v - 1);
        return L.concat(N.slice(1));
      }
      return [[]];
    }, s = t.toPolygonArray().pop() || [];
    let o = [];
    [0, 1, 2, 3].map((y) => i(s[y], s[y + 1], 3).slice(1)).forEach((y) => o = o.concat(y));
    const a = new se("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), b = Math.min.apply(null, u), m = Math.max.apply(null, u);
...
const Lt = z("appbar", () => {
  ...
  function i(a) {
    if (r.value = { ...r.value, [a.id]: re(a) }, a.id in e.value)
      e.value[a.id].resolveMe(re(a));
    else {
      const l = new J();
      l.resolveMe(re(a)), e.value = {
        ...e.value,
        [a.id]: l
      };
    }
...
class Vs extends Z {
  ...
  _funCounter;
  constructor(e) {
    super(e), this._eventBus = new rs(), this._eventRegister = [], this._funCounter = 1, this._nameRegister = Object.values(E).filter((t) => typeof t == "string" && t.indexOf("/") > -1);
  }
  /**
  ...
  defaultHandlerFactory(e) {
    ...
    switch (e) {
      ...
      case "ramp_map_basemap_checks_tile_proj":
        t = (i) => {
          i.schemaChanged && this.$iApi.geo.layer.allLayers().filter((o) => o.layerType === S.TILE).forEach((o) => {
            o.checkProj();
          });
          const s = new CustomEvent("BasemapSchemaChange");
...
const Tt = z("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Tt(), t = we("iApi"), i = O(() => e.maptipPoint), s = O(() => e.maptipInstance), o = O(() => e.content), a = ve([]);
    a.push(
      Et(i, () => {
        if (i.value) {
...
const Ys = ["data-cy"], qi = /* @__PURE__ */ C({
  ...
  setup(r) {
    ...
    return (n, c) => {
      ...
      return g(), A("div", {
        class: ae(["shadow-tm bg-white h-full xs:mr-0 sm:mr-12 last:mr-0 pointer-events-auto min-w-0 shrink-0", r.panel.expanded ? "flex-grow max-w-full" : ""]),
        style: $i(r.panel.style),
        "data-cy": r.panel.id,
        ref_key: "componentEl",
        ref: e
      }, [
        oe(Ci, {
          ...
          default: te(() => [
            P((g(), W(ns(r.panel.route.screen), ls({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  const r = h(void 0), e = h(void 0), t = h(0), i = h(0), s = h(!1), o = h(!0), a = h({}), l = h({}), n = h([]), c = h([]), u = h([]), p = h(1), d = O(() => i.value);
  function b(x) {
  ...
  function K() {
    let x = t.value;
    const R = [], he = 350, Qe = 12, ci = 600;
    for (let Pe = n.value.length - 1; Pe >= 0; Pe--) {
      const Xe = n.value[Pe];
      let Le = Xe.width || he;
      if (s.value ? Le = x : Le += Qe, Xe.id === "grid" && (Le = Math.max(Math.min(Le, x), ci)), (x >= Le && !s.value || R.length === 0) && (x -= Le, R.unshift(Xe)), Xe.id === "grid" && x < ci)
        break;
    }
    if (r.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(r.value) && !s.value) {
      let Pe;
      for (let ui = 0; ui < R.length - 1 && x < (r.value.width || he) + Qe; ui++)
        Pe = R.shift(), x += Pe.width || he;
      x >= (r.value.width || he) ? R.unshift(r.value) : e.value || (Pe = R.shift(), R.unshift(r.value));
      const Xe = n.value.indexOf(r.value), Le = n.value.indexOf(Pe), Gt = n.value.slice();
      Le > -1 && (Gt.splice(Xe, 1), Gt.splice(Le, 0, r.value)), n.value = Gt;
    }
    i.value = x, u.value = R;
  }
  function Ke(x) {
    if (a.value = { ...a.value, [x.id]: x }, x.id in l.value)
      l.value[x.id].resolveMe(x);
    else {
      const R = new J();
      R.resolveMe(x), l.value = {
        ...l.value,
        [x.id]: R
      };
    }
  ...
  function Mt(x) {
    x.teleport ? c.value = [...c.value, x] : (n.value = [...n.value, x], e.value = x);
  }
  function Pt(x) {
    if (x.teleport) {
      const R = c.value.indexOf(x);
      R !== -1 && (c.value = [...c.value.slice(0, R), ...c.value.slice(R + 1)]);
    } else {
      const R = n.value.indexOf(x);
      R !== -1 && (n.value = [...n.value.slice(0, R), ...n.value.slice(R + 1)]);
    }
  }
  function Nt(x, R) {
    const he = n.value.indexOf(x), Qe = R === "right" ? 1 : -1;
  ...
  function Ft(x) {
    a.value[x.id] !== void 0 && delete a.value[x.id], l.value[x.id] !== void 0 && delete l.value[x.id];
    const R = u.value.indexOf(x);
    R !== -1 && (u.value = [...u.value.slice(0, R), ...u.value.slice(R + 1)]), r.value && r.value.id == x.id && (r.value = void 0);
  }
  function Dt(x) {
    l.value = {
      ...l.value,
  ...
  setup(r) {
    ...
    const e = We(), t = we("iApi"), i = h(), s = O(() => e.opacity), o = O(() => e.mobileView);
    He(() => {
    ...
    return (u, p) => (g(), W(Oi, {
      ...
      default: te(() => [
        (g(!0), A(je, null, pt(a(_(t).screenSize), (d) => (g(), W(qi, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Zs = /* @__PURE__ */ Me(Js, [["__scopeId", "data-v-068bb8d9"]]), Ks = ["content", "aria-label"], ti = /* @__PURE__ */ C({
  ...
  setup(r) {
    const e = h(!1), t = h(null), i = ve([]), s = h(), o = h(), a = h(), l = r;
    i.push(
      Et(e, () => {
        t.value.update();
      })
    ...
    return He(() => {
      ...
      return g(), A("div", {
        ...
        P(f("div", {
          ...
          class: ae(["rv-dropdown shadow-md border border-gray:200 py-8 bg-white rounded z-10", { "text-center": r.centered }]),
          ref_key: "dropdown",
          ref: o
        }, [
          Oe(p.$slots, "default", {
  ...
  const r = h([]), e = h({}), t = O(() => r.value.length >= 99 ? 99 : r.value.length);
  function i(c) {
    r.value = [c, ...r.value];
  }
  function s(c) {
    if (r.value.includes(c)) {
      ...
      c instanceof Wi && n(c), u > -1 && r.value.splice(u, 1);
    }
  }
  function o(c) {
    e.value[c.id] = c;
...
}), Qs = { class: "h-full flex flex-col" }, Xs = { class: "w-full flex mb-6" }, er = ["content", "aria-label"], tr = /* @__PURE__ */ C({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(r) {
    const e = Ie(), { t } = H(), i = O(() => e.notificationNumber), s = () => e.clearAll();
    return (o, a) => {
      const l = Q("panel-screen"), n = M("tippy");
...
class ir extends Z {
  ...
  addGroup(e, t, i) {
    ...
    const s = new Wi(this.$iApi, e, t, i);
...
const sr = ["content"], rr = { class: "flex items-center text-left" }, or = { class: "select-text cursor-text" }, ar = ["content"], nr = {
  key: 0,
  class: "text-left"
}, lr = /* @__PURE__ */ C({
  ...
  setup(r) {
    ...
    return (n, c) => {
      const u = M("tippy");
      return P((g(), A("li", {
        class: ae(["flex-col default-focus-style p-4", r.notification.messageList ? "cursor-pointer" : ""]),
        ...
        f("div", rr, [
          f("span", null, [
            ...
            f("span", or, B(r.notification.message), 1)
          ]),
          c[4] || (c[4] = f("span", { class: "flex-grow" }, null, -1)),
          r.notification.messageList ? (g(), A("div", {
            key: 0,
            class: ae(["dropdown-icon p-4 pointer-events-none", { "transform -rotate-180": s.value }])
          }, c[2] || (c[2] = [
            f("svg", {
              xmlns: "http://www.w3.org/2000/svg",
              height: "24",
          ...
          P((g(), A("button", {
            type: "button",
            onClick: c[0] || (c[0] = Qt((p) => a(r.notification), ["stop"])),
        ...
        r.notification.messageList && s.value ? (g(), A("div", nr, [
          (g(!0), A(je, null, pt(r.notification.messageList, (p, d) => (g(), A("p", {
    ...
    return (l, n) => {
      ...
      return g(), A("div", null, [
        a.value.length > 0 ? P((g(), A("ul", {
          ...
          (g(!0), A(je, null, pt(a.value, (d, b) => (g(), A(je, {
            key: d.message + b
          }, [
            b > 0 ? (g(), A("div", ur)) : U("", !0),
            P(oe(lr, {
...
}), dr = { class: "flex items-center hover:text-white" }, hr = ["aria-label"], fr = {
  key: 0,
  class: "number rounded-full w-18 text-white"
}, mr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, yr = { class: "pb-8 border-b border-gray-600" }, gr = { class: "absolute flex right-3 top-3" }, vr = ["content", "aria-label"], br = /* @__PURE__ */ C({
  __name: "caption-button",
  setup(r) {
    const e = Ie(), { t } = H(), i = O(() => e.notificationNumber), s = () => e.clearAll();
    return (o, a) => {
      const l = Q("close"), n = M("tippy");
      return g(), W(ti, {
        position: "top-start",
        ...
        header: te(() => [
          f("div", dr, [
            ...
            i.value && i.value > 0 ? (g(), A("span", fr, B(i.value), 1)) : U("", !0)
          ])
        ]),
        default: te((c) => [
          f("div", mr, [
            f("div", null, [
              f("h4", yr, B(_(t)("notifications.title")), 1),
              f("div", gr, [
                P((g(), A("button", {
                  type: "button",
                  onClick: s,
            ...
            oe(Hi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
...
}), wr = /* @__PURE__ */ Me(br, [["__scopeId", "data-v-3623a7d2"]]), Ar = { class: "flex hover:text-white" }, Er = ["aria-label"], xr = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Sr = { class: "pb-8 border-b border-gray-600 mb-10" }, _r = { class: "absolute right-5 top-5" }, Ir = { class: "select-text" }, Lr = { class: "font-bold cursor-text" }, Tr = { class: "text-sm cursor-text" }, Rr = { class: "text-sm cursor-text" }, $r = /* @__PURE__ */ C({
  ...
  setup(r) {
    const { t: e } = H(), t = O(() => `${ht.major}.${ht.minor}.${ht.patch}`), i = O(() => ht.hash.slice(0, 9)), s = O(() => {
    ...
    return (o, a) => {
      const l = Q("close"), n = Q("dropdown-menu"), c = M("focus-item");
      return P((g(), W(n, {
        ...
        default: te((u) => [
          f("div", xr, [
            f("div", null, [
              ...
              f("div", Ir, [
                f("div", null, [
                  f("span", Lr, B(t.value), 1),
                  f("span", Tr, " [" + B(i.value) + "] ", 1)
                ]),
                f("div", null, [
                  f("span", Rr, B(s.value), 1)
                ]),
...
}), Cr = /* @__PURE__ */ Me($r, [["__scopeId", "data-v-ed2f8f44"]]), Or = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, kr = {
  key: 0,
  ...
  __name: "map-caption",
  setup(r) {
    const e = De(), t = pe(), { t: i } = H(), s = we("iApi"), o = O(() => e.scale), a = O(() => e.attribution), l = O(() => e.coords), n = O(() => e.langtoggle), c = O(() => t.config.map), u = h([]), p = ve([]);
    p.push(
      Et(c, (w) => {
    ...
    return (w, v) => {
      const $ = Q("dropdown-menu"), L = M("truncate"), N = M("tippy");
      return g(), A("div", Or, [
        oe(Cr, {
          class: "sm:block display-none ml-8 mr-4",
          position: "top-end"
        }),
        oe(wr, { class: "sm:block display-none" }),
        d() ? (g(), A("span", kr, [
          f("a", {
        ...
        a.value?.text.disabled ? U("", !0) : P((g(), A("span", Nr, [
        ...
        f("div", Fr, [
          l.value?.disabled ? U("", !0) : P((g(), A("div", Dr, [
          ...
          n.value?.disabled ? U("", !0) : (g(), W($, {
            ...
            header: te(() => [
              f("span", Br, B(_(i)("map.language.short")), 1)
            ]),
            default: te(() => [
              (g(!0), A(je, null, pt(u.value, (F, K) => (g(), A("a", {
                key: `${F}-${K}`,
                class: ae(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": F === _(s).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (Ke) => b(F)
              }, [
                rt(B(_(i)("map.language." + F)) + " ", 1),
                F === _(s).$i18n.locale.value ? (g(), A("span", Vr, B(_(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, zr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    const e = Ie(), t = we("iApi"), { t: i } = H(), s = O(() => e.notificationNumber);
    return (o, a) => {
      const l = M("tippy");
      return P((g(), A("button", {
        type: "button",
...
}), Yr = /* @__PURE__ */ Me(Hr, [["__scopeId", "data-v-a451db5c"]]), Jr = { class: "flex items-center mb-20" }, Zr = { class: "text-xl" }, Kr = /* @__PURE__ */ C({
    ...
    return (c, u) => {
      ...
      return i.value ? (g(), A("div", {
        ...
        f("div", {
          ...
          f("div", Jr, [
            f("h2", Zr, B(_(t)("keyboardInstructions.title")), 1),
            oe(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (g(!0), A(je, null, pt(s.value, (d) => (g(), A("p", {
...
}), tt = z("instance", () => ({ started: h(!1) })), Qr = { class: "h-full relative" }, Xr = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, eo = { class: "absolute top-8 w-full flex justify-center" }, to = {
  key: 1,
  class: "w-full h-full"
}, io = /* @__PURE__ */ C({
  __name: "shell",
  setup(r) {
    const e = we("iApi"), t = tt(), i = ye(), s = We(), { t: o } = H(), a = O(() => i.items.appbar), l = () => {
    ...
    return (c, u) => (g(), A("div", Qr, [
      f("div", Xr, [
        ...
        oe(Kr),
        oe(Zs, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        a.value ? U("", !0) : (g(), W(Yr, { key: 0 })),
        oe(jr, { class: "z-30" })
      ]),
      _(t).started ? (g(), W(Hs, { key: 0 })) : (g(), A("div", to, u[1] || (u[1] = [
        f("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (g(!0), A(je, null, pt(n(), (p) => (g(), W(ds, {
...
}), so = /* @__PURE__ */ Me(io, [["__scopeId", "data-v-7a1e48c2"]]), ro = C({
  name: "App",
  components: { Shell: so },
  setup() {
    const r = hs();
    He(() => {
      new ji().observe(r?.proxy?.$refs["app-size"]), Ls({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const lo = /* @__PURE__ */ Me(ro, [["render", no]]), Ee = "focus-list", ze = "focus-item", co = "focus-icon", uo = "focus-container", nt = `[${Ee}],[${uo}]`, vt = "truncate-text", bt = "show-truncate", st = "focused", Jt = `button,input,select,a,textarea,[contenteditable],[${Ee}],[${co}],[tabIndex]`, po = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(Ee, !0), new ho(r, e.value);
  },
  updated(r) {
    Yi(r);
  }
...
function Yi(r) {
  r.querySelectorAll(Jt).forEach((t) => {
    if (t.closest(nt) === r || t.closest(nt) === t && t.parentElement.closest(nt) === r)
      if (t.closest(`[${Ee}],.${st}`).classList.contains(st))
...
class ho {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Jt).forEach((s) => {
      (e === -1 || s.closest(nt) === this.element || s.closest(nt) === s && s.parentElement.closest(nt) === this.element || s.closest(`[${Ee}],.${st}`).classList.contains(st)) && s.setAttribute("tabindex", e.toString());
    });
  }
  /**
   ...
   */
  defocusItem(e) {
    e.classList.remove(st), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(ze) === bt && e.querySelector(`[${vt}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(st), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(ze) === bt && e.querySelector(`[${vt}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
    ...
    if (i.length !== 0)
      switch (e.key) {
        ...
        case " ":
          ...
          break;
        case "Tab":
          const s = this.highlightedItem.querySelectorAll(Jt).length === 0, o = this.element.isEqualNode(e.target);
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(ze) === bt && this.highlightedItem.querySelector(`[${vt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Yi(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
...
const yi = "focus-item", fo = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", mo()), e.value ? r.setAttribute(yi, e.value) : r.toggleAttribute(yi, !0);
  }
};
function mo() {
  let r;
...
const ii = "focus-container", Ji = "focus-list", yo = "focus-icon", zt = `[${Ji}],[${ii}]`, gi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Ji}],[${ii}],[${yo}],[tabIndex]`;
let Vt = [];
const go = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && Vt.push(new vo(r));
  },
  beforeUnmount(r) {
...
const bo = "truncate-text", wo = "truncate-trigger", Ao = {
  ...
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${wo}]`)), Ts(r, {
...
const xo = ["content"], So = {
  ...
  setup(r, { expose: e }) {
    const { t } = H(), i = We(), s = Lt(), o = we("iApi"), a = pi("el"), l = pi("contentEl"), n = h();
    e({ el: a });
    const c = r, u = O(() => o?.fixture.get("appbar") ? s.temporary : []), p = O(() => i.mobileView), d = O(() => i.reorderable), b = (v) => v.scrollHeight > v.clientHeight, m = () => !p.value && !c.panel.teleport, y = (v) => {
      c.panel.move(v), v === "left" && Rt(() => {
        (a.value?.querySelector(".move-left")).focus();
      });
    }, w = O(() => c.screenId ? c.panel.screens[c.screenId][o?.$i18n.locale.value ?? "en"] : null);
    return He(() => {
      ...
      const L = Q("back"), N = Q("panel-options-menu"), F = Q("left"), K = Q("right"), Ke = Q("pin"), Mt = Q("expand"), Pt = Q("minimize"), Nt = Q("close"), Ft = M("truncate"), Dt = M("focus-item"), x = M("tippy");
      return P((g(), A("div", {
        ...
        r.header ? (g(), A("header", So, [
          oe(L, {
            class: ae(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (R) => r.panel.close())
          }, null, 8, ["class"]),
          P((g(), A("h2", _o, [
            v.$slots.header ? Oe(v.$slots, "header", { key: 0 }) : (g(), A("div", Io, B(_(t)(r.panel.alertName)), 1))
          ])), [
            [Ft]
          ]),
          v.$slots.controls ? (g(), W(N, { key: 0 }, {
            default: te(() => [
              Oe(v.$slots, "controls")
            ]),
            _: 3
          ...
          f("div", {
            class: ae(r.panel.teleport ? "flex" : "display-none sm:flex")
          }, [
            r.panel.teleport ? U("", !0) : (g(), A("div", Lo, [
              d.value ? (g(), W(F, {
                key: 0,
        ...
        r.content ? (g(), A("div", {
          ...
          v.$slots.content ? Oe(v.$slots, "content", { key: 0 }) : w.value ? (g(), A("div", {
            key: 1,
            innerHTML: w.value.innerHTML
          }, null, 8, To)) : U("", !0)
        ], 512)) : U("", !0),
        r.footer ? P((g(), A("div", Ro, [
          Oe(v.$slots, "footer")
        ])), [
          [Dt]
        ]) : U("", !0)
...
}), Co = { class: "relative" }, Oo = ["content", "aria-label"], ko = ["transform"], Mo = /* @__PURE__ */ C({
  __name: "pin",
  props: {
    active: Boolean
  },
  setup(r) {
    ...
    return (t, i) => {
      ...
      return g(), A("div", Co, [
        P((g(), A("button", {
          type: "button",
          class: ae(["text-gray-500 hover:text-black focus:text-black p-8", { "text-gray-700": r.active }]),
...
}), Do = { class: "relative" }, Go = ["content", "aria-label"], Uo = /* @__PURE__ */ C({
  __name: "back",
  props: {
    active: Boolean
  },
  ...
  setup(r) {
    ...
    return (t, i) => {
      ...
      return g(), A("div", Wo, [
        P((g(), A("button", {
          type: "button",
          class: ae(["text-gray-500 hover:text-black focus:text-black p-6", { "text-gray-700": r.active }]),
...
}), Qo = { class: "relative" }, Xo = ["content", "aria-label"], ea = /* @__PURE__ */ C({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), ia = /* @__PURE__ */ Me(ta, [["__scopeId", "data-v-51e22a4a"]]), sa = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return g(), W(a, {
        ...
        default: te(() => [
          _(t).isFullscreen ? (g(), A("svg", sa, o[0] || (o[0] = [
            f("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, ca = ["content", "aria-label"], ua = /* @__PURE__ */ C({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, da = ["aria-label", "content"], ha = /* @__PURE__ */ C({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
...
}), fa = /* @__PURE__ */ Me(ha, [["__scopeId", "data-v-457cd2d4"]]), ma = z("areas-of-interest", () => ({ areas: h([]) })), ya = z("export", () => {
  const r = h({
    title: !0,
    map: !0,
    mapElements: !0,
...
function xa(r, e) {
  ...
  if (t.test(e) && !r.disabledSearchTypes.includes("LAT/LNG")) {
    const o = e.slice(0, -1);
    return new Sa(r, o);
  } else return s.test(e) && !r.disabledSearchTypes.includes("FSA") ? new _a(r, e) : i.test(e) && !r.disabledSearchTypes.includes("NTS") ? new Ia(r, e.substring(0, 6).toUpperCase()) : new La(r, e);
}
class Ot {
  config;
  query;
...
const bi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", wi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ai = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Ei = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", Ta = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
class xi {
  ...
  constructor(e, t) {
    ...
    l ? (i = l.geoLocation ? l.geoLocation : bi, s = l.geoNames ? l.geoNames : wi, o = l.geoProvince ? l.geoProvince : Ai, a = l.geoTypes ? l.geoTypes : Ei) : (i = bi, s = wi, o = Ai, a = Ei), i = i.replace("@{language}", e), s = s.replace("@{language}", e), o = o.replace("@{language}", e), a = a.replace("@{language}", e);
    const n = t?.settings;
    let c, u, p, d, b;
...
const Ra = z("geosearch", () => {
  const r = h(new xi("en", void 0)), e = h({
    ...
    province: "",
    extent: void 0
  }), t = h(!1), i = h(""), s = h(""), o = h(""), a = h([]), l = h([]), n = h(!1), c = h([]), u = O(
    () => new Promise((L) => {
      r.value.fetchProvinces().then((N) => {
        N.sort((F, K) => F.name > K.name ? 1 : -1), L(N);
      });
    })
  ), p = O(
    () => new Promise((L) => {
  ...
  function b(L) {
    ...
    else if (N && N !== o.value || L) {
      const F = setInterval(() => {
        r.value.config.provinces.listFetched && r.value.config.types.typesFetched && (clearInterval(F), r.value.query(`${N}*`).then((K) => {
          c.value = K.failedServs, o.value = N, l.value = K.results;
          const Ke = Si(
            t.value,
            //@ts-expect-error TODO: explain why this is needed or remove
            e.value,
  ...
  function v(L) {
    ...
    L = L.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(), s.value = Array.from(L).map((F) => Object.keys(N).includes(F) ? "[" + F + N[F] + "]" : F.replace(/["$!*+?^{}()|[\]\\]/g, "").replace(/[.\\]/g, "\\$&").trim()).join("");
  }
  function $(L) {
...
var Zi = /* @__PURE__ */ ((r) => (r.Visibility = "visibilityButton", r.Expand = "expandButton", r))(Zi || {}), Zt = /* @__PURE__ */ ((r) => (r.Item = "item", r.Placeholder = "placeholder", r.Error = "error", r))(Zt || {});
class Ki extends Z {
  _uid;
  _name;
  _type;
  ...
  toggleVisibility(e, t = !0) {
    if (this.visibility !== e) {
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof Ne) || this._lastVisible.layerControlAvailable(q.Visibility)))
          this._lastVisible.toggleVisibility(!0);
        else {
          const i = this.children.find(
            (s) => !(s instanceof Ne) || s.layerControlAvailable(q.Visibility)
          );
   ...
   */
  checkVisibility(e) {
    this instanceof Ne && !this.layerControlAvailable(q.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
...
class Ne extends Ki {
  ...
  // @ts-expect-error TODO: explain why this is needed or remove
  load(e) {
    const t = e instanceof ri ? e : this.$iApi.geo.layer.getLayer(this._layerId ?? this._layerUid);
...
class _i extends Ki {
  ...
  constructor(e, t, i) {
    ...
    }), (t.infoType || t.content) && (this._controls = t.controls?.slice() ?? [Zi.Expand]), super.load();
  }
...
const Oa = z("legend", () => {
  ...
  function o(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof _i) && !(n.item instanceof Ne)) {
...
class Ga {
  ...
  constructor(e, t, i) {
    ...
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new Mn(this), this.panel = new Pn(this), this.geo = new On(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new ir(this), this._isFullscreen = Ae.isEnabled && !!this.$vApp.$root && Ae.isFullscreen && Ae.element === this.$vApp.$root.$el, Ae.isEnabled && Ae.onchange(() => {
   ...
   */
  initialize(e, t, i) {
    const s = pe(this.$vApp.$pinia), o = We(this.$vApp.$pinia), a = Tt(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
   ...
   */
  reload(e, t) {
    const i = tt(this.$vApp.$pinia), s = Ie(this.$vApp.$pinia), o = pe(this.$vApp.$pinia), a = ye(this.$vApp.$pinia), l = Se(this.$vApp.$pinia), n = Ht(this.$vApp.$pinia), c = !!e;
  ...
  setLanguage(e) {
    if (this.$i18n.locale.value === e)
      return;
    const t = pe(this.$vApp.$pinia), i = Ie(this.$vApp.$pinia), s = t.registeredLangs;
...
function Ua(r, e) {
  ...
  t.use(({ store: a }) => {
    const l = hi(a.$state);
    a.$reset = () => a.$patch(hi(l));
  });
  const i = Ws(), s = ki(lo).use(i).use(Is, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  s.directive("focus-container", go), s.directive("focus-list", po), s.directive("focus-item", fo), s.directive("truncate", Ao), s.component("panel-screen", $o), s.component("pin", Mo), s.component("close", Fo), s.component("back", Uo), s.component("expand", qo), s.component("panel-options-menu", ia), s.component("dropdown-menu", ti), s.component("minimize", Yo), s.component("right", Ko), s.component("left", ea), s.component("fullscreen-nav-button", oa), s.component("geolocator-nav-button", aa), s.component("home-nav-button", na), s.component("mapnav-button", ua), s.component("appbar-button", fa), s.component("transition", Ci), s.component("transition-group", Oi), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.provide("iApi", e);
  const o = s.mount(r);
...
class si {
  ...
  static async create(e) {
    const t = new si(e), i = e.layers.map((a) => {
...
class Ba extends Z {
  ...
  async createMap(e, t) {
    ...
    }, s = e.basemaps.map((n) => si.create(n)), a = (await Promise.all(s)).filter((n) => (n.createErr && i(n), n.esriBasemap.baseLayers.length > 0));
    a.forEach((n) => {
    ...
    const l = {};
    this.esriMap = re(await k.Map(l)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
...
class za extends Z {
   ...
   */
  constructor(e) {
    super(e), this.maptipStore = Tt(this.$vApp.$pinia);
  }
...
class ja extends Ba {
  ...
  removeLayer(e) {
    ...
    let t;
    if (e instanceof ri ? t = e : t = this.$iApi.geo.layer.getLayer(e), !t)
  ...
  */
  ...
  runIdentify(e) {
    ...
    t.some((c) => c.identifyMode === X.HYBRID || c.identifyMode === X.SYMBOLIC) && (s = this.esriView.hitTest({
      x: i.screenX,
      y: i.screenY
...
class tn extends Z {
  ...
  extractCsvFields(e, t = ",") {
    return fi.dsvFormat(t).parseRows(e)[0].map((s) => ({ name: s, type: Re.STRING }));
  }
  /**
...
class Qi extends ri {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = T.NONE, this.dataFormat = ee.UNKNOWN, this.layerType = S.UNKNOWN, this.layerFormat = me.UNKNOWN;
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = X.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = j.NEW, this.initiationState = D.NEW, this.drawState = ue.NOT_LOADED, this.loadDefProm = new J(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.layerTree = new _t(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async terminate() {
    this.updateInitiationState(D.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new J(), this.loadPromDone = !1, this.updateLayerState(j.NEW), this.updateDrawState(ue.NOT_LOADED), this.updateInitiationState(D.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
...
class oi extends Je {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = T.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new Bi(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new es();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new is(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.origRampConfig.name || (this.name = i.name ?? this.id), this.dataFormat === ee.ESRI_FEATURE) {
        ...
        this.attribs.attLoader = new ts(this.$iApi, o);
      } else
...
class nn extends an {
  ...
  async onInitiate() {
    this.esriLayer = re(await k.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Ze extends oi {
  ...
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = me.FEATURE, this.tooltipField = "", this.layerIdx = 0, e.identifyMode && e.identifyMode !== X.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = X.HYBRID;
  }
  async reload() {
  ...
  runIdentify(e) {
    ...
    return e.hitTest && (this.identifyMode === X.HYBRID || this.identifyMode === X.SYMBOLIC) && (s = o.then(async () => {
...
class fn extends oi {
  tooltipField;
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.tooltipField = "", this.supportsIdentify = !0, this.layerType = S.FEATURE, this.layerFormat = me.FEATURE, e.identifyMode && e.identifyMode !== X.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = X.HYBRID;
  }
  async onInitiate() {
    re(this.esriLayer = await k.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class mn extends Je {
  ...
  origState;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.supportsSublayers = !0, this.layerType = S.MAPIMAGE, this.layerFormat = me.MAPIMAGE, this.isDynamic = !1, this.hovertips = !1, this.layerTree.layerIdx = -1, this.identifyMode = X.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = re(await k.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class yn extends oi {
  tooltipField;
  constructor(e, t, i) {
    if (super(e, t), this.layerType = S.SUBLAYER, this.layerFormat = me.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.dataFormat = ee.ESRI_FEATURE, this.supportsFeatures = !0, this.tooltipField = "", this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
...
class gn extends Je {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.OSM, this.layerFormat = me.OSM, this.dataFormat = ee.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
    this.esriLayer = re(await k.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class vn extends Je {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.IMAGERY, this.layerFormat = me.IMAGERY, this.dataFormat = ee.ESRI_RASTER;
  }
  async onInitiate() {
    this.esriLayer = re(await k.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class bn extends Je {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.TILE, this.layerFormat = me.TILE, this.dataFormat = ee.ESRI_TILE;
  }
  async onInitiate() {
    this.esriLayer = re(await k.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class wn extends Je {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = S.WMS, this.layerFormat = me.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = ee.OGC_RASTER, this.identifyMode = X.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = re(await k.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Xi extends Qi {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = me.NOLAYER, this.drawState = ue.NOT_VISUAL, this.attribs = new es(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
...
class xn extends Xi {
  ...
  serviceUrl;
  constructor(e, t) {
    super(e, t), this.layerType = S.DATATABLE, this.serviceUrl = e.url, this.filter = new Bi(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
  }
  async onInitiate() {
  }
  onLoadActions() {
    const e = super.onLoadActions(), t = Date.now(), s = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, o = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then((l) => {
      ...
      this.attribs.attLoader = new ts(this.$iApi, n), this.attribs.quickCache = new is(this.geomType);
  ...
  async symbolToSvg(e) {
    ...
    const o = et(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
      ...
      "picture-fill"() {
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(m).then((N) => {
          const F = o.pattern(
            y,
            w,
            (K) => (
...
class On extends Z {
   ...
   */
  constructor(e) {
    super(e), this.geom = lt.geom, this.proj = lt.proj, this.shared = lt.sharedUtils, this.map = new ja(e), this.layer = new on(e), this.attributes = new Sn(e), this.query = new Cn(e), this.symbology = new $n(e), Array.isArray(dt.request.interceptors) || (dt.request.interceptors = []), dt.request.interceptors.push({
      before: (t) => {
...
const kn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-CI30uO6H.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-CsO4fA17.js"), "../fixtures/basemap/index.ts": () => import("./index-CVBwMTZq.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BPUfoxxb.js"), "../fixtures/details/index.ts": () => import("./index-BtKcUNuN.js"), "../fixtures/export-footnote/index.ts": () => import("./index-Bg6JqVAE.js"), "../fixtures/export-legend/index.ts": () => import("./index-BciCvAtt.js"), "../fixtures/export-map/index.ts": () => import("./index-Ckdhqu3J.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-B_geX6n_.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DhgDptyz.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-DKQgKYCx.js"), "../fixtures/export-title/index.ts": () => import("./index-BMPrV7c5.js"), "../fixtures/export/index.ts": () => import("./index-BBtcJiMs.js"), "../fixtures/extentguard/index.ts": () => import("./index-C8ObmkVN.js"), "../fixtures/gazebo/index.ts": () => import("./index-D5sdzsY5.js"), "../fixtures/geosearch/index.ts": () => import("./index-ClwGCShj.js"), "../fixtures/grid/index.ts": () => import("./index-CdCiypon.js"), "../fixtures/help/index.ts": () => import("./index-v867KtJs.js"), "../fixtures/hilight/index.ts": () => import("./index-BITJHsCX.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-KmWbNt_x.js"), "../fixtures/legend/index.ts": () => import("./index-BoclO5AU.js"), "../fixtures/mapnav/index.ts": () => import("./index-BUzf3q3v.js"), "../fixtures/metadata/index.ts": () => import("./index-Bv8-d0Tj.js"), "../fixtures/northarrow/index.ts": () => import("./index-BOUWqAbc.js"), "../fixtures/overviewmap/index.ts": () => import("./index-01vrb1qX.js"), "../fixtures/panguard/index.ts": () => import("./index-BexkDpYj.js"), "../fixtures/scrollguard/index.ts": () => import("./index-ChNn7cDS.js"), "../fixtures/settings/index.ts": () => import("./index-CUj67A59.js"), "../fixtures/snowman/index.ts": () => import("./index-0cc1MY4e.js"), "../fixtures/swipe/index.ts": () => import("./index-2BxwQ_KI.js"), "../fixtures/wizard/index.ts": () => import("./index-mhGNjdxG.js") });
class Mn extends Z {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      i = li.updateBaseToInstance(new t(), e, this.$iApi);
    } else {
...
const Gn = /* @__PURE__ */ Me(Fn, [["render", Dn], ["__scopeId", "data-v-a3c61802"]]), Un = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-Y4OjyiwA.js"), "../fixtures/basemap/screen.vue": () => import("./screen-B_xv6gwu.js"), "../fixtures/export/screen.vue": () => import("./screen-QHq6tOni.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-DS_0bMUE.js"), "../fixtures/grid/screen.vue": () => import("./screen-Bdio-CEh.js"), "../fixtures/help/screen.vue": () => import("./screen-DWTeJLd9.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-C_IjUpvb.js"), "../fixtures/legend/screen.vue": () => import("./screen-B7aGQBHK.js"), "../fixtures/metadata/screen.vue": () => import("./screen-DAxqnhLB.js"), "../fixtures/settings/screen.vue": () => import("./screen-Bv-ot336.js"), "../fixtures/wizard/screen.vue": () => import("./screen-D_iPMP4f.js") });
class At extends Z {
  /**
   * ID of this panel.
   *
  ...
  return r.controls && r.controls.length > 0 && (e.controls = ct(r.controls, t), r.controls.includes("visibility") && e.controls.push("visibilityButton"), (r.controls.length !== 1 || r.controls[0] !== "visibility") && console.warn(
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        o.layerId ? s.children.push(Ri(o)) : s.children.push(Kt(o));
      }), e.children.push(s);
    } else
...
var it = { major: "4", minor: "11", patch: "0-beta", timestamp: "Fri Feb 28 11:51:54 2025 -0500", hash: "aaf5426cb7deb78bca80d8184e3365132615888c" };
console.info(
...
const Ol = (r, e, t) => new Ga(r, e, t), lt = new Ds();
export {
  q as $,
  Cr as A,
  mt as B,
