...
import { ref as h, computed as P, markRaw as re, defineComponent as C, inject as ge, reactive as be, watch as xt, onBeforeUnmount as dt, resolveDirective as k, withDirectives as M, openBlock as g, createElementBlock as w, withKeys as ns, withModifiers as Xt, onMounted as Ye, normalizeClass as ae, normalizeStyle as Ci, createVNode as oe, Transition as Oi, withCtx as te, createBlock as W, resolveDynamicComponent as ls, mergeProps as cs, useCssVars as us, TransitionGroup as ki, Fragment as qe, renderList as ht, unref as _, nextTick as $t, renderSlot as ke, createElementVNode as f, vShow as ps, resolveComponent as Q, createTextVNode as at, toDisplayString as B, createCommentVNode as U, onUpdated as ds, Teleport as hs, getCurrentInstance as fs, useTemplateRef as di, createApp as Mi, toRaw as xe, h as ms, render as Bt, defineAsyncComponent as ys } from "vue";
import St from "@arcgis/core/Color";
import ft from "@arcgis/core/config";
import { watch as Se } from "@arcgis/core/core/reactiveUtils.js";
import hi from "@arcgis/core/geometry/Extent";
import gs from "@arcgis/core/geometry/Multipoint";
...
import Es from "@arcgis/core/symbols/PictureMarkerSymbol";
import xs from "@arcgis/core/symbols/SimpleFillSymbol";
import Ss from "@arcgis/core/symbols/SimpleLineSymbol";
...
class Ie extends Oe {
  ...
  constructor(e) {
    ...
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new Me(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || Gi.ROUND, this._join = e.join || Di.ROUND;
  }
...
class yt extends Oe {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new Me(e.fill.colour), this._fillStyle = e.fill.style || Ui.SOLID, this._outlineStyle = new Ie(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new St(this.fillColour.rgba), i = new xs();
...
class Ds {
  ...
  async projectGeoJson(e, t, i) {
    let s, o;
    if (t ? s = this.normalizeProj(t) : s = I.parseGeoJsonCrs(e.crs), i ? o = this.normalizeProj(i) : o = Fs, o === s)
      return e;
  ...
  async projectExtent(e, t) {
    ...
    const a = new se("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((y) => y[0]), u = n.map((y) => y[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), v = Math.min.apply(null, u), m = Math.max.apply(null, u);
...
class Gs {
  ...
  sharedUtils;
  constructor() {
    this.proj = new Ds(), this.geom = new Ps(), this.sharedUtils = new Ns();
  }
  defaultTileSchemas() {
...
const Lt = z("appbar", () => {
  ...
  const r = h([]), e = h([]), t = h([]);
  function i(p) {
    return zt(r.value, (d) => d?.uid === p);
  }
  function s(p) {
    return zt(r.value, (d) => d?.id === p);
  }
  function o(p) {
    return zt(
      r.value,
...
const Rt = z("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Rt(), t = ge("iApi"), i = P(() => e.maptipPoint), s = P(() => e.maptipInstance), o = P(() => e.content), a = be([]), l = h(!1);
    a.push(
      xt(i, () => {
        if (i.value) {
  ...
  constructor(e) {
    this.resizeObserver = new ResizeObserver((t) => {
      t.length && window.requestAnimationFrame(() => {
        t.forEach((i) => {
          const s = i.target.dataset.breakpoints, o = s ? JSON.parse(s) : e ?? Js;
...
const Zs = ["data-cy"], Wi = /* @__PURE__ */ C({
    ...
    return (n, c) => {
      ...
      return g(), w("div", {
        ...
        oe(Oi, {
          ...
          default: te(() => [
            M((g(), W(ls(r.panel.route.screen), cs({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  const r = h(void 0), e = h(void 0), t = h(0), i = h(0), s = h(!1), o = h(!0), a = h({}), l = h({}), n = h([]), c = h([]), u = h([]), p = h(1), d = P(() => i.value);
  function v(x) {
  ...
  function K() {
    let x = t.value;
    const R = [], he = 350, Xe = 12, ui = 600;
    for (let Ne = n.value.length - 1; Ne >= 0; Ne--) {
      const et = n.value[Ne];
      let Le = et.width || he;
      if (s.value ? Le = x : Le += Xe, et.id === "grid" && (Le = Math.max(Math.min(Le, x), ui)), (x >= Le && !s.value || R.length === 0) && (x -= Le, R.unshift(et)), et.id === "grid" && x < ui)
        break;
    }
    if (r.value && //@ts-expect-error TODO: explain why this is needed or remove
    !R.includes(r.value) && !s.value) {
      let Ne;
      for (let pi = 0; pi < R.length - 1 && x < (r.value.width || he) + Xe; pi++)
        Ne = R.shift(), x += Ne.width || he;
      x >= (r.value.width || he) ? R.unshift(r.value) : e.value || (Ne = R.shift(), R.unshift(r.value));
      const et = n.value.indexOf(r.value), Le = n.value.indexOf(Ne), Ut = n.value.slice();
      Le > -1 && (Ut.splice(et, 1), Ut.splice(Le, 0, r.value)), n.value = Ut;
    }
    i.value = x, u.value = R;
  }
  function Qe(x) {
  ...
  function Ft(x, R) {
    const he = n.value.indexOf(x), Xe = R === "right" ? 1 : -1;
    u.value.includes(n.value[he + Xe]) && ([n.value[he], n.value[he + Xe]] = [
      n.value[he + Xe],
      n.value[he]
    ]);
  }
  ...
  setup(r) {
    ...
    const e = He(), t = ge("iApi"), i = h(), s = P(() => e.opacity), o = P(() => e.mobileView);
    Ye(() => {
    ...
    const a = (u) => (
      ...
      const [d, v] = [u.children[0].getBoundingClientRect(), u.parentElement.getBoundingClientRect()];
      u.style.width = `${d.width}px`, u.style.height = `${d.height}px`, u.style.left = `${d.left - v.left}px`, u.style.position = "absolute", c(u, p, [
        [0, -6],
        [1, 0]
      ]);
    }, c = (u, p, d) => {
    ...
    return (u, p) => (g(), W(ki, {
      ...
      default: te(() => [
        (g(!0), w(qe, null, ht(a(_(t).screenSize), (d) => (g(), W(Wi, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, Qs = /* @__PURE__ */ Pe(Ks, [["__scopeId", "data-v-068bb8d9"]]), Xs = ["content", "aria-label"], ii = /* @__PURE__ */ C({
  ...
  setup(r) {
    ...
    return Ye(() => {
      window.addEventListener(
        ...
        a.value && o.value && (t.value = Cs(a.value, o.value, {
...
}), er = { class: "h-full flex flex-col" }, tr = { class: "w-full flex mb-6" }, ir = ["content", "aria-label"], sr = /* @__PURE__ */ C({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(r) {
    const e = Te(), { t } = Y(), i = P(() => e.notificationNumber), s = () => e.clearAll();
    return (o, a) => {
      const l = Q("panel-screen"), n = k("tippy");
      return g(), W(l, { panel: r.panel }, {
        header: te(() => [
          at(B(_(t)("notifications.title")), 1)
        ]),
        content: te(() => [
          f("div", er, [
            f("div", tr, [
...
const or = ["content"], ar = { class: "flex items-center text-left" }, nr = { class: "select-text cursor-text" }, lr = ["content"], cr = {
  key: 0,
  class: "text-left"
}, ur = /* @__PURE__ */ C({
      ...
      return M((g(), w("li", {
        ...
        f("div", ar, [
          f("span", null, [
            ...
            f("span", nr, B(r.notification.message), 1)
          ]),
        ...
        r.notification.messageList && s.value ? (g(), w("div", cr, [
          (g(!0), w(qe, null, ht(r.notification.messageList, (p, d) => (g(), w("p", {
    ...
    return (l, n) => {
      ...
      return g(), w("div", null, [
        a.value.length > 0 ? M((g(), w("ul", {
          ...
          (g(!0), w(qe, null, ht(a.value, (d, v) => (g(), w(qe, {
            key: d.message + v
          }, [
            v > 0 ? (g(), w("div", dr)) : U("", !0),
            M(oe(ur, {
...
}), fr = { class: "flex items-center hover:text-white" }, mr = ["aria-label"], yr = {
  key: 0,
  class: "number rounded-full w-18 text-white"
}, gr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, vr = { class: "pb-8 border-b border-gray-600" }, br = { class: "absolute flex right-3 top-3" }, Ar = ["content", "aria-label"], wr = /* @__PURE__ */ C({
  __name: "caption-button",
  setup(r) {
    const e = Te(), { t } = Y(), i = P(() => e.notificationNumber), s = () => e.clearAll();
    return (o, a) => {
      const l = Q("close"), n = k("tippy");
      return g(), W(ii, {
        position: "top-start",
        ...
        header: te(() => [
          f("div", fr, [
            ...
            i.value && i.value > 0 ? (g(), w("span", yr, B(i.value), 1)) : U("", !0)
          ])
        ]),
        default: te((c) => [
          f("div", gr, [
            f("div", null, [
              f("h4", vr, B(_(t)("notifications.title")), 1),
              f("div", br, [
                M((g(), w("button", {
                  type: "button",
                  onClick: s,
            ...
            oe(Yi, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
...
}), Er = /* @__PURE__ */ Pe(wr, [["__scopeId", "data-v-3623a7d2"]]), xr = { class: "flex hover:text-white" }, Sr = ["aria-label"], _r = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Ir = ["aria-label", "content"], Tr = { class: "pb-8 border-b border-gray-600 mb-10" }, Lr = { class: "absolute right-5 top-5" }, Rr = { class: "select-text" }, $r = { class: "font-bold cursor-text" }, Cr = { class: "text-sm cursor-text" }, Or = { class: "text-sm cursor-text" }, kr = /* @__PURE__ */ C({
  ...
  setup(r) {
    const { t: e } = Y(), t = ge("iApi"), i = () => {
      t.reload();
    }, s = P(() => `${mt.major}.${mt.minor}.${mt.patch}`), o = P(() => mt.hash.slice(0, 9)), a = P(() => {
    ...
    return (l, n) => {
      const c = Q("close"), u = Q("dropdown-menu"), p = k("tippy"), d = k("focus-item");
      return M((g(), W(u, {
          ...
          f("div", _r, [
            f("div", null, [
              M((g(), w("button", {
                ...
                onClick: i,
                "aria-label": _(e)("ramp.reload"),
                content: _(e)("ramp.reload")
              }, n[1] || (n[1] = [
                f("svg", {
              ...
              f("div", Rr, [
                f("div", null, [
                  f("span", $r, B(s.value), 1),
                  f("span", Cr, " [" + B(o.value) + "] ", 1)
                ]),
                f("div", null, [
                  f("span", Or, B(a.value), 1)
                ]),
...
}), Mr = /* @__PURE__ */ Pe(kr, [["__scopeId", "data-v-dc5124c0"]]), Pr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, Nr = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, Fr = ["href", "aria-label"], Dr = ["src", "alt"], Gr = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base"
}, Ur = { class: "flex min-w-fit justify-end" }, Br = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, zr = ["aria-pressed", "aria-label", "content"], Vr = { class: "relative top-1 text-sm sm:text-base" }, jr = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, qr = ["onClick"], Wr = {
  key: 0,
  class: "sr-only"
}, Hr = /* @__PURE__ */ C({
  __name: "map-caption",
  setup(r) {
    const e = Ge(), t = pe(), { t: i } = Y(), s = ge("iApi"), o = P(() => e.scale), a = P(() => e.attribution), l = P(() => e.coords), n = P(() => e.langtoggle), c = P(() => t.config.map), u = h([]), p = be([]);
    p.push(
      xt(c, (A) => {
    ...
    return (A, b) => {
      const $ = Q("dropdown-menu"), T = k("truncate"), N = k("tippy");
      return g(), w("div", Pr, [
        oe(Mr, {
          class: "sm:block display-none ml-8 mr-4",
          position: "top-end"
        }),
        oe(Er, { class: "sm:block display-none" }),
        d() ? (g(), w("span", Nr, [
          f("a", {
        ...
        a.value?.text.disabled ? U("", !0) : M((g(), w("span", Gr, [
        ...
        f("div", Ur, [
          l.value?.disabled ? U("", !0) : M((g(), w("div", Br, [
          ...
          o.value?.disabled ? U("", !0) : M((g(), w("button", {
            key: 1,
            type: "button",
          ...
          n.value?.disabled ? U("", !0) : (g(), W($, {
            ...
            header: te(() => [
              f("span", jr, B(_(i)("map.language.short")), 1)
            ]),
            default: te(() => [
              (g(!0), w(qe, null, ht(u.value, (F, K) => (g(), w("a", {
                key: `${F}-${K}`,
                class: ae(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": F === _(s).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (Qe) => v(F)
              }, [
                at(B(_(i)("map.language." + F)) + " ", 1),
                F === _(s).$i18n.locale.value ? (g(), w("span", Wr, B(_(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, qr))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
...
}), Kr = /* @__PURE__ */ Pe(Zr, [["__scopeId", "data-v-a451db5c"]]), Qr = { class: "flex items-center mb-20" }, Xr = { class: "text-xl" }, eo = /* @__PURE__ */ C({
  __name: "keyboard-instructions",
  setup(r) {
    const e = ge("iApi"), { t } = Y(), i = h(!1), s = h(["app", "lists", "map"]), o = h([]), a = h(null), l = h(null);
    Ye(() => {
      o.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (g(), w("div", {
        ...
        f("div", {
          ...
          f("div", Qr, [
            f("h2", Xr, B(_(t)("keyboardInstructions.title")), 1),
            oe(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (g(!0), w(qe, null, ht(s.value, (d) => (g(), w("p", {
...
}), st = z("instance", () => ({ started: h(!1) })), to = { class: "h-full relative" }, io = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, so = { class: "absolute top-8 w-full flex justify-center" }, ro = {
  key: 1,
  class: "w-full h-full"
}, oo = /* @__PURE__ */ C({
  __name: "shell",
  setup(r) {
    const e = ge("iApi"), t = st(), i = ye(), s = He(), { t: o } = Y(), a = P(() => i.items.appbar), l = () => {
      e?.event.emit("openKeyboardInstructions");
    }, n = () => s.teleported;
    return (c, u) => (g(), w("div", to, [
      f("div", io, [
        ...
        oe(eo),
        oe(Qs, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        a.value ? U("", !0) : (g(), W(Kr, { key: 0 })),
        oe(Hr, { class: "z-30" })
      ]),
      _(t).started ? (g(), W(Ys, { key: 0 })) : (g(), w("div", ro, u[1] || (u[1] = [
        f("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (g(!0), w(qe, null, ht(n(), (p) => (g(), W(hs, {
...
}), ao = /* @__PURE__ */ Pe(oo, [["__scopeId", "data-v-7a1e48c2"]]), no = C({
  name: "App",
  components: { Shell: ao },
  setup() {
    const r = fs();
    Ye(() => {
      new qi().observe(r?.proxy?.$refs["app-size"]), Ls({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const po = /* @__PURE__ */ Pe(no, [["render", uo]]), Ee = "focus-list", Ve = "focus-item", ho = "focus-icon", fo = "focus-container", ct = `[${Ee}],[${fo}]`, bt = "truncate-text", At = "show-truncate", ot = "focused", Zt = `button,input,select,a,textarea,[contenteditable],[${Ee}],[${ho}],[tabIndex]`, mo = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(Ee, !0), new yo(r, e.value);
  },
  updated(r) {
    Ji(r);
  }
...
function Ji(r) {
  r.querySelectorAll(Zt).forEach((t) => {
    if (t.closest(ct) === r || t.closest(ct) === t && t.parentElement.closest(ct) === r)
      if (t.closest(`[${Ee}],.${ot}`).classList.contains(ot))
...
class yo {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Zt).forEach((s) => {
      (e === -1 || s.closest(ct) === this.element || s.closest(ct) === s && s.parentElement.closest(ct) === this.element || s.closest(`[${Ee}],.${ot}`).classList.contains(ot)) && s.setAttribute("tabindex", e.toString());
    });
  }
  /**
   ...
   */
  defocusItem(e) {
    e.classList.remove(ot), this.setTabIndex(-1, e), e._tippy && e._tippy.hide(), e.getAttribute(Ve) === At && e.querySelector(`[${bt}]`)?._tippy?.hide();
  }
  /**
   ...
   */
  focusItem(e) {
    e.classList.add(ot), this.setAriaActiveDescendant(e), this.setTabIndex(0, e), e.scrollIntoView({ block: "nearest" }), e._tippy && !this.isTapped && e._tippy.show(), e.getAttribute(Ve) === At && e.querySelector(`[${bt}]`)?._tippy?.show(), this.isTapped = !1;
  }
  /**
  ...
  onClick(e) {
    ...
    this.highlightedItem = t.closest(`[${Ve}]`) || t.closest(`[${Ee}]`) || this.highlightedItem, t.hasAttribute(`${Ve}`) && this.element.focus(), this.highlightedItem !== this.element ? this.focusItem(this.highlightedItem) : this.element.removeAttribute("aria-activedescendant");
  }
  /**
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(Ve) === At && this.highlightedItem.querySelector(`[${bt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Ji(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
   ...
   */
  onBlur() {
    this.highlightedItem && (this.highlightedItem._tippy && this.highlightedItem._tippy.hide(), this.highlightedItem.getAttribute(Ve) === At && this.highlightedItem.querySelector(`[${bt}]`)?._tippy?.hide());
  }
  /**
...
const gi = "focus-item", go = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", vo()), e.value ? r.setAttribute(gi, e.value) : r.toggleAttribute(gi, !0);
  }
};
function vo() {
  let r;
...
const si = "focus-container", Zi = "focus-list", bo = "focus-icon", Vt = `[${Zi}],[${si}]`, vi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Zi}],[${si}],[${bo}],[tabIndex]`;
let jt = [];
const Ao = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && jt.push(new wo(r));
  },
  beforeUnmount(r) {
...
const Eo = "truncate-text", xo = "truncate-trigger", So = {
  beforeMount(r, e) {
    !r.classList.contains("truncate") && !e.value?.noTruncateClass && r.classList.add("truncate"), r.toggleAttribute(Eo, !0);
  },
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${xo}]`)), Rs(r, {
...
const Io = ["content"], To = {
  ...
  setup(r, { expose: e }) {
    const { t } = Y(), i = He(), s = Lt(), o = ge("iApi"), a = di("el"), l = di("contentEl"), n = h();
    e({ el: a });
    const c = r, u = P(() => o?.fixture.get("appbar") ? s.temporary : []), p = P(() => i.mobileView), d = P(() => i.reorderable), v = (b) => b.scrollHeight > b.clientHeight, m = () => !p.value && !c.panel.teleport, y = (b) => {
      c.panel.move(b), b === "left" && $t(() => {
        (a.value?.querySelector(".move-left")).focus();
      });
    }, A = P(() => c.screenId ? c.panel.screens[c.screenId][o?.$i18n.locale.value ?? "en"] : null);
    return Ye(() => {
      ...
      const T = Q("back"), N = Q("panel-options-menu"), F = Q("left"), K = Q("right"), Qe = Q("pin"), Pt = Q("expand"), Nt = Q("minimize"), Ft = Q("close"), Dt = k("truncate"), Gt = k("focus-item"), x = k("tippy");
      return M((g(), w("div", {
        ...
        r.header ? (g(), w("header", To, [
          oe(T, {
            class: ae(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (R) => r.panel.close())
          }, null, 8, ["class"]),
          M((g(), w("h2", Lo, [
            b.$slots.header ? ke(b.$slots, "header", { key: 0 }) : (g(), w("div", Ro, B(_(t)(r.panel.alertName)), 1))
          ])), [
            [Dt]
          ]),
          b.$slots.controls ? (g(), W(N, { key: 0 }, {
            default: te(() => [
              ke(b.$slots, "controls")
            ]),
            _: 3
          ...
          f("div", {
            ...
            r.panel.teleport ? U("", !0) : (g(), w("div", $o, [
              d.value ? (g(), W(F, {
                key: 0,
...
}), Mo = { class: "relative" }, Po = ["content", "aria-label"], No = ["transform"], Fo = /* @__PURE__ */ C({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), Bo = { class: "relative" }, zo = ["content", "aria-label"], Vo = /* @__PURE__ */ C({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), jo = { class: "w-32 h-32" }, qo = ["content", "aria-label"], Wo = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), ta = { class: "relative" }, ia = ["content", "aria-label"], sa = /* @__PURE__ */ C({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), oa = /* @__PURE__ */ Pe(ra, [["__scopeId", "data-v-51e22a4a"]]), aa = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return g(), W(a, {
        ...
        default: te(() => [
          _(t).isFullscreen ? (g(), w("svg", aa, o[0] || (o[0] = [
            f("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, da = ["content", "aria-label"], ha = /* @__PURE__ */ C({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, ma = ["aria-label", "content"], ya = /* @__PURE__ */ C({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(r) {
    const e = ge("iApi"), t = r, i = () => e?.event.emit(E.APPBAR_BUTTON_CLICK, t.id);
    return (s, o) => {
...
}), ga = /* @__PURE__ */ Pe(ya, [["__scopeId", "data-v-457cd2d4"]]), va = z("areas-of-interest", () => ({ areas: h([]) })), ba = z("export", () => {
  const r = h({
    title: !0,
    map: !0,
    mapElements: !0,
...
class Ea {
  ...
  constructor(e, t) {
    Ct.get(t).then((i) => {
      i.data.definitions.forEach((s) => qt[e][s.code] = s.description), Object.keys(qt[e]).forEach((s) => {
        this.list[s] = qt[e][s];
      }), this.listFetched = !0;
    });
  }
  ...
  fsaToProvinces(e) {
    const t = {};
    let i = wa[e.substring(0, 1).toUpperCase()];
...
function Ia(r, e) {
  ...
  if (t.test(e) && !r.disabledSearchTypes.includes("LAT/LNG")) {
    const o = e.slice(0, -1);
    return new Ta(r, o);
  } else return s.test(e) && !r.disabledSearchTypes.includes("FSA") ? new La(r, e) : i.test(e) && !r.disabledSearchTypes.includes("NTS") ? new Ra(r, e.substring(0, 6).toUpperCase()) : new $a(r, e);
}
class kt {
  config;
  query;
...
const Ai = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", wi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ei = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", xi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", Ca = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
const Oa = z("geosearch", () => {
  const r = h(new Si("en", void 0)), e = h({
    type: "",
    province: "",
    extent: void 0
  }), t = h(!1), i = h(""), s = h(""), o = h(""), a = h([]), l = h([]), n = h(!1), c = h([]), u = P(
    () => new Promise((T) => {
...
const Pa = z("legend", () => {
  ...
  function o(n) {
    if (n.parent === void 0)
      ...
      if (!(n.item instanceof Ii) && !(n.item instanceof Fe)) {
  ...
  function a(n) {
    const c = (u) => (u = u.filter((p) => (p === n && !p.children.length && p.onRemoved(), p !== n)), u.forEach((p) => {
      ...
      (p) => !(p instanceof Ii && !p.children.length && p.content === "")
    ), u);
    e.value = c(e.value);
  }
  function l(n) {
...
class za {
  ...
  constructor(e, t, i) {
    ...
    const s = Va(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new Dn(this), this.panel = new Gn(this), this.geo = new Nn(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new rr(this), this._isFullscreen = we.isEnabled && !!this.$vApp.$root && we.isFullscreen && we.element === this.$vApp.$root.$el, we.isEnabled && we.onchange(() => {
   ...
   */
  initialize(e, t, i) {
    const s = pe(this.$vApp.$pinia), o = He(this.$vApp.$pinia), a = Rt(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
   ...
   */
  reload(e, t) {
    const i = st(this.$vApp.$pinia), s = Te(this.$vApp.$pinia), o = pe(this.$vApp.$pinia), a = ye(this.$vApp.$pinia), l = _e(this.$vApp.$pinia), n = Yt(this.$vApp.$pinia), c = !!e;
...
function Va(r, e) {
  ...
  const i = Hs(), s = Mi(po).use(i).use(Ts, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  s.directive("focus-container", Ao), s.directive("focus-list", mo), s.directive("focus-item", go), s.directive("truncate", So), s.component("panel-screen", ko), s.component("pin", Fo), s.component("close", Uo), s.component("back", Vo), s.component("expand", Yo), s.component("panel-options-menu", oa), s.component("dropdown-menu", ii), s.component("minimize", Ko), s.component("right", ea), s.component("left", sa), s.component("fullscreen-nav-button", la), s.component("geolocator-nav-button", ca), s.component("home-nav-button", ua), s.component("mapnav-button", ha), s.component("appbar-button", ga), s.component("transition", Oi), s.component("transition-group", ki), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.config.idPrefix = `ramp-${r.id || e.geo.shared.generateUUID()}`, s.provide("iApi", e);
  const o = s.mount(r);
...
class ja extends Z {
  ...
  async createMap(e, t) {
    ...
    const l = {};
    this.esriMap = re(await O.Map(l)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
    ...
    if (e ? (e.logo ? e.logo.disabled ? s.logo.disabled = !0 : (s.logo.altText = e.logo.altText || i.altText, s.logo.link = e.logo.link || i.link, s.logo.value = e.logo.value || i.value) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value), e.text ? e.text.disabled ? s.text.disabled = !0 : s.text.value = e.text.value || t.value : s.text.value = t.value, Ge(this.$vApp.$pinia).setAttribution(s)) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value, s.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      if (n) {
        ...
        Promise.all(c).then((u) => {
          o = u.filter((d) => d?.copyright).map((d) => d.copyright).join(" | "), s.text.value = o || s.text.value || t.value, Ge(this.$vApp.$pinia).setAttribution(s);
        });
      }
    }
  }
...
class Ha extends ja {
   ...
   */
  constructor(e) {
    super(e), this.maptip = new qa(e), this.caption = new Wa(e), this.mapMouseThrottle = 0;
  }
  async createMap(e, t) {
  ...
  async createMapView(e) {
    ...
    this.esriView = re(
      ...
      n.preventDefault();
    }) : console.error("ESRI Map View is missing its container"), Se(
...
class on extends Z {
  ...
  extractCsvFields(e, t = ",") {
    return mi.dsvFormat(t).parseRows(e)[0].map((s) => ({ name: s, type: $e.STRING }));
  }
  /**
...
class nn extends Z {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, o = {
    ...
    const c = new Tt(e).updateQuery(l), [u, p] = await We(Ct.get(c));
    if (!p)
...
class ln extends Z {
  ...
  async awaitLayer(e) {
    ...
    const o = 300, a = setInterval(() => {
      ...
      if (l && l.esriLayer && l.esriView)
        clearInterval(a), i.resolveMe(l);
      else if (s > 8e3) {
        clearInterval(a);
        const n = setInterval(() => {
          const c = this.getLayer(e);
          c && c.esriLayer && c.esriView && (clearInterval(n), i.resolveMe(c));
        }, 1500);
      }
    }, o);
    return i.getPromise();
...
class Xi extends oi {
  ...
  constructor(e, t) {
    ...
    this.expectedTime.draw = e.expectedDrawTime ?? i.draw, this.expectedTime.load = e.expectedLoadTime ?? i.load, this.expectedTime.fail = e.maxLoadTime || i.fail, this.lastCancel = 0, this.timers = {
      draw: void 0,
      load: void 0
    }, this.origRampConfig = e, this.id = e.id || "", this.uid = this.$iApi.geo.shared.generateUUID(), this.isCosmetic = !1, this.isRemoved = !1, this.isSublayer = !1, this.supportsIdentify = !1, this.mapLayer = !0, this.identifyMode = X.NONE, this.supportsFeatures = !1, this.hovertips = !1, this.supportsSublayers = !1, this.isFile = !1, this.layerState = j.NEW, this.initiationState = D.NEW, this.drawState = ue.NOT_LOADED, this.loadDefProm = new H(), this.url = this.origRampConfig.url, this.canReload = !!(this.url || this.origRampConfig.caching), this.loadPromDone = !1, this.nameArcadeFormula = "", this.tooltipArcadeFormula = "", this.layerTree = new It(0, this.uid, this.name, !0);
  }
  updateInitiationState(e) {
  ...
  async terminate() {
    this.updateInitiationState(D.TERMINATING), await Promise.all(this.sublayers.map((e) => e.terminate())), this.loadDefProm = new H(), this.loadPromDone = !1, this.updateLayerState(j.NEW), this.updateDrawState(ue.NOT_LOADED), this.updateInitiationState(D.TERMINATED);
  }
  // ----------- LAYER LOAD -----------
...
class un extends cn {
  ...
  async onInitiate() {
    this.esriLayer = re(await O.GraphicsLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class gn extends ai {
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.supportsIdentify = !0, this.layerType = S.FEATURE, this.layerFormat = me.FEATURE, e.identifyMode && e.identifyMode !== X.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = X.HYBRID;
  }
  async onInitiate() {
    re(this.esriLayer = await O.FeatureLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class vn extends Ze {
  ...
  async onInitiate() {
    this.esriLayer = re(await O.MapImageLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class bn extends ai {
  constructor(e, t, i) {
    if (super(e, t), this.layerType = S.SUBLAYER, this.layerFormat = me.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.dataFormat = ee.ESRI_FEATURE, this.supportsFeatures = !0, this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
...
class An extends Ze {
  ...
  async onInitiate() {
    this.esriLayer = re(await O.OpenStreetMapLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class wn extends Ze {
  ...
  async onInitiate() {
    this.esriLayer = re(await O.ImageryLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class En extends Ze {
  ...
  async onInitiate() {
    this.esriLayer = re(await O.TileLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class xn extends Ze {
  ...
  async onInitiate() {
    this.esriLayer = re(await O.WMSLayer(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class es extends Xi {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = ee.ESRI_FEATURE, this.layerFormat = me.NOLAYER, this.drawState = ue.NOT_VISUAL, this.attribs = new ts(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
...
const Fn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-C6DVn5w2.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-2FpHfwCV.js"), "../fixtures/basemap/index.ts": () => import("./index-BV2H12bn.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BSyOCb9c.js"), "../fixtures/details/index.ts": () => import("./index-CVCrDvdC.js"), "../fixtures/export-footnote/index.ts": () => import("./index-DwjmSl6i.js"), "../fixtures/export-legend/index.ts": () => import("./index-Djn9K_e4.js"), "../fixtures/export-map/index.ts": () => import("./index-phh-LtCY.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-ClubVShY.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-CPXXLcMY.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-D_1EPedC.js"), "../fixtures/export-title/index.ts": () => import("./index-D4JfDrgN.js"), "../fixtures/export/index.ts": () => import("./index-DR_121gN.js"), "../fixtures/extentguard/index.ts": () => import("./index-Bm7OC8Pw.js"), "../fixtures/gazebo/index.ts": () => import("./index-DpJXc43Z.js"), "../fixtures/geosearch/index.ts": () => import("./index-B_RzUGTd.js"), "../fixtures/grid/index.ts": () => import("./index-Bz64zJF-.js"), "../fixtures/help/index.ts": () => import("./index-D6R8hWdH.js"), "../fixtures/hilight/index.ts": () => import("./index-2xXXDcQn.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-Cw-ZIYv9.js"), "../fixtures/legend/index.ts": () => import("./index-B2wjeagN.js"), "../fixtures/mapnav/index.ts": () => import("./index-DHQa3zzB.js"), "../fixtures/metadata/index.ts": () => import("./index-Ch0SZwyO.js"), "../fixtures/northarrow/index.ts": () => import("./index-DKIHv7JL.js"), "../fixtures/overviewmap/index.ts": () => import("./index-Bwv-DNHF.js"), "../fixtures/panguard/index.ts": () => import("./index-B_xy-hGs.js"), "../fixtures/scrollguard/index.ts": () => import("./index-9XhuzbEN.js"), "../fixtures/settings/index.ts": () => import("./index-lsZd6bxw.js"), "../fixtures/snowman/index.ts": () => import("./index-afqmQ5qt.js"), "../fixtures/swipe/index.ts": () => import("./index-BTZ86G9i.js"), "../fixtures/wizard/index.ts": () => import("./index-CnEZNbJe.js") });
class Dn extends Z {
  /**
...
const Vn = /* @__PURE__ */ Pe(Bn, [["render", zn], ["__scopeId", "data-v-a3c61802"]]), jn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-CqD0bz8J.js"), "../fixtures/basemap/screen.vue": () => import("./screen-C8YV_fu2.js"), "../fixtures/export/screen.vue": () => import("./screen-C4z8S6Pb.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-B4bWIqzc.js"), "../fixtures/grid/screen.vue": () => import("./screen-Dhzg3oKA.js"), "../fixtures/help/screen.vue": () => import("./screen-BPfDxNkd.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-C6Jg1-Gs.js"), "../fixtures/legend/screen.vue": () => import("./screen-DksV2orJ.js"), "../fixtures/metadata/screen.vue": () => import("./screen-uUxiQE6-.js"), "../fixtures/settings/screen.vue": () => import("./screen-B39iTmCK.js"), "../fixtures/wizard/screen.vue": () => import("./screen-CvJVKGt6.js") });
class Et extends Z {
  /**
   * ID of this panel.
   *
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Wed May 7 16:21:00 2025 -0400", hash: "d68efc6441b08b05205640bba3fcd4e07265799f" };
console.info(
...
const Fl = (r, e, t) => new za(r, e, t), ut = new Gs();
export {
  q as $,
  Mr as A,
  yt as B,
