import{H as He,o as B,s as Vt,A as Ht,c as we,r as Wt,g as We,P as Ut,N as qt}from"./vec32-C4Ldnv_6.js";import{fg as Me,fj as X,eq as ye,aw as N,o as s,q as Se,G as Yt,cS as oe,c7 as Jt,eR as Zt,b8 as kt,aL as Xt,ay as $t}from"./main-i0baoGPg.js";import{l as Ue}from"./ViewingMode-CyR_b1T8.js";import{H as Kt}from"./InterleavedLayout-CYG26v1g.js";import{n as g,u as $,t as qe,o as Ce,r as Qt}from"./ShaderOutput-C_OqLoo1.js";import{n as E,a as b,t as re}from"./NormalAttribute.glsl-DxH_jhov.js";import{a7 as Oe,a8 as m,q as Ye,a9 as ea,aa as A,ab as ta,ac as aa,ad as oa,ae as ra,af as ie,p as ia,ag as na,ah as sa,h as L,B as F,c as V,ai as H,aj as W,u as K,C as O,ak as U,D as la,v as ca,al as da,K as P,am as ua,an as Je,y as Ze,ao as ke,ap as Xe,aq as ma,F as Ne,G as ne,ar as $e,as as ha,i as se,at as pa,au as va,av as ze,aw as le,m as Ke,o as z,ax as fa,ay as Ee,az as ce,l as ga,aA as xa,aB as ba,x as Ta,aC as Qe,aD as et,g as de,aE as tt,aF as at,z as ot,r as rt,aG as it,aH as ue,aI as nt,Y as wa,E as st,aJ as Ma,aK as ya,aL as Sa,H as Ca,aM as Oa,aN as Na,aO as za,aP as Ea,I as c,L as D,J as _a,M as Ga,O as _e,aQ as Ia,U as Aa,aR as La,d as Ra,aS as Fa,V as Pa,Z as Da}from"./VerticalOffset.glsl-BYzMW0y9.js";import{n as r,t as f}from"./glsl-o28TenZV.js";import{i as _,B as Ge,g as Ie,b as lt,e as Q,n as me,f as ja}from"./renderState-DlSSrLcZ.js";import{e as T}from"./VertexAttribute-DFC3a3eR.js";import{n as ct,r as Ba}from"./vec4f64-CjUMzAyX.js";import{e as Ae,o as q}from"./mat3f64-Dh9_zhFu.js";import{j as Va}from"./mat3-DOnW3DjW.js";import{o as dt}from"./mat4f64-BaJwL7tQ.js";import{o as Ha,r as Wa}from"./doublePrecisionUtils-BJbYwoii.js";import{a as Le}from"./BindType-CKbZk6AG.js";import{s as Ua,n as ut}from"./vec2f64-CEUyUoff.js";import{o as he}from"./vec2-BnynUbeJ.js";import{i as pe}from"./ShaderBuilder-BARMR0Es.js";import{D as mt,G as qa,t as Ya,_ as Ja,f as Za,O as ht}from"./enums-DBi1-Mm2.js";import{p as ka,w as Xa}from"./Texture-C2WKckN6.js";import{s as G}from"./vec42-D8CJyqHG.js";function $a(e){e.vertex.code.add(r`
...
}`)}let oo=class extends Ye{constructor(e,t,a){super(e,"mat4",Le.Pass,(o,i,n)=>o.setUniformMatrix4fv(e,t(i,n)),a)}};function gt(e,t){const a=e.fragment;switch(a.code.add(r`struct ShadingNormalParameters {
vec3 normalView;
vec3 viewDirection;
...
}`)}}function Y(e,t){io(e,t,new L("textureAlphaCutoff",a=>a.textureAlphaCutoff))}function io(e,t,a){const o=e.fragment,i=t.alphaDiscardMode,n=i===_.Blend;i!==_.Mask&&i!==_.MaskBlend||o.uniforms.add(a),o.code.add(r`
...
forwardTextureCoordinates();`),e.include(Y,t),o.main.add(r`
        discardBySlice(vpos);
...
forwardObjectAndLayerIdColor();`),e.include(Y,t),o.main.add(r`
        discardBySlice(vpos);
        ${f(i,r`vec4 texColor = texture(tex, ${h?"colorUV":"vuv0"});
        ...
        vpos = addVerticalOffset(vpos, localOrigin);
        gl_Position = transformPosition(proj, view, vpos);
        forwardTextureCoordinates();`),e.fragment.include(U,t),e.include(Y,t),o.main.add(r`
        discardBySlice(vpos);
        ${f(i,r`vec4 texColor = texture(tex, ${h?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
vpos = addVerticalOffset(vpos, localOrigin);
gl_Position = transformPosition(proj, view, vpos);
forwardTextureCoordinates();`),e.fragment.include(U,t),e.include(Y,t),e.include(la,t),o.main.add(r`
        discardBySlice(vpos);
        ${f(i,r`vec4 texColor = texture(tex, ${h?"colorUV":"vuv0"});
                discardOrAdjustAlpha(texColor);`)}
...
float evaluateAmbientOcclusion() { return 0.0; }`)}function It(e,t){const a=e.fragment,o=t.lightingSphericalHarmonicsOrder!==void 0?t.lightingSphericalHarmonicsOrder:2;o===0?(a.uniforms.add(new ie("lightingAmbientSH0",({lighting:i})=>B(At,i.sh.r[0],i.sh.g[0],i.sh.b[0]))),a.code.add(r`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
return ambientLight * (1.0 - ambientOcclusion);
}`)):o===1?(a.uniforms.add(new z("lightingAmbientSH_R",({lighting:i})=>G(I,i.sh.r[0],i.sh.r[1],i.sh.r[2],i.sh.r[3])),new z("lightingAmbientSH_G",({lighting:i})=>G(I,i.sh.g[0],i.sh.g[1],i.sh.g[2],i.sh.g[3])),new z("lightingAmbientSH_B",({lighting:i})=>G(I,i.sh.b[0],i.sh.b[1],i.sh.b[2],i.sh.b[3]))),a.code.add(r`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec4 sh0 = vec4(
0.282095,
0.488603 * normal.x,
0.488603 * normal.z,
...
return ambientLight * (1.0 - ambientOcclusion);
}`)):o===2&&(a.uniforms.add(new ie("lightingAmbientSH0",({lighting:i})=>B(At,i.sh.r[0],i.sh.g[0],i.sh.b[0])),new z("lightingAmbientSH_R1",({lighting:i})=>G(I,i.sh.r[1],i.sh.r[2],i.sh.r[3],i.sh.r[4])),new z("lightingAmbientSH_G1",({lighting:i})=>G(I,i.sh.g[1],i.sh.g[2],i.sh.g[3],i.sh.g[4])),new z("lightingAmbientSH_B1",({lighting:i})=>G(I,i.sh.b[1],i.sh.b[2],i.sh.b[3],i.sh.b[4])),new z("lightingAmbientSH_R2",({lighting:i})=>G(I,i.sh.r[5],i.sh.r[6],i.sh.r[7],i.sh.r[8])),new z("lightingAmbientSH_G2",({lighting:i})=>G(I,i.sh.g[5],i.sh.g[6],i.sh.g[7],i.sh.g[8])),new z("lightingAmbientSH_B2",({lighting:i})=>G(I,i.sh.b[5],i.sh.b[6],i.sh.b[7],i.sh.b[8]))),a.code.add(r`vec3 calculateAmbientIrradiance(vec3 normal, float ambientOcclusion) {
vec3 ambientLight = 0.282095 * lightingAmbientSH0;
vec4 sh1 = vec4(
0.488603 * normal.x,
0.488603 * normal.z,
...
}`))}const At=N(),I=ct();function xe(e){e.constants.add("ambientBoostFactor","float",fa)}function be(e){e.uniforms.add(new se("lightingGlobalFactor",t=>t.lighting.globalFactor))}function De(e,t){const a=e.fragment;switch(e.include(ge,t),t.pbrMode!==m.Disabled&&e.include(Re,t),e.include(It,t),e.include(Oe),a.code.add(r`
...
return outColor;
}`);break;default:ye(t.pbrMode);case m.COUNT:}}let fo=class extends Ye{constructor(e,t,a){super(e,"mat4",Le.Draw,(o,i,n,d)=>o.setUniformMatrix4fv(e,t(i,n,d)),a)}};function Lt(e,t){t.receiveShadows&&(e.fragment.uniforms.add(new oo("shadowMapMatrix",(a,o)=>o.shadowMap.getShadowMapMatrices(a.origin),4)),Rt(e))}function je(e,t){t.receiveShadows&&(e.fragment.uniforms.add(new fo("shadowMapMatrix",(a,o)=>o.shadowMap.getShadowMapMatrices(a.origin),4)),Rt(e))}function Rt(e){const t=e.fragment;t.include(ft),t.uniforms.add(new Ke("shadowMap",a=>a.shadowMap.depthTexture),new ba("numCascades",a=>a.shadowMap.numCascades),new z("cascadeDistances",a=>a.shadowMap.cascadeDistances)).code.add(r`int chooseCascade(float depth, out mat4 mat) {
...
}`)}function go(e,t){t.hasColorTextureTransform?(e.varyings.add("colorUV","vec2"),e.vertex.uniforms.add(new A("colorTextureTransformMatrix",a=>a.colorTextureTransformMatrix??q)).code.add(r`void forwardColorUV(){
colorUV = (colorTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(r`void forwardColorUV(){}`)}function xo(e,t){t.hasNormalTextureTransform&&t.textureCoordinateType!==P.None?(e.varyings.add("normalUV","vec2"),e.vertex.uniforms.add(new A("normalTextureTransformMatrix",a=>a.normalTextureTransformMatrix??q)).code.add(r`void forwardNormalUV(){
normalUV = (normalTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(r`void forwardNormalUV(){}`)}function bo(e,t){t.hasEmissionTextureTransform&&t.textureCoordinateType!==P.None?(e.varyings.add("emissiveUV","vec2"),e.vertex.uniforms.add(new A("emissiveTextureTransformMatrix",a=>a.emissiveTextureTransformMatrix??q)).code.add(r`void forwardEmissiveUV(){
emissiveUV = (emissiveTextureTransformMatrix * vec3(vuv0, 1.0)).xy;
}`)):e.vertex.code.add(r`void forwardEmissiveUV(){}`)}function To(e,t){t.hasOcclusionTextureTransform&&t.textureCoordinateType!==P.None?(e.varyings.add("occlusionUV","vec2"),e.vertex.uniforms.add(new A("occlusionTextureTransformMatrix",a=>a.occlusionTextureTransformMatrix??q)).code.add(r`void forwardOcclusionUV(){
