...
}`),n.uniforms.add(new fi("stipplePatternTexture",a=>a.stippleTexture),new q("stipplePatternSDFNormalizer",a=>yr(a.stipplePattern)),new q("stipplePatternPixelSizeInv",a=>1/wt(a))),t.stippleOffColorEnabled&&n.uniforms.add(new Me("stippleOffColor",a=>Tr(a.stippleOffColor))),n.code.add(p`float getStippleSDF(out bool isClamped) {
...
return isClamped ? floor(antiAliasedResult + 0.5) : antiAliasedResult;
  ...
  `)}function yr(e){return e?(Math.floor(.5*(Sr(e)-1))+.5)/e.pixelRatio:1}function wt(e){const t=e.stipplePattern;return t?gr(e.stipplePattern)/t.pixelRatio:1}const Or=.4,Ge=64,Nt=Ge/2,Er=Nt/5,Ar=Ge/Er,Rr=.25;function Ut(e,t){const i=e.vertex;We(i),i.uniforms.get("markerScale")==null&&i.constants.add("markerScale","float",1),i.constants.add("markerSizePerLineWidth","float",Ar).code.add(p`float getLineWidth() {
