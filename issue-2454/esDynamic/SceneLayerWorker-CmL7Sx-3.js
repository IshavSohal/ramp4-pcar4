import { fq as q, bx as v, cy as K } from "./main-CPC-ab0b.js";
import { y as Q } from "./DoubleArray-67cUHX8h.js";
import { i as W, a as X } from "./MeshLocalVertexSpace-CNKIwIWb.js";
import { f as Z, l as ee } from "./vec3-CIfsGX3L.js";
import "./sphere-DCxSUOg7.js";
import "./I3SUtil-CW3KnCEk.js";
var U, D;
(function(e) {
...
function te() {
  return _ || (_ = new Promise((e) => import("./i3s-BEctomty.js").then((t) => t.i).then(({ default: t }) => {
...
async function pe(e) {
  ...
  let s;
  const [{ projectBuffer: I }, { initializeProjection: M }] = await Promise.all([import("./main-CPC-ab0b.js").then((a) => a.r9), import("./main-CPC-ab0b.js").then((a) => a.ra)]);
  await M(c, l);
  const g = [0, 0, 0];
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    ...
    const a = i.type === "georeferenced" ? W.fromJSON(i) : X.fromJSON(i), { project: m } = await import("./projection-bGe56mL0.js"), d = m({ positions: f, transform: t ? { localMatrix: t } : void 0, vertexSpace: a, inSpatialReference: c, outSpatialReference: l, localMode: u });
...
//# sourceMappingURL=SceneLayerWorker-CmL7Sx-3.js.map
