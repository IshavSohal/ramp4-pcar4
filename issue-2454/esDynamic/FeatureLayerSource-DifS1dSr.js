import { K as L, f5 as U, br as j, f6 as Q, f7 as T, f8 as P, D as x, s as R, aj as G, eV as V, f9 as C, O as E, P as F, fa as H, f1 as z, S as W, a9 as M, fb as X, fc as A, $ as m, bm as v, fd as Y, fe as Z, ff as B, fg as K, fh as ee, b8 as te, fi as ae, fj as se, b1 as $, a1 as N, fk as re, fl as ne, eO as ie, _ as oe, ah as ue, bx as le, fm as de, fn as ce, fo as pe, Q as he } from "./main-CPC-ab0b.js";
import { i as ye } from "./MeshLocalVertexSpace-CNKIwIWb.js";
import { a as fe } from "./meshVertexSpaceUtils-CRWkOpdJ.js";
import { N as me, v as ge } from "./MeshTransform-CgqRDDhF.js";
import { isFeatureIdentifierArrayWithGlobalId as we, isFeatureIdentifierArrayWithObjectId as be } from "./editingSupport-k3rBbKBT.js";
import { o as Ie } from "./clientSideDefaults-DX17LWwq.js";
...
let O = class extends H {
  ...
  async uploadAssets(t, e) {
    const { uploadAssets: a } = await import("./uploadAssets-0WbKuNX8.js");
  ...
  async _uploadMeshesAndGetAssetMapEditsJSON(t) {
    ...
    for (const n of e) {
      ...
      if (fe(o)) r.push(i);
        ...
        const u = i.anchor, { convertMeshVertexSpace: d } = await import("./convertMeshVertexSpace-D5IIrD5T.js"), l = await d(i, new ye({ origin: [u.x, u.y, u.z ?? 0] }));
...
//# sourceMappingURL=FeatureLayerSource-DifS1dSr.js.map
