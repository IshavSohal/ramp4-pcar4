import { a9 as Et, fq as bt } from "./main-CPC-ab0b.js";
...
async function Mt() {
  gt = await (Et("esri-csp-restrictions") ? await import("./libtess-asm-DBDehE3e.js").then((i) => i.l) : await import("./libtess-Ct6cLUI8.js").then((i) => i.l)).default({ locateFile: (i) => bt(`esri/core/libs/libtess/${i}`) });
}
function $t(x, i) {
...
//# sourceMappingURL=TurboLine-AlefEfnq.js.map
