const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./screen-B_TH20eu.js","./main-CZWQ_YsF.js","./preload-helper-dJJaZANz.js","./main-BjH693uE.css","./table-state-manager-BxhJ2X4c.js","./screen-BHmI98jY.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { b$ as FixtureInstance, hN as useGridStore, hK as markRaw, hL as useAppbarStore } from './main-CZWQ_YsF.js';
    ...
    this.$iApi.panel.register(
      {
        grid: {
          screens: {
            "grid-screen": () => markRaw(__vitePreload(() => import('./screen-B_TH20eu.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0,import.meta.url))
          },
          style: {
            width: "450px"
          },
