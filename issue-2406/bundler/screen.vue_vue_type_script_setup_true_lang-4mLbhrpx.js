import { defineComponent as C, computed as h, resolveComponent as k, resolveDirective as O, withDirectives as R, openBlock as i, createBlock as E, unref as r, withCtx as m, createElementVNode as e, createElementBlock as w, Fragment as V, renderList as j, normalizeClass as y, toDisplayString as _, inject as q, ref as b, useTemplateRef as N, onBeforeMount as D, watch as P, onMounted as A, onBeforeUnmount as F, createVNode as T, createTextVNode as H, createCommentVNode as I } from "vue";
import { debounce as U } from "throttle-debounce";
import { useI18n as $ } from "vue-i18n";
import { a as W, f as z } from "./main-D-OUJN6Z.js";
const G = ["onClick", "aria-label"], J = { class: "md-icon-small inline" }, K = /* @__PURE__ */ C({
  ...
  setup(v) {
    const { t: f } = $(), s = W(), u = z(), g = h(() => s.mobileView ? "top-end" : "left-end"), l = (a) => {
      a.selectable && u.toggleSelected({
        name: a.name
      });
    };
    return (a, n) => {
      const x = k("dropdown-menu"), p = O("focus-item");
      return R((i(), E(x, {
        position: g.value,
...
}), Q = { ref: "componentEl" }, X = { class: "flex" }, Y = ["aria-label"], Z = ["aria-label"], ne = /* @__PURE__ */ C({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(v) {
    const f = v, { t: s } = $(), u = q("iApi"), g = z(), l = b(), a = b(void 0), n = b(void 0), x = b([]), p = N("componentEl"), o = h(() => g.componentSelectedState), S = h(() => {
      let c = {};
    ...
    }), L = h(() => !!l.value?.customRendererFunc), d = U(300, () => {
      if (!l.value || !p.value)
        return;
