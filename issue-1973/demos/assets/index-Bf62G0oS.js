const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./screen-CGYyb0NI.js","./main-5ivotA7d.js","./preload-helper-dJJaZANz.js","./main-Dm4D1JVC.css","./table-state-manager-BxhJ2X4c.js","./screen-BHmI98jY.css"])))=>i.map(i=>d[i]);
import { _ as __vitePreload } from './preload-helper-dJJaZANz.js';
import { b$ as FixtureInstance, hN as useGridStore, hK as markRaw, hL as useAppbarStore } from './main-5ivotA7d.js';
    ...
    this.$iApi.panel.register(
      {
        grid: {
          screens: {
            "grid-screen": () => markRaw(__vitePreload(() => import('./screen-CGYyb0NI.js'),true?__vite__mapDeps([0,1,2,3,4,5]):void 0,import.meta.url))
          },
          style: {
            width: "450px"
          },
