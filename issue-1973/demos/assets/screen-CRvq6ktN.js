import { fZ as createBaseVNode, c7 as ref, iT as reactive, ca as computed, g2 as watch, c8 as onMounted, c9 as onBeforeUnmount, cf as openBlock, cl as createElementBlock, iR as renderSlot, cg as createTextVNode, g3 as createCommentVNode, cm as Fragment, cn as renderList, ch as toDisplayString, c4 as defineComponent, c5 as useI18n, iU as toRef, ci as unref, iB as _export_sfc, jw as getDefaultExportFromCjs, c6 as inject, f$ as useTemplateRef, cc as resolveDirective, cj as createVNode, ce as withCtx, ck as withDirectives, f_ as normalizeClass, iA as vShow, iX as Transition, nN as provide, jb as useWizardStore, j3 as LayerType, nO as onErrorCaptured, g5 as GlobalEvents, lj as LayerState, nP as WizardStep, cb as resolveComponent, cd as createBlock, iN as withModifiers, mX as nextTick } from './main-5ivotA7d.js';
import { r as require$$0 } from './vue.esm-bundler-BHf0jc3U.js';
...
const _hoisted_7$1 = { class: "text-base font-bold" };
const _hoisted_8 = {
  class: "mb-0.5",
  "data-type": "url"
};
...
const _sfc_main$3 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    __expose({ selectInput, textInput, urlInput });
    ...
    return (_ctx, _cache) => {
      ...
      return openBlock(), createElementBlock("div", {
        ...
        __props.type === "file" ? (openBlock(), createElementBlock("div", _hoisted_1$3, [
          ...
          createBaseVNode("label", _hoisted_7$1, toDisplayString(__props.label), 1),
...
const WizardInput = /* @__PURE__ */ _export_sfc(_sfc_main$3, [["__scopeId", "data-v-a9b9da18"]]);
...
const StepperItem = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-dd76e7f6"]]);
          ...
          createVNode(_sfc_main$1, { activeStep: step.value }, {
            default: withCtx(() => [
              createVNode(StepperItem, {
                ...
                summary: url.value,
                onFocusPanel: refocusPanel,
                onFocusFirstElement: focusFirst
              }, {
                default: withCtx(() => [
                  createBaseVNode("form", {
                    ...
                    _cache[11] || (_cache[11] = createBaseVNode("span", { class: "block text-center mb-10" }, "or", -1)),
                    createVNode(WizardInput, {
                      type: "url",
                      name: "url",
                ...
                default: withCtx(() => [
                  createBaseVNode("form", {
                    ...
                    layerInfo.value?.configOptions.includes(`name`) ? (openBlock(), createBlock(WizardInput, {
                      ...
                      "onUpdate:modelValue": _cache[4] || (_cache[4] = ($event) => layerInfo.value.config.name = $event),
                      ...
                      ref: stepThreeStart,
                      onFocusElement: focusStepThree,
                      activeStep: step.value,
                      step: 2
                    }, null, 8, ["modelValue", "label", "aria-label", "validation-messages", "activeStep"])) : createCommentVNode("", true),
                    layerInfo.value?.configOptions.includes(`nameField`) ? (openBlock(), createBlock(WizardInput, {
                      ...
                      "onUpdate:modelValue": _cache[5] || (_cache[5] = ($event) => layerInfo.value.config.nameField = $event),
                    ...
                    layerInfo.value?.configOptions.includes(`tooltipField`) ? (openBlock(), createBlock(WizardInput, {
                      ...
                      "onUpdate:modelValue": _cache[6] || (_cache[6] = ($event) => layerInfo.value.config.tooltipField = $event),
                    ...
                    layerInfo.value?.configOptions.includes(`latField`) ? (openBlock(), createBlock(WizardInput, {
                      ...
                      "onUpdate:modelValue": _cache[7] || (_cache[7] = ($event) => layerInfo.value.config.latField = $event),
                      defaultOption: true,
                    ...
                    layerInfo.value?.configOptions.includes(`longField`) ? (openBlock(), createBlock(WizardInput, {
                      ...
                      "onUpdate:modelValue": _cache[8] || (_cache[8] = ($event) => layerInfo.value.config.longField = $event),
                      defaultOption: true,
                    ...
                    layerInfo.value?.configOptions.includes(`sublayers`) ? (openBlock(), createElementBlock("div", _hoisted_3, [
                      ...
                      (openBlock(), createBlock(WizardInput, {
                        ...
                        "onUpdate:modelValue": _cache[9] || (_cache[9] = ($event) => layerInfo.value.config.sublayers = $event),
...
const WizardScreenV = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-6677c773"]]);
