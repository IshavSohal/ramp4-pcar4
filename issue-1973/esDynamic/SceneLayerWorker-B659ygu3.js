import { fq as q, bx as v, cy as K } from "./main-CSZcX0az.js";
import { y as Q } from "./DoubleArray-BY2nyzvx.js";
import { i as W, a as X } from "./MeshLocalVertexSpace-BFHzT10H.js";
import { f as Z, l as ee } from "./vec3-ts4mI18P.js";
import "./sphere-BW68tJMz.js";
import "./I3SUtil-C8yktA2L.js";
var U, D;
(function(e) {
...
function te() {
  return _ || (_ = new Promise((e) => import("./i3s-BXDDlHt3.js").then((t) => t.i).then(({ default: t }) => {
...
async function pe(e) {
  ...
  let s;
  const [{ projectBuffer: I }, { initializeProjection: M }] = await Promise.all([import("./main-CSZcX0az.js").then((a) => a.r9), import("./main-CSZcX0az.js").then((a) => a.ra)]);
  await M(c, l);
  const g = [0, 0, 0];
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    ...
    const a = i.type === "georeferenced" ? W.fromJSON(i) : X.fromJSON(i), { project: m } = await import("./projection-DMkAgDED.js"), d = m({ positions: f, transform: t ? { localMatrix: t } : void 0, vertexSpace: a, inSpatialReference: c, outSpatialReference: l, localMode: u });
...
//# sourceMappingURL=SceneLayerWorker-B659ygu3.js.map
