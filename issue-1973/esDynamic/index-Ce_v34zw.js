import { jr as A, js as y, bY as M, fU as $, hG as O, g1 as D, hH as j } from "./main-CSZcX0az.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-BdQGOOfE.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-B9jT9KqX.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-BGQDFhNQ.js")).default, n = (await import("./index-CqlwqWQ1.js")).default, a = (await import("./index-x-mDwbic.js")).default, w = (await import("./index-DvatO-bQ.js")).default, p = (await import("./index-v2SUlunH.js")).default, r = (await import("./index-CKjJek4m.js")).default, b = (await import("./index-CDVccUbe.js")).default;
...
//# sourceMappingURL=index-Ce_v34zw.js.map
