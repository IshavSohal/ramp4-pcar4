import { fq as T } from "./main-CSZcX0az.js";
...
function y() {
  return new Promise((t) => import("./lyr3DWorker-B7OvNcPR.js").then((r) => r.l).then(({ default: r }) => {
...
//# sourceMappingURL=Lyr3DWorker-Bp8Hl41P.js.map
