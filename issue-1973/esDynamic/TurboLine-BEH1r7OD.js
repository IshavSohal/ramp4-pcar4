import { a9 as Et, fq as bt } from "./main-CSZcX0az.js";
...
async function Mt() {
  gt = await (Et("esri-csp-restrictions") ? await import("./libtess-asm-DPi9ah9w.js").then((i) => i.l) : await import("./libtess-DsyOkobw.js").then((i) => i.l)).default({ locateFile: (i) => bt(`esri/core/libs/libtess/${i}`) });
}
function $t(x, i) {
...
//# sourceMappingURL=TurboLine-BEH1r7OD.js.map
