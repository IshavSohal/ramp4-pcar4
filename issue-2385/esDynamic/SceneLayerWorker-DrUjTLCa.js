import { hX as K, bh as D } from "./main-BBM-S1He.js";
import { y as X } from "./DoubleArray-DeRqMbaz.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-WiMcpcG-.js";
import { n as Z, s as ee } from "./vec3-BQUF1DJ0.js";
import "./sphere-CtlM14rY.js";
import "./I3SUtil-DCPiV_ik.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-wkVPUD21.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-BBM-S1He.js").then((d) => d.qK), import("./main-BBM-S1He.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-DOCPFkwN.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-DrUjTLCa.js.map
