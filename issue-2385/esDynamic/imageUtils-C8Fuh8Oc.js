import { am as m, au as d, a2 as u, K as w, s as p } from "./main-BBM-S1He.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-7s9649Os.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-D7NzbHDZ.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-C8Fuh8Oc.js.map
