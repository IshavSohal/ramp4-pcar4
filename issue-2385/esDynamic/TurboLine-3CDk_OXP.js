import { af as le, hX as ue } from "./main-BBM-S1He.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-Ctu51omo.js").then((i) => i.l) : await import("./libtess-B7ZvXreT.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-3CDk_OXP.js.map
