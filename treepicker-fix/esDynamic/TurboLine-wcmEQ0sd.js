import { af as le, hX as ue } from "./main-D-74LVlY.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-CL-bogJO.js").then((i) => i.l) : await import("./libtess-DsZnsxfA.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-wcmEQ0sd.js.map
