import { hX as K, bh as D } from "./main-D-74LVlY.js";
import { y as X } from "./DoubleArray-Dl1sIvtZ.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-UTIKKZBz.js";
import { n as Z, s as ee } from "./vec3-fy6Szxzi.js";
import "./sphere-CYj7uAL6.js";
import "./I3SUtil-aQMmY4mu.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-BByjWVvx.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-D-74LVlY.js").then((d) => d.qK), import("./main-D-74LVlY.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-BT01-8Nl.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-DNDZ9Cmx.js.map
