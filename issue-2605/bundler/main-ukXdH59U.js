...
class Ms {
  ...
  async projectExtent(e, t) {
    ...
    const a = new ie("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, a), n = l.toArray().pop() || [], c = n.map((g) => g[0]), u = n.map((g) => g[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), v = Math.min.apply(null, u), m = Math.max.apply(null, u);
...
const Ws = ["data-cy"], Vi = /* @__PURE__ */ O({
    ...
    return (n, c) => {
      ...
      return y(), A("div", {
        ...
        re(Ri, {
          ...
          default: ee(() => [
            M((y(), W(os(r.panel.route.screen), as({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  setup(r) {
    ...
    return (c, u) => (y(), W($i, {
      ...
      default: ee(() => [
        (y(!0), A(qe, null, dt(o(S(t).screenSize), (p) => (y(), W(Vi, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
...
const tr = ["content"], ir = { class: "flex items-center text-left" }, sr = { class: "select-text cursor-text" }, rr = ["content"], or = {
  ...
  setup(r) {
    ...
    return (n, c) => {
      ...
      return M((y(), A("li", {
        ...
        r.notification.messageList && s.value ? (y(), A("div", or, [
          (y(!0), A(qe, null, dt(r.notification.messageList, (p, d) => (y(), A("p", {
    ...
    return (l, n) => {
      ...
      return y(), A("div", null, [
        a.value.length > 0 ? M((y(), A("ul", {
          ...
          (y(!0), A(qe, null, dt(a.value, (d, v) => (y(), A(qe, {
            key: d.message + v
          }, [
            v > 0 ? (y(), A("div", lr)) : U("", !0),
            M(re(ar, {
...
}, hr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, fr = { class: "pb-8 border-b border-gray-600" }, mr = { class: "absolute flex right-3 top-3" }, gr = ["content", "aria-label"], yr = /* @__PURE__ */ O({
      ...
      return y(), W(Xt, {
        ...
        header: ee(() => [
          f("div", ur, [
            ...
            i.value && i.value > 0 ? (y(), A("span", dr, B(i.value), 1)) : U("", !0)
          ])
        ]),
        default: ee((c) => [
          f("div", hr, [
  ...
  setup(r) {
    ...
    return (w, b) => {
      ...
      return y(), A("div", Cr, [
        ...
        a.value?.text.disabled ? U("", !0) : M((y(), A("span", Pr, [
        ...
        f("div", Nr, [
          l.value?.disabled ? U("", !0) : M((y(), A("div", Fr, [
          ...
          o.value?.disabled ? U("", !0) : M((y(), A("button", {
            key: 1,
            type: "button",
          ...
          n.value?.disabled ? U("", !0) : (y(), W($, {
            ...
            default: ee(() => [
              (y(!0), A(qe, null, dt(u.value, (F, ce) => (y(), A("a", {
                key: `${F}-${ce}`,
                ...
                F === S(s).$i18n.locale.value ? (y(), A("span", zr, B(S(i)("map.language.curr")), 1)) : U("", !0)
              ], 10, Br))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (o, a) => {
      ...
      return M((y(), A("button", {
        ...
        s.value && s.value > 0 ? (y(), A("span", qr, B(s.value), 1)) : U("", !0)
      ], 8, jr)), [
        [l]
      ]);
    };
    ...
    return (c, u) => {
      ...
      return i.value ? (y(), A("div", {
        ...
        f("div", {
          ...
          (y(!0), A(qe, null, dt(s.value, (d) => (y(), A("p", {
  ...
  __name: "shell",
  setup(r) {
    const e = ve("iApi"), t = it(), i = ye(), s = He(), { t: o } = H(), a = N(() => i.items.appbar), l = () => {
      e?.event.emit("openKeyboardInstructions");
    }, n = () => s.teleported;
    return (c, u) => (y(), A("div", Kr, [
      f("div", Qr, [
        ...
        a.value ? U("", !0) : (y(), W(Hr, { key: 0 })),
        re(Vr, { class: "z-30" })
      ]),
      S(t).started ? (y(), W(js, { key: 0 })) : (y(), A("div", eo, u[1] || (u[1] = [
        f("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (y(!0), A(qe, null, dt(n(), (p) => (y(), W(cs, {
...
const Eo = ["content"], xo = {
  ...
  setup(r, { expose: e }) {
    ...
    e({ el: a });
    const c = r, u = N(() => o?.fixture.get("appbar") ? s.temporary : []), p = N(() => i.mobileView), d = N(() => i.reorderable), v = (b) => b.scrollHeight > b.clientHeight, m = () => !p.value && !c.panel.teleport, g = (b) => {
    ...
    return Ye(() => {
      ...
      return M((y(), A("div", {
        ...
        r.header ? (y(), A("header", xo, [
          re(T, {
            class: oe(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: $[0] || ($[0] = (fe) => r.panel.close())
          }, null, 8, ["class"]),
          M((y(), A("h2", So, [
            b.$slots.header ? ke(b.$slots, "header", { key: 0 }) : (y(), A("div", _o, B(S(t)(r.panel.alertName)), 1))
          ])), [
            [_]
          ]),
          ...
          f("div", {
            ...
            r.panel.teleport ? U("", !0) : (y(), A("div", Io, [
              d.value ? (y(), W(F, {
                key: 0,
              ...
              r.panel.controls && r.panel.controls.expand ? (y(), W(Mt, {
                key: 2,
                onClick: $[4] || ($[4] = (fe) => r.panel.expand()),
                active: r.panel.expanded
              }, null, 8, ["active"])) : U("", !0)
            ])),
            r.panel.button && u.value?.includes(r.panel.id) ? (y(), W(Pt, {
              key: 1,
        ...
        r.content ? (y(), A("div", {
          ...
          b.$slots.content ? ke(b.$slots, "content", { key: 0 }) : w.value ? (y(), A("div", {
            key: 1,
            innerHTML: w.value.innerHTML
          }, null, 8, To)) : U("", !0)
        ], 512)) : U("", !0),
        r.footer ? M((y(), A("div", Lo, [
          ke(b.$slots, "footer")
        ])), [
          [R]
        ]) : U("", !0)
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return y(), W(a, {
        ...
        default: ee(() => [
          S(t).isFullscreen ? (y(), A("svg", ia, o[0] || (o[0] = [
            f("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
...
const yi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", vi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", bi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", wi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", Ta = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
class Ai {
  ...
  constructor(e, t) {
    ...
    l ? (i = l.geoLocation ? l.geoLocation : yi, s = l.geoNames ? l.geoNames : vi, o = l.geoProvince ? l.geoProvince : bi, a = l.geoTypes ? l.geoTypes : wi) : (i = yi, s = vi, o = bi, a = wi), i = i.replace("@{language}", e), s = s.replace("@{language}", e), o = o.replace("@{language}", e), a = a.replace("@{language}", e);
    const n = t?.settings;
    let c, u, p, d, v;
...
class Da {
    ...
    if (t?.configs !== void 0) {
      ...
      if (c.panels) {
        if (c.panels.open && c.panels.open.length > 0) {
          const m = c.panels.open.map((g) => g.id);
   ...
   */
  reload(e, t) {
    const i = it(this.$vApp.$pinia), s = Te(this.$vApp.$pinia), o = de(this.$vApp.$pinia), a = ye(this.$vApp.$pinia), l = _e(this.$vApp.$pinia), n = qt(this.$vApp.$pinia), c = !!e;
...
function Ga(r, e) {
  ...
  s.directive("focus-container", go), s.directive("focus-list", uo), s.directive("focus-item", ho), s.directive("truncate", wo), s.component("panel-screen", Ro), s.component("pin", ko), s.component("close", No), s.component("back", Go), s.component("expand", jo), s.component("panel-options-menu", ta), s.component("dropdown-menu", Xt), s.component("minimize", Ho), s.component("right", Zo), s.component("left", Xo), s.component("fullscreen-nav-button", ra), s.component("geolocator-nav-button", oa), s.component("home-nav-button", aa), s.component("mapnav-button", ca), s.component("appbar-button", ha), s.component("transition", Ri), s.component("transition-group", $i), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.config.idPrefix = `ramp-${r.id || e.geo.shared.generateUUID()}`, s.provide("iApi", e);
  const o = s.mount(r);
...
class Zi extends ii {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = L.NONE, this.dataFormat = X.UNKNOWN, this.layerType = x.UNKNOWN, this.layerFormat = ge.UNKNOWN;
...
class on extends Ze {
  constructor(e, t) {
    super(e, t), this.dataFormat = X.ESRI_FEATURE, this.layerFormat = ge.GRAPHIC, this.hovertips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
...
class Ke extends si {
  ...
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = X.ESRI_FEATURE, this.layerFormat = ge.FEATURE, this.tooltipField = "", this.layerIdx = 0, e.identifyMode && e.identifyMode !== Q.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = Q.HYBRID;
  }
  async reload() {
  ...
  runIdentify(e) {
    ...
    return e.hitTest && (this.identifyMode === Q.HYBRID || this.identifyMode === Q.SYMBOLIC) && (s = o.then(async () => {
      ...
      a.forEach((n) => {
        i.items.push(yt.makeRawItem(at.ESRI, n.attributes));
      }), l.forEach((n) => {
        i.items.push(yt.makeOidItem(n, this));
...
class hn extends si {
  tooltipField;
  constructor(e, t) {
    super(e, t), this.dataFormat = X.ESRI_FEATURE, this.tooltipField = "", this.supportsIdentify = !0, this.layerType = x.FEATURE, this.layerFormat = ge.FEATURE, e.identifyMode && e.identifyMode !== Q.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = Q.HYBRID;
  }
  async onInitiate() {
...
class mn extends si {
  tooltipField;
  constructor(e, t, i) {
    if (super(e, t), this.layerType = x.SUBLAYER, this.layerFormat = ge.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.dataFormat = X.ESRI_FEATURE, this.supportsFeatures = !0, this.tooltipField = "", this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
...
class gn extends Ze {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.OSM, this.layerFormat = ge.OSM, this.dataFormat = X.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
...
class yn extends Ze {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.IMAGERY, this.layerFormat = ge.IMAGERY, this.dataFormat = X.ESRI_RASTER;
  }
  async onInitiate() {
...
class vn extends Ze {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = x.TILE, this.layerFormat = ge.TILE, this.dataFormat = X.ESRI_TILE;
  }
  async onInitiate() {
...
class bn extends Ze {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = x.WMS, this.layerFormat = ge.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = X.OGC_RASTER, this.identifyMode = Q.GEOMETRIC;
  }
  async onInitiate() {
  ...
  runIdentify(e) {
    ...
    return this.getFeatureInfo(this.sublayerNames, e.geometry, this.mimeType).then((s) => {
      if (s) {
        let o = !0, a;
        typeof s != "string" ? a = at.JSON : s.indexOf("Search returned no results") === -1 && s !== "" ? a = at.TEXT : (o = !1, a = at.UNKNOWN), o && i.items.push(yt.makeRawItem(a, s));
      }
      i.loaded = !0, t.resolveMe();
    }).catch(() => {
      i.errored = !0, t.resolveMe();
...
class Ki extends Zi {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = X.ESRI_FEATURE, this.layerFormat = ge.NOLAYER, this.drawState = pe.NOT_VISUAL, this.attribs = new Qi(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
...
class Rn extends Z {
  ...
  async symbolToSvg(e) {
    ...
    const o = et(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), a = {
      ...
      none: () => "transparent",
      // esriSFSNull
      horizontal: (m, g) => o.pattern(5, 5, (b) => b.line(0, 5 / 2, 5, 5 / 2)).stroke(g),
      vertical: (m, g) => o.pattern(5, 5, (b) => b.line(5 / 2, 0, 5 / 2, 5)).stroke(g),
      "forward-diagonal": (m, g) => o.pattern(5, 5, (b) => {
        b.line(0, 0, 5, 5).stroke(g), b.line(0, 0, 5, 5).move(0, 5).stroke(g), b.line(0, 0, 5, 5).move(5, 0).stroke(g);
      }),
      "backward-diagonal": (m, g) => o.pattern(5, 5, (b) => {
        b.line(5, 0, 0, 5).stroke(g), b.line(5, 0, 0, 5).move(5 / 2, 5 / 2).stroke(g), b.line(5, 0, 0, 5).move(-5 / 2, -5 / 2).stroke(g);
      }),
      cross: (m, g) => o.pattern(5, 5, (b) => {
        b.line(5 / 2, 0, 5 / 2, 5).stroke(g), b.line(0, 5 / 2, 5, 5 / 2).stroke(g);
      }),
      "diagonal-cross": (m, g) => o.pattern(7, 7, (b) => {
      ...
      "picture-fill"() {
        const m = e.imageData ? `data:${e.contentType};base64,${e.imageData}` : e.url, g = e.width * e.xscale, w = e.height * e.yscale;
        e.outline = e.outline || c;
        const b = v(e.outline.color), $ = d({
          color: b.colour,
          opacity: b.opacity,
      ...
      "picture-marker"() {
        const m = e.source, g = m && m.imageData ? `data:${m.contentType};base64,${m.imageData}` : e.url;
...
const On = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-CwLWWQlf.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-CAYcP_oN.js"), "../fixtures/basemap/index.ts": () => import("./index-Dpoti4Eq.js"), "../fixtures/crosshairs/index.ts": () => import("./index-o0btL892.js"), "../fixtures/details/index.ts": () => import("./index-CytFRiSZ.js"), "../fixtures/export-footnote/index.ts": () => import("./index-1Jddl6Bn.js"), "../fixtures/export-legend/index.ts": () => import("./index-W9YOKK20.js"), "../fixtures/export-map/index.ts": () => import("./index-U-e2GXYi.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-yLEqSkFV.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DkseAKAq.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-BeOEB6mn.js"), "../fixtures/export-title/index.ts": () => import("./index-BGyAF77X.js"), "../fixtures/export/index.ts": () => import("./index-CwwtQekj.js"), "../fixtures/extentguard/index.ts": () => import("./index-CkpaLvGx.js"), "../fixtures/gazebo/index.ts": () => import("./index-BXcoSUQy.js"), "../fixtures/geosearch/index.ts": () => import("./index-DbRDo46C.js"), "../fixtures/grid/index.ts": () => import("./index-DmkTa4Zz.js"), "../fixtures/help/index.ts": () => import("./index-BY_EGRp6.js"), "../fixtures/hilight/index.ts": () => import("./index-D-vAwHHJ.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-C_T0IpIQ.js"), "../fixtures/legend/index.ts": () => import("./index-BiLDwOYZ.js"), "../fixtures/mapnav/index.ts": () => import("./index-DVT16qH3.js"), "../fixtures/metadata/index.ts": () => import("./index-ajIrsJWu.js"), "../fixtures/northarrow/index.ts": () => import("./index-DyHCcX-F.js"), "../fixtures/overviewmap/index.ts": () => import("./index-BVQsovjl.js"), "../fixtures/panguard/index.ts": () => import("./index-5M643W2p.js"), "../fixtures/scrollguard/index.ts": () => import("./index-BDnA7Rg-.js"), "../fixtures/settings/index.ts": () => import("./index-Sp8gsldw.js"), "../fixtures/snowman/index.ts": () => import("./index-DgV2FYIE.js"), "../fixtures/wizard/index.ts": () => import("./index-C4O5YccR.js") });
class kn extends Z {
  /**
...
const Dn = /* @__PURE__ */ Pe(Nn, [["render", Fn], ["__scopeId", "data-v-a3c61802"]]), Gn = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-BFbofCU0.js"), "../fixtures/basemap/screen.vue": () => import("./screen-C7in0Xgc.js"), "../fixtures/export/screen.vue": () => import("./screen-B4l_6f8Z.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-BGBpNJgc.js"), "../fixtures/grid/screen.vue": () => import("./screen-CZ18Nlto.js"), "../fixtures/help/screen.vue": () => import("./screen-Cm5Vz0kz.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-DRGJPn_b.js"), "../fixtures/legend/screen.vue": () => import("./screen-CSw3vnqH.js"), "../fixtures/metadata/screen.vue": () => import("./screen-DPh8hag7.js"), "../fixtures/settings/screen.vue": () => import("./screen-CQOKyvlc.js"), "../fixtures/wizard/screen.vue": () => import("./screen-wnfLgAcW.js") });
class At extends Z {
  /**
   * ID of this panel.
   *
...
var st = { major: "4", minor: "12", patch: "0-beta", timestamp: "Thu Apr 10 12:17:05 2025 -0400", hash: "bec160f7ec4ab8ae0151a74d90a3ac616e7ebe43" };
console.info(
