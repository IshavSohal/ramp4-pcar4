import { af as le, hX as ue } from "./main-CogLml66.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-A7zDYVJ5.js").then((i) => i.l) : await import("./libtess-D2UUzB55.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-YWdd5Bt6.js.map
