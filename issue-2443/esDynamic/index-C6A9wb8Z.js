import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-CogLml66.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-BvqE2c0w.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-Bp7MJBVI.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-rWOBQePu.js")).default, n = (await import("./index-C8mas1LY.js")).default, a = (await import("./index-B1dEXcEh.js")).default, w = (await import("./index-DvjlzqRG.js")).default, p = (await import("./index-B6ITrFKv.js")).default, r = (await import("./index-BFzl0VLH.js")).default, b = (await import("./index-DySdGKb7.js")).default;
...
//# sourceMappingURL=index-C6A9wb8Z.js.map
