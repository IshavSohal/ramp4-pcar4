import { hX as K, bh as D } from "./main-CogLml66.js";
import { y as X } from "./DoubleArray-D5RswEi_.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-DNGnaspw.js";
import { n as Z, s as ee } from "./vec3-Ds5ciLKL.js";
import "./sphere-MGGcNA5a.js";
import "./I3SUtil-kwBlr3sh.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-BbKweP99.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-CogLml66.js").then((d) => d.qK), import("./main-CogLml66.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-bcGX5jNb.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-CT7xrTpP.js.map
