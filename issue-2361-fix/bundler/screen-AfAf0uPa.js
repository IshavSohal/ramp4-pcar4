...
const Yt = { class: "h-full flex items-center justify-center" }, Zt = ["placeholder", "aria-label", "disabled"], Qt = ["placeholder", "aria-label", "disabled"], Xt = {
  ...
  setup(_) {
    const n = [re.OID, re.DOUBLE, re.SINGLE, re.INTEGER], e = oe("iApi"), a = tt(), l = fe(), r = O(() => l.mobileView), i = C(!r.value), d = C(), v = kt("gridContainer"), { t: b, locale: x } = N(), h = () => Mt()?.proxy?.$forceUpdate(), L = _, c = C({
      id: "dummy",
      layerIds: [],
      state: new It(),
      fieldMap: {}
    ...
    return X(() => {
      ...
      return E(), k("div", {
        ...
        F(o("div", Ol, [
          ...
          o("div", ql, [
            o("span", Wl, T(ie.value.reduce((f, w) => f + w, 0) < Ee.value ? y(b)("grid.splash.loading") : y(b)("grid.splash.building")), 1)
          ]),
          o("div", null, [
            o("button", {
              type: "button",
        ...
        F(o("div", Zl, [
          o("div", Ql, [
            ...
            F((E(), k("div", Jl, [
              ...
              q.value.visibleRows !== ue.value.length ? (E(), k("span", ea, T(y(b)("grid.filters.label.filtered", {
                max: ue.value.length
              })), 1)) : R("", !0)
            ])), [
              [u]
...
}), _a = /* @__PURE__ */ ge(La, [["__scopeId", "data-v-92d0dc1b"]]), Ea = /* @__PURE__ */ D({
  __name: "screen",
  props: {
    panel: {
      type: et,
