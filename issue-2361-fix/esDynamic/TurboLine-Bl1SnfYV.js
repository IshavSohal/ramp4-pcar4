import { af as le, hX as ue } from "./main-CSz95fEX.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-CCMHSuJ0.js").then((i) => i.l) : await import("./libtess-BrcsGrQd.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-Bl1SnfYV.js.map
