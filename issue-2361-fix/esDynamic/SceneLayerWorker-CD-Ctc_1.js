import { hX as K, bh as D } from "./main-CSz95fEX.js";
import { y as X } from "./DoubleArray-LMnr5Cno.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-CGn-UYaE.js";
import { n as Z, s as ee } from "./vec3-DTk3U8-R.js";
import "./sphere-D8EG4ZjK.js";
import "./I3SUtil-C9SY0Vuo.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-CSDXAWJu.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-CSz95fEX.js").then((d) => d.qK), import("./main-CSz95fEX.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-Bo_xpCZW.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-CD-Ctc_1.js.map
