import { hX as K, bh as D } from "./main-CAZsdGtE.js";
import { y as X } from "./DoubleArray-B_CRqLPv.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-D5XQrP7s.js";
import { n as Z, s as ee } from "./vec3-BBINXoc-.js";
import "./sphere-C7VPaAJi.js";
import "./I3SUtil-BfwLzuw9.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-DBXvYziz.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-CAZsdGtE.js").then((d) => d.qK), import("./main-CAZsdGtE.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-DBXfKB20.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-B_DB89oO.js.map
