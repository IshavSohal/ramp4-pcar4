import { iO as A, iP as y, bx as M, fB as $, ha as O, fK as D, hb as B } from "./main-CAZsdGtE.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-Bd5JvaPs.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-cJzP3H24.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-CvpIXNON.js")).default, n = (await import("./index-CDrqcIPP.js")).default, a = (await import("./index-TwFLq_N8.js")).default, w = (await import("./index-3W-uNNAf.js")).default, p = (await import("./index-WMW2o9TJ.js")).default, r = (await import("./index-DbcAh1Zc.js")).default, b = (await import("./index-BTdzFqBJ.js")).default;
...
//# sourceMappingURL=index-EUJ6qt2l.js.map
