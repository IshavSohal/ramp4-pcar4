import { af as le, hX as ue } from "./main-CAZsdGtE.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-C7q8CW9h.js").then((i) => i.l) : await import("./libtess-DEZcNaju.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-BS0-4P3U.js.map
