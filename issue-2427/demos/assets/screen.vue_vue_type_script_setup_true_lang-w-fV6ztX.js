import { bF as defineComponent, bG as useI18n, fE as usePanelStore, fF as useExportStore, bL as computed, bM as resolveComponent, bN as resolveDirective, bV as withDirectives, bQ as openBlock, bO as createBlock, bP as withCtx, fG as createBaseVNode, bW as createElementBlock, bY as renderList, fH as normalizeClass, bS as toDisplayString, bT as unref, bX as Fragment, bH as inject, bI as ref, fI as useTemplateRef, fJ as debounce, fK as onBeforeMount, fL as watch, bJ as onMounted, bK as onBeforeUnmount, bR as createTextVNode, fM as createCommentVNode } from './main-Dj2TL05W.js';
      ...
      return openBlock(), createBlock(_component_panel_screen, {
        ...
        content: withCtx(() => [
          createBaseVNode("div", {
            ...
            createBaseVNode("canvas", { class: "export-canvas !w-[100%]" }, null, -1)
          ]), 512)
        ]),
        footer: withCtx(() => [
          createBaseVNode("div", _hoisted_1, [
            ...
            }, toDisplayString(unref(t)("export.download")), 9, _hoisted_2),
            createBaseVNode("button", {
              type: "button",
              onClick: _cache[1] || (_cache[1] = ($event) => unref(make)()),
              class: "py-8 px-4 sm:px-16",
              "aria-label": unref(t)("export.refresh")
            }, toDisplayString(unref(t)("export.refresh")), 9, _hoisted_3),
