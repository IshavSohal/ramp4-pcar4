...
export declare class PanelAPI extends APIScope {
    panelStore: import('pinia').Store<"panel", import('pinia')._UnwrapAll<Pick<import('../stores/panel').PanelStore, "pinned" | "priority" | "stackWidth" | "remWidth" | "mobileView" | "reorderable" | "items" | "regPromises" | "orderedItems" | "teleported" | "visible">>, Pick<import('../stores/panel').PanelStore, "getRemainingWidth">, Pick<import('../stores/panel').PanelStore, "remove" | "close" | "open" | "move" | "getVisible" | "getRegPromises" | "openPanel" | "closePanel" | "movePanel" | "removePanel" | "setStackWidth" | "setMobileView" | "updateVisible" | "registerPanel" | "addRegPromise">>;
