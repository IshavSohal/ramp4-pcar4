import { af as le, hX as ue } from "./main-DeGq1-p9.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-D_zDtu3X.js").then((i) => i.l) : await import("./libtess-wTxaWH3W.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-BahZw1dB.js.map
