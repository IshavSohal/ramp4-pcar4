import { hX as T } from "./main-DeGq1-p9.js";
...
function y() {
  return new Promise((t) => import("./lyr3DWorker-Dz_eH2De.js").then((r) => r.l).then(({ default: r }) => {
...
//# sourceMappingURL=Lyr3DWorker-DXSE-ejr.js.map
