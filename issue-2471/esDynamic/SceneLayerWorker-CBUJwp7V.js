import { hX as K, bh as D } from "./main-DeGq1-p9.js";
import { y as X } from "./DoubleArray-D4u8CuwT.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-DtQlTEYG.js";
import { n as Z, s as ee } from "./vec3-CUwIVrkG.js";
import "./sphere-BOJefQBt.js";
import "./I3SUtil-DyoPnr7m.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-BMQydDk7.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-DeGq1-p9.js").then((d) => d.qK), import("./main-DeGq1-p9.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-DQJQatY0.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-CBUJwp7V.js.map
