...
import "tiny-emitter";
import { G as re, L as ve, F as be } from "./main-Cgw6vbGY.js";
...
class ut extends xe {
  async init() {
    ...
    this.$vApp.$el.getElementsByClassName("inner-shell")[0].appendChild(r.childNodes[0]), Object.entries(Pe).forEach((t) => this.$iApi.$i18n.mergeLocaleMessage(...t)), this._parseConfig(this.config), Y(this.$vApp.$pinia).supportedTypes.forEach((t) => {
      const n = `${t.type}-icon`;
      this.$iApi.component(n, fe(Ae(/* @__PURE__ */ Object.assign({ "./icons/circle-icon.vue": () => import("./circle-icon-BuLL_Hij.js"), "./icons/edit-icon.vue": () => import("./edit-icon-WXVJUKOT.js"), "./icons/point-icon.vue": () => import("./point-icon-B4W32I_m.js"), "./icons/polygon-icon.vue": () => import("./polygon-icon-CmnA-_UH.js"), "./icons/polyline-icon.vue": () => import("./polyline-icon-t4yCu9a9.js"), "./icons/rectangle-icon.vue": () => import("./rectangle-icon-ClGn1758.js") }), `./icons/${t.type}-icon.vue`, 3)));
    });
  }
  async added() {
