...
import { _ as H, d as L, F as K, G as X } from "./main-Cgw6vbGY.js";
...
const G = /* @__PURE__ */ H(te, [["render", ne]]), ie = /* @__PURE__ */ I({
  ...
  setup(f) {
    const i = S("iApi"), { t } = B(), o = ee(), p = [
      {
        type: "point",
        icon: g(_(() => import("./point-icon-B4W32I_m.js")))
      },
      {
        type: "polyline",
        icon: g(_(() => import("./polyline-icon-t4yCu9a9.js")))
      },
      {
        type: "polygon",
        icon: g(_(() => import("./polygon-icon-CmnA-_UH.js")))
      },
      {
        type: "circle",
        icon: g(_(() => import("./circle-icon-BuLL_Hij.js")))
      },
      {
        type: "rectangle",
        icon: g(_(() => import("./rectangle-icon-ClGn1758.js")))
      }
    ], a = M(() => {
      const s = p.filter((u) => o.supportedTypes.some((x) => x.type === u.type));
      return s.push({
        type: "edit",
        icon: g(_(() => import("./edit-icon-WXVJUKOT.js")))
      }), s;
    }), n = (s) => {
