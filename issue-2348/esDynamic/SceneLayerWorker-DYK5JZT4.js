import { fq as q, bx as v, cy as K } from "./main-Dm62uCOY.js";
import { y as Q } from "./DoubleArray-YkBQyqzY.js";
import { i as W, a as X } from "./MeshLocalVertexSpace-9vDh2tMv.js";
import { f as Z, l as ee } from "./vec3-DMA3DxBl.js";
import "./sphere-DIaRQnyS.js";
import "./I3SUtil-DCFBkadM.js";
var U, D;
(function(e) {
...
function te() {
  return _ || (_ = new Promise((e) => import("./i3s-BqbW2-Cu.js").then((t) => t.i).then(({ default: t }) => {
...
async function pe(e) {
  ...
  let s;
  const [{ projectBuffer: I }, { initializeProjection: M }] = await Promise.all([import("./main-Dm62uCOY.js").then((a) => a.r9), import("./main-Dm62uCOY.js").then((a) => a.ra)]);
  await M(c, l);
  const g = [0, 0, 0];
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    ...
    const a = i.type === "georeferenced" ? W.fromJSON(i) : X.fromJSON(i), { project: m } = await import("./projection-Bdjpio0r.js"), d = m({ positions: f, transform: t ? { localMatrix: t } : void 0, vertexSpace: a, inSpatialReference: c, outSpatialReference: l, localMode: u });
...
//# sourceMappingURL=SceneLayerWorker-DYK5JZT4.js.map
