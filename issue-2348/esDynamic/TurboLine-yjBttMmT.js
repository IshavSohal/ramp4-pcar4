import { a9 as Et, fq as bt } from "./main-Dm62uCOY.js";
...
async function Mt() {
  gt = await (Et("esri-csp-restrictions") ? await import("./libtess-asm-CDLGhWVg.js").then((i) => i.l) : await import("./libtess-C568Y7OI.js").then((i) => i.l)).default({ locateFile: (i) => bt(`esri/core/libs/libtess/${i}`) });
}
function $t(x, i) {
...
//# sourceMappingURL=TurboLine-yjBttMmT.js.map
