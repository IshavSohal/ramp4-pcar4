import { defineComponent as C, computed as h, resolveComponent as k, resolveDirective as O, withDirectives as R, openBlock as i, createBlock as $, unref as r, withCtx as m, createElementVNode as e, createElementBlock as S, Fragment as j, renderList as V, normalizeClass as y, toDisplayString as w, inject as q, ref as b, useTemplateRef as A, onBeforeMount as D, watch as N, onMounted as P, onBeforeUnmount as F, createTextVNode as T, createCommentVNode as H } from "vue";
import { debounce as I } from "throttle-debounce";
import { useI18n as z } from "vue-i18n";
import { a as U, f as L } from "./main-CAlY8wv7.js";
const W = ["onClick", "aria-label"], G = { class: "md-icon-small inline" }, J = /* @__PURE__ */ C({
  ...
  setup(v) {
    const { t: f } = z(), s = U(), u = L(), _ = h(() => s.mobileView ? "top-end" : "left-end"), l = (a) => {
  ...
  ref: "componentEl"
}, Q = { class: "flex" }, X = ["aria-label"], Y = ["aria-label"], le = /* @__PURE__ */ C({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(v) {
    const f = v, { t: s } = z(), u = q("iApi"), _ = L(), l = b(), a = b(void 0), n = b(void 0), x = b([]), p = A("componentEl"), o = h(() => _.componentSelectedState), g = h(() => {
      let c = {};
    ...
    }), E = h(() => !!l.value?.customRendererFunc), d = I(300, () => {
      if (!l.value || !p.value)
        return;
