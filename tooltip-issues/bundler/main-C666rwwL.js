...
import { dsv as pi, csv2geojson as js } from "csv2geojson";
...
class ue extends He {
  ...
  rawArray;
  constructor(e, t, i, s) {
    super(e, t.sr || i), s ? this.rawArray = ue.arrayDeepCopy(t) : t instanceof ue ? this.rawArray = t.toArray() : this.rawArray = ue.parsePointSet(t);
  }
...
class ge extends He {
  ...
  constructor(e, t, i, s) {
    if (super(e, t.sr || i), s)
      ...
      this.rawArray = t.map((o) => ue.parsePointSet(o));
    } else
  ...
  updateAt(e, t) {
    this.rawArray[t] = ue.parsePointSet(e);
  }
...
class $e extends He {
  ...
  static parseMultiPolygon(e) {
    ...
    if (e instanceof te)
      return [e.toArray()];
    if (e instanceof ge || e instanceof ue)
...
class Ys {
  ...
  async projectExtent(e, t) {
    ...
    const n = new te("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, n), a = l.toArray().pop() || [], c = a.map((h) => h[0]), u = a.map((h) => h[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), v = Math.min.apply(null, u), f = Math.max.apply(null, u);
    return N.fromParams(t.id + "_projected", p, v, d, f, l.sr);
  }
}
class Js {
  // useful functions
...
const or = ["data-cy"], Wi = /* @__PURE__ */ C({
  ...
  const r = m(void 0), e = m(void 0), t = m(0), i = m(0), s = m(!1), o = m(!0), n = m({}), l = m({}), a = m([]), c = m([]), u = m([]), p = M(() => i.value);
  function d(E) {
  ...
  setup(r) {
    ...
    return (c, u) => (y(), V($i, {
      ...
      default: X(() => [
        (y(!0), b(Ve, null, ut(o(_(t).screenSize), (p) => (y(), V(Wi, {
          key: `${p.id}`,
          panel: p
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  function s(c) {
    if (r.value.includes(c)) {
      ...
      c instanceof Hi && a(c), u > -1 && r.value.splice(u, 1);
    }
  }
  function o(c) {
    e.value[c.id] = c;
...
}), cr = { class: "h-full flex flex-col" }, ur = { class: "w-full flex mb-6" }, pr = ["content", "aria-label"], dr = /* @__PURE__ */ C({
  __name: "screen",
  props: {
    panel: {
      type: Object,
...
const fr = ["content"], mr = { class: "flex items-center text-left" }, gr = { class: "select-text cursor-text" }, yr = ["content"], vr = {
    ...
    return (a, c) => {
      ...
      return k((y(), b("li", {
        ...
        r.notification.messageList && s.value ? (y(), b("div", vr, [
          (y(!0), b(Ve, null, ut(r.notification.messageList, (p, d) => (y(), b("p", {
  ...
  setup(r) {
    ...
    return (l, a) => {
      const c = O("focus-item"), u = O("focus-list"), p = O("tippy");
      return y(), b("div", null, [
        n.value.length > 0 ? k((y(), b("ul", {
          ...
          (y(!0), b(Ve, null, ut(n.value, (d, v) => (y(), b(Ve, {
            key: d.message + v
          }, [
            v > 0 ? (y(), b("div", wr)) : F("", !0),
            k(se(br, {
  ...
  __name: "map-caption",
  setup(r) {
    const e = Fe(), t = ce(), { t: i } = j(), s = be("iApi"), o = M(() => e.scale), n = M(() => e.attribution), l = M(() => e.coords), a = M(() => e.langtoggle), c = M(() => t.config.map), u = m([]), p = ye([]);
    p.push(
      Et(c, (h) => {
      ...
      return y(), b("div", Vr, [
        ...
        g("div", Yr, [
          ...
          a.value?.disabled ? F("", !0) : (y(), V(A, {
            ...
            default: X(() => [
              (y(!0), b(Ve, null, ut(u.value, ($, W) => (y(), b("a", {
                key: `${$}-${W}`,
    ...
    return (c, u) => {
      ...
      return i.value ? (y(), b("div", {
        ...
        g("div", {
          ...
          (y(!0), b(Ve, null, ut(s.value, (d) => (y(), b("p", {
...
}), Xe = G("instance", () => ({ started: m(!1) })), co = { class: "h-full relative" }, uo = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, po = { class: "absolute top-8 w-full flex justify-center" }, ho = {
  key: 1,
  class: "w-full h-full"
}, fo = /* @__PURE__ */ C({
  __name: "shell",
  setup(r) {
    ...
    return (c, u) => (y(), b("div", co, [
      ...
      _(t).started ? (y(), V(rr, { key: 0 })) : (y(), b("div", ho, u[1] || (u[1] = [
        g("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (y(!0), b(Ve, null, ut(a(), (p) => (y(), V(ds, {
...
const Mo = ["content"], Po = {
  ...
  setup(r, { expose: e }) {
    ...
    e({ el: n });
    const l = r, a = M(() => o?.fixture.get("appbar") ? s.temporary : []), c = M(() => i.mobileView), u = M(() => i.reorderable), p = () => !c.value && !l.panel.teleport, d = (f) => {
    ...
    return We(() => {
      ...
      const w = Z("back"), A = Z("panel-options-menu"), q = Z("left"), L = Z("right"), $ = Z("pin"), W = Z("expand"), pe = Z("minimize"), pt = Z("close"), Mt = O("truncate"), Pt = O("focus-item"), Nt = O("tippy");
      return k((y(), b("div", {
        ...
        r.header ? (y(), b("header", Po, [
          ...
          g("div", {
            ...
            r.panel.button && a.value?.includes(r.panel.id) ? (y(), V(pe, {
              key: 1,
...
}), ln = { class: "relative" }, cn = ["content", "aria-label"], un = /* @__PURE__ */ C({
  __name: "right",
  props: {
    active: Boolean
  },
...
}), pn = { class: "relative" }, dn = ["content", "aria-label"], hn = /* @__PURE__ */ C({
  __name: "left",
  props: {
    active: Boolean
  },
...
class Ai {
  ...
  constructor(e, t) {
    ...
    const a = t?.settings;
    let c, u, p, d, v;
    a ? (c = a.categories ? a.categories : [], u = a.sortOrder ? a.sortOrder : [], p = a.disabledSearchTypes ? a.disabledSearchTypes : [], d = a.maxResults > 0 ? a.maxResults : 100, v = !!a.officialOnly) : (c = [], u = [], p = [], d = 100, v = !1), this.config = {
      language: e,
      geoNameUrl: s,
      geoLocateUrl: i,
      types: Pn(e, n),
...
const zn = G("geosearch", () => {
  const r = m(new Ai("en", void 0)), e = m({
    ...
    province: "",
    extent: void 0
  }), t = m(!1), i = m(""), s = m(""), o = m(""), n = m([]), l = m([]), a = m(!1), c = m([]), u = M(
    () => new Promise((L) => {
      r.value.fetchProvinces().then(($) => {
        $.sort((W, pe) => W.name > pe.name ? 1 : -1), L($);
      });
    })
  ), p = M(
    () => new Promise((L) => {
  ...
  function v(L) {
    ...
    if (!$)
      ...
      const W = setInterval(() => {
        r.value.config.provinces.listFetched && r.value.config.types.typesFetched && (clearInterval(W), r.value.query(`${$}*`).then((pe) => {
          c.value = pe.failedServs, o.value = $, l.value = pe.results;
          const pt = wi(
            t.value,
            //@ts-ignore
            e.value,
  ...
  initialize(e, t, i) {
    ...
    if (t?.configs !== void 0) {
      ...
      const u = setInterval(() => {
        ...
        if (f && (clearInterval(u), this.geo.map.createMap(c.map, f), f._tippy.hide(0), n.setMaptipInstance(f._tippy), c.layers && c.layers.length > 0)) {
          let h = 0;
          c.layers.forEach((w) => {
...
function Xn(r, e) {
  ...
  s.directive("focus-container", Lo), s.directive("focus-list", xo), s.directive("focus-item", _o), s.directive("truncate", Oo), s.component("panel-screen", zo), s.component("pin", Wo), s.component("close", Jo), s.component("back", Qo), s.component("expand", rn), s.component("panel-options-menu", mn), s.component("dropdown-menu", Xt), s.component("minimize", an), s.component("right", un), s.component("left", hn), s.component("fullscreen-nav-button", vn), s.component("geolocator-nav-button", bn), s.component("home-nav-button", An), s.component("mapnav-button", xn), s.component("appbar-button", Tn), s.component("transition", Li), s.component("transition-group", $i), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.provide("iApi", e);
  const o = s.mount(r);
...
class ma extends J {
  ...
  extractCsvFields(e, t = ",") {
    return pi.dsvFormat(t).parseRows(e)[0].map((s) => ({ name: s, type: Le.STRING }));
  }
  /**
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    for (let h = 0; h < d.length; h++) {
      const w = d[h];
      w.geometry.spatialReference = p, w.geometry.type = n.geometryType, Object.keys(w.attributes).forEach((A) => {
  ...
  onLoadActions() {
    ...
    const o = [], n = (a, c) => {
      ...
      if (a.sublayers && a.sublayers.length > 0) {
        const d = (p ? p.name : "") || a.title || "", v = new _t(u, "", d, !1);
        c.findChildByIdx(u) || c.children.push(v), a.sublayers.reverse().forEach((f) => {
          n(f, v);
        });
      } else {
        ...
        if (d.isRemoved)
          return;
        if (d.name = p?.name || a.title || "", o.push(d), !c.children.map((v) => v.layerIdx).includes(u)) {
...
class ka extends Ye {
  ...
  getFeatureInfo(e, t, i) {
    ...
    let n, l;
    const a = s.getExtent(), c = o.spatialReferences, u = e.join(","), p = s.esriView.toScreen(t.toESRI()), d = Math.floor(p.x), v = Math.floor(p.y), h = {
...
const Wa = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-BTQi0hmt.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-KeTNEls3.js"), "../fixtures/basemap/index.ts": () => import("./index-6ZeWmm_a.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BON1X936.js"), "../fixtures/details/index.ts": () => import("./index-qI9byqwl.js"), "../fixtures/export-footnote/index.ts": () => import("./index-CaFMWLdJ.js"), "../fixtures/export-legend/index.ts": () => import("./index-DiW18Qic.js"), "../fixtures/export-map/index.ts": () => import("./index-DDD3D3j-.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-D6fNoH6j.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-C_aDahVE.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-CKOVZxHq.js"), "../fixtures/export-title/index.ts": () => import("./index-dZK6H_7d.js"), "../fixtures/export/index.ts": () => import("./index-Db2jOPoQ.js"), "../fixtures/extentguard/index.ts": () => import("./index-C9pymMCa.js"), "../fixtures/gazebo/index.ts": () => import("./index-D-unqHFR.js"), "../fixtures/geosearch/index.ts": () => import("./index-BOy_KgvM.js"), "../fixtures/grid/index.ts": () => import("./index-DVNhctcf.js"), "../fixtures/help/index.ts": () => import("./index-C2mCnDK3.js"), "../fixtures/hilight/index.ts": () => import("./index-B4xJAsn3.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-fJa6r-oa.js"), "../fixtures/legend/index.ts": () => import("./index-CnGKm0SG.js"), "../fixtures/mapnav/index.ts": () => import("./index-BcTK1PYv.js"), "../fixtures/metadata/index.ts": () => import("./index-C-L7m5ki.js"), "../fixtures/northarrow/index.ts": () => import("./index-CI4DFqkO.js"), "../fixtures/overviewmap/index.ts": () => import("./index-D8CPh7xN.js"), "../fixtures/panguard/index.ts": () => import("./index-DJKgDG97.js"), "../fixtures/scrollguard/index.ts": () => import("./index-DK2xHHMS.js"), "../fixtures/settings/index.ts": () => import("./index-VKAZFaUZ.js"), "../fixtures/snowman/index.ts": () => import("./index-C_Aop7cz.js"), "../fixtures/wizard/index.ts": () => import("./index-BAOlL4Sj.js") });
class Ha extends J {
  /**
...
const Qa = /* @__PURE__ */ ke(Za, [["render", Ka], ["__scopeId", "data-v-a3c61802"]]), Xa = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-BEWz-rGA.js"), "../fixtures/basemap/screen.vue": () => import("./screen-CJ-1O0I4.js"), "../fixtures/export/screen.vue": () => import("./screen-9dorgOWr.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-DoNJpgR7.js"), "../fixtures/grid/screen.vue": () => import("./screen-CgwpaQKy.js"), "../fixtures/help/screen.vue": () => import("./screen-B1a5H7SW.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-BAAlQx1H.js"), "../fixtures/legend/screen.vue": () => import("./screen-CIp-jzgn.js"), "../fixtures/metadata/screen.vue": () => import("./screen-Dr8IMFKK.js"), "../fixtures/settings/screen.vue": () => import("./screen-Biv8Wgie.js"), "../fixtures/wizard/screen.vue": () => import("./screen-DqJ6Kx5E.js") });
class wt extends J {
  /**
   * ID of this panel.
   *
...
var et = { major: "4", minor: "10", patch: "0-beta", timestamp: "Thu Dec 12 16:59:11 2024 -0500", hash: "7b7dc93627182e6b6047cddba53cec644a195f18" };
console.info(
