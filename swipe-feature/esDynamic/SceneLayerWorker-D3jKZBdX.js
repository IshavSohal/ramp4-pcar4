import { hX as K, bh as D } from "./main-guk43f7a.js";
import { y as X } from "./DoubleArray-DV8hcI_J.js";
import { i as Q, a as W } from "./MeshLocalVertexSpace-Dk19EYfs.js";
import { n as Z, s as ee } from "./vec3-CVITxXb4.js";
import "./sphere-CCQ5OBni.js";
import "./I3SUtil-CotETwcf.js";
var S, $;
(function(e) {
...
function te() {
  return x || (x = new Promise((e) => import("./i3s-CUeJH1gF.js").then((t) => t.i).then(({ default: t }) => {
...
async function be(e) {
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    const [{ projectBuffer: c }, { initializeProjection: b }] = await Promise.all([import("./main-guk43f7a.js").then((d) => d.qK), import("./main-guk43f7a.js").then((d) => d.qL)]);
    await b(f, l), s = new Float64Array(a.length), c(a, f, 0, s, l, 0, s.length / 3);
  } else {
    const c = i.type === "georeferenced" ? Q.fromJSON(i) : W.fromJSON(i), { project: b } = await import("./georeference-BCf4x36g.js").then((d) => d.g);
...
//# sourceMappingURL=SceneLayerWorker-D3jKZBdX.js.map
