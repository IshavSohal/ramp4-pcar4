import { af as le, hX as ue } from "./main-guk43f7a.js";
...
async function xe() {
  ee = await (le("esri-csp-restrictions") ? await import("./libtess-asm-CUVOOzgA.js").then((i) => i.l) : await import("./libtess-DBe4EbtR.js").then((i) => i.l)).default({ locateFile: (i) => ue(`esri/core/libs/libtess/${i}`) });
}
function sr(s, i) {
...
//# sourceMappingURL=TurboLine-wqRtkLsY.js.map
