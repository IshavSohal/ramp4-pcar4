const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["./basis_transcoder-B0zC_Mwh.js","./main-6KLKyala.js","./preload-helper-dJJaZANz.js","./main-DN5ApbYJ.css"])))=>i.map(i=>d[i]);
import { a as a$k } from './devEnvironmentUtils-CAuYLvCt.js';
import { co as U$1, cp as y$3, kw as i$b, hF as e$j, fv as o$r, cx as u$a, cw as g$5, qx as U$2, cl as n$8, eD as O$7, qy as i$c, qz as f$b, fi as i$d, h$ as n$9, H as s$f, s as s$g, cU as o$u, el as Z$1, lw as tt, fU as t$o, mw as u$c, J as s$h, qA as i$e, jP as m$b, lR as u$e, h4 as r$d, lT as l$f, hE as n$a, ih as t$q, eQ as S$3, nX as f$c, bo as i$f, qB as A$5, qC as G$2, ci as _$5, ck as z$3, aj as e$o, qD as g$6, cm as r$e, hB as s$i, hR as q$3, hQ as l$g, qE as H$3, qF as G$3, bw as l$h, hy as G$4, hH as l$i, cu as e$q, ms as i$i, aW as e$r, iY as j$3, c7 as s$j, hx as n$d, hW as r$g, aX as y$5, aY as c$g, dY as S$4, qG as l$j, hX as x$4, h7 as n$e, fy as o$y, b2 as d$e, gs as A$6, ay as n$f, j3 as e$s, ct as r$h, ch as P$3, fw as S$7, V as has, qH as e$u, iq as _$8, U as U$3, B as a$j, mu as r$i, qI as P$4, ju as h$d, j5 as h$e, nY as i$j, hz as A$8 } from './main-6KLKyala.js';
import { t as t$n, e as e$m, o as o$x } from './mat3f64-DiVtVT5k.js';
import { o as o$t, r as r$c, e as e$p } from './mat4f64-D1udxz0O.js';
import { x as x$3, c as c$f, y as y$4, u as u$f, q as q$4, i as i$h, L as L$4, O as O$a, E as E$8 } from './BufferView-DC3Y-TJB.js';
import { r as r$j, n as n$i, u as u$h } from './vec3-Jof5fFrr.js';
import { l as l$l, n as n$h, i as o$B, o as o$C, j as f$d, k as n$j, u as u$g, t as t$u, m as t$v } from './DefaultMaterial_COLOR_GAMMA-WhRtDgwo.js';
import { r as r$k } from './resourceUtils-DHRdYxSg.js';
import { t as t$t } from './NestedMap-DnQjTF8c.js';
import { t as t$l, l as l$e } from './Indices-C_dNRLrs.js';
import { t as t$p } from './requestImageUtils-CbzTmC6B.js';
import { O as O$8, L as L$3, t as t$s } from './orientedBoundingBox-HEp3tgeM.js';
import { t as t$m, u as u$d, a as a$g, i as i$g, N as N$6, s as s$k, e as e$t, n as n$g } from './basicInterfaces-WNnrzIVI.js';
import { d as d$d, e as e$l, o as o$s } from './triangle-Bs-kj4_e.js';
import { s as s$e } from './Util-DgvkFNmz.js';
...
import { m as m$a, a as u$b, e as e$n, c as a$h } from './Texture-D093N61m.js';
import { H as H$4 } from './InterleavedLayout-CowiwskE.js';
...
import { w as w$1, Z as Z$2 } from './sphere-BwSX567k.js';
import { a as a$f } from './BindType-KnpK3yZX.js';
import { n as n$c } from './symbolColorUtils-DztOK3KP.js';
import { o as o$w, r as r$f } from './doublePrecisionUtils-D7kjth1C.js';
import './RenderState-Bf2oUuZv.js';
import './quat-DNEVrSaD.js';
import './quatf64-BVXz_O4E.js';
import './computeTranslationToOriginAndRotation-B2ejBmcz.js';
import './plane-CAULi61B.js';
import './ObjectStack-CBJoU9Zc.js';
import './lineSegment-De3JcQU7.js';
...
function t$i(){if(null==s$b){const t=t=>n$9(`esri/libs/basisu/${t}`);s$b=__vitePreload(() => import('./basis_transcoder-B0zC_Mwh.js'),true?__vite__mapDeps([0,1,2,3]):void 0,import.meta.url).then((e=>e.b)).then((({default:e})=>e({locateFile:t}).then((e=>(e.initializeBasis(),delete e.then,e)))));}return s$b}let s$b;
