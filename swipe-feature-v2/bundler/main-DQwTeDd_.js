...
import Is, { setDefaultProps as Ts, useTippy as Ls } from "vue-tippy";
...
const Lt = z("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Lt(), t = we("iApi"), i = O(() => e.maptipPoint), s = O(() => e.maptipInstance), o = O(() => e.content), a = ve([]);
    a.push(
      Et(i, () => {
        if (i.value) {
...
const Ys = ["data-cy"], qi = /* @__PURE__ */ C({
  ...
  function K() {
    ...
    for (let Pe = n.value.length - 1; Pe >= 0; Pe--) {
      const Xe = n.value[Pe];
      let Te = Xe.width || he;
      if (s.value ? Te = x : Te += Qe, Xe.id === "grid" && (Te = Math.max(Math.min(Te, x), ci)), (x >= Te && !s.value || R.length === 0) && (x -= Te, R.unshift(Xe)), Xe.id === "grid" && x < ci)
        break;
    }
    ...
    !R.includes(r.value) && !s.value) {
      ...
      const Xe = n.value.indexOf(r.value), Te = n.value.indexOf(Pe), Gt = n.value.slice();
      Te > -1 && (Gt.splice(Xe, 1), Gt.splice(Te, 0, r.value)), n.value = Gt;
    }
    i.value = x, u.value = R;
  }
  function Ke(x) {
...
const sr = ["content"], rr = { class: "flex items-center text-left" }, or = { class: "select-text cursor-text" }, ar = ["content"], nr = {
...
}), wr = /* @__PURE__ */ Me(br, [["__scopeId", "data-v-3623a7d2"]]), Ar = { class: "flex hover:text-white" }, Er = ["aria-label"], xr = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Sr = { class: "pb-8 border-b border-gray-600 mb-10" }, _r = { class: "absolute right-5 top-5" }, Ir = { class: "select-text" }, Tr = { class: "font-bold cursor-text" }, Lr = { class: "text-sm cursor-text" }, Rr = { class: "text-sm cursor-text" }, $r = /* @__PURE__ */ C({
        ...
        default: te((u) => [
          f("div", xr, [
            f("div", null, [
              ...
              f("div", Ir, [
                f("div", null, [
                  f("span", Tr, B(t.value), 1),
                  f("span", Lr, " [" + B(i.value) + "] ", 1)
                ]),
                f("div", null, [
  ...
  setup(r) {
    ...
    return (w, v) => {
      const $ = Q("dropdown-menu"), T = M("truncate"), N = M("tippy");
      return g(), A("div", Or, [
        oe(Cr, {
  ...
  setup() {
    const r = hs();
    He(() => {
      new ji().observe(r?.proxy?.$refs["app-size"]), Ts({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const bo = "truncate-text", wo = "truncate-trigger", Ao = {
  ...
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${wo}]`)), Ls(r, {
...
const xo = ["content"], So = {
  ...
  setup(r, { expose: e }) {
    const { t } = H(), i = We(), s = Tt(), o = we("iApi"), a = pi("el"), l = pi("contentEl"), n = h();
    e({ el: a });
    ...
    return He(() => {
      ...
      const T = Q("back"), N = Q("panel-options-menu"), F = Q("left"), K = Q("right"), Ke = Q("pin"), Mt = Q("expand"), Pt = Q("minimize"), Nt = Q("close"), Ft = M("truncate"), Dt = M("focus-item"), x = M("tippy");
      return P((g(), A("div", {
...
const bi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", wi = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", Ai = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Ei = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", La = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
const Ra = z("geosearch", () => {
  const r = h(new xi("en", void 0)), e = h({
    ...
    () => new Promise((T) => {
      r.value.fetchProvinces().then((N) => {
        N.sort((F, K) => F.name > K.name ? 1 : -1), T(N);
      });
    })
  ), p = O(
    () => new Promise((T) => {
  ...
  function v(T) {
    ...
    T = T.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(), s.value = Array.from(T).map((F) => Object.keys(N).includes(F) ? "[" + F + N[F] + "]" : F.replace(/["$!*+?^{}()|[\]\\]/g, "").replace(/[.\\]/g, "\\$&").trim()).join("");
  }
  function $(T) {
...
class Ga {
   ...
   */
  initialize(e, t, i) {
    const s = pe(this.$vApp.$pinia), o = We(this.$vApp.$pinia), a = Lt(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
...
class Qi extends ri {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = L.NONE, this.dataFormat = ee.UNKNOWN, this.layerType = S.UNKNOWN, this.layerFormat = me.UNKNOWN;
...
class oi extends Je {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = L.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new Bi(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new es();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class wn extends Je {
  ...
  getFeatureInfo(e, t, i) {
    ...
    }), Object.keys(v).forEach((T) => l[T] = v[T]), Ue(o.url.split("?")[0], {
      query: l,
      responseType: y
    });
  }
...
class Rn extends ni {
  ...
  constructor(e, t, i = !1) {
    if (super(e, t, i), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((s, o) => {
      const a = o === 0, l = new Li(this, s.minValue, s.maxValue, a);
...
const kn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-DDkiJH03.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-BilU1jFK.js"), "../fixtures/basemap/index.ts": () => import("./index-DEDB7TrJ.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BztNSdwF.js"), "../fixtures/details/index.ts": () => import("./index-BoXAfnCI.js"), "../fixtures/export-footnote/index.ts": () => import("./index-C9ap_tKQ.js"), "../fixtures/export-legend/index.ts": () => import("./index-B2UyRejT.js"), "../fixtures/export-map/index.ts": () => import("./index-CUT7B9TC.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-B2yq10qI.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-Bby_Vrij.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-CuVm93xt.js"), "../fixtures/export-title/index.ts": () => import("./index-D7wflf3f.js"), "../fixtures/export/index.ts": () => import("./index-COq7Di8u.js"), "../fixtures/extentguard/index.ts": () => import("./index-_PEPdAHA.js"), "../fixtures/gazebo/index.ts": () => import("./index-jWCuOzbQ.js"), "../fixtures/geosearch/index.ts": () => import("./index-DMOsBXOw.js"), "../fixtures/grid/index.ts": () => import("./index-Bz6eZZ-1.js"), "../fixtures/help/index.ts": () => import("./index-Bu2NiIAP.js"), "../fixtures/hilight/index.ts": () => import("./index-ec1LX365.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-BKm4fovO.js"), "../fixtures/legend/index.ts": () => import("./index-DFRLdh2D.js"), "../fixtures/mapnav/index.ts": () => import("./index-oH4HV_CG.js"), "../fixtures/metadata/index.ts": () => import("./index-Db3XPaFo.js"), "../fixtures/northarrow/index.ts": () => import("./index-KeKF0Dp9.js"), "../fixtures/overviewmap/index.ts": () => import("./index-C9ipmH2G.js"), "../fixtures/panguard/index.ts": () => import("./index-DC8TjFEU.js"), "../fixtures/scrollguard/index.ts": () => import("./index-2uoJIz3Q.js"), "../fixtures/settings/index.ts": () => import("./index-BuROGI3k.js"), "../fixtures/snowman/index.ts": () => import("./index-B2FL7bIL.js"), "../fixtures/swipe/index.ts": () => import("./index-D3v0HWy5.js"), "../fixtures/wizard/index.ts": () => import("./index-17ztk9sZ.js") });
class Mn extends Z {
  /**
...
const Gn = /* @__PURE__ */ Me(Fn, [["render", Dn], ["__scopeId", "data-v-a3c61802"]]), Un = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-B33erNzX.js"), "../fixtures/basemap/screen.vue": () => import("./screen-BiajhYxh.js"), "../fixtures/export/screen.vue": () => import("./screen-v5U7nA-a.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-DCUMrkZO.js"), "../fixtures/grid/screen.vue": () => import("./screen-5hffSS63.js"), "../fixtures/help/screen.vue": () => import("./screen-B8Ny8OAL.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen--wge6Q_c.js"), "../fixtures/legend/screen.vue": () => import("./screen-Dt3dq3rb.js"), "../fixtures/metadata/screen.vue": () => import("./screen-CaIzyWyn.js"), "../fixtures/settings/screen.vue": () => import("./screen-Becj4Kdu.js"), "../fixtures/wizard/screen.vue": () => import("./screen-CelmN-3h.js") });
class At extends Z {
  /**
   * ID of this panel.
   *
...
var it = { major: "4", minor: "11", patch: "0-beta", timestamp: "Mon Feb 3 17:07:41 2025 -0500", hash: "44d428ddc2b979e7e89ea9b2bde4a086526fcfa1" };
console.info(
