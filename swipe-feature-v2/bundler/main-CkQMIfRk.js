import { TinyEmitter as ls } from "tiny-emitter";
import { defineStore as U, createPinia as cs } from "pinia";
import { ref as h, computed as k, markRaw as se, defineComponent as O, inject as be, reactive as ye, watch as Et, onBeforeUnmount as ct, resolveDirective as M, withDirectives as P, openBlock as y, createElementBlock as A, withKeys as us, withModifiers as Qt, onMounted as We, normalizeClass as oe, normalizeStyle as Ri, createVNode as re, Transition as Ci, withCtx as ee, createBlock as j, resolveDynamicComponent as ps, mergeProps as ds, useCssVars as hs, TransitionGroup as Oi, Fragment as Ve, renderList as ut, unref as _, nextTick as $t, renderSlot as Ce, createElementVNode as m, vShow as fs, resolveComponent as Z, createTextVNode as it, toDisplayString as G, createCommentVNode as D, onUpdated as ms, Teleport as gs, getCurrentInstance as ys, useTemplateRef as ui, createApp as ki, toRaw as Ee, h as vs, render as Ut, defineAsyncComponent as bs } from "vue";
import As from "@arcgis/core/Basemap";
import xt from "@arcgis/core/Color";
import dt from "@arcgis/core/config";
import pi from "@arcgis/core/geometry/Extent";
import ws from "@arcgis/core/geometry/Multipoint";
import Es from "@arcgis/core/geometry/Point";
import Xt from "@arcgis/core/geometry/Polygon";
import Mi from "@arcgis/core/geometry/Polyline";
...
class F extends He {
  ...
  static fromArcServer(e, t) {
    return F.fromESRI(pi.fromJSON(e), t);
  }
...
class Se extends Re {
  ...
  constructor(e) {
    ...
    this._width = typeof t > "u" || t < 0 ? 0.75 : t, this._colour = new Oe(e.colour), this._miter = e.miter ?? 2, this._cap = e.cap || zi.ROUND, this._join = e.join || Bi.ROUND;
  }
...
class mt extends Re {
  ...
  _fillStyle;
  constructor(e) {
    super(), e = e || {}, e.fill || (e.fill = {}), this._fillColour = new Oe(e.fill.colour), this._fillStyle = e.fill.style || Vi.SOLID, this._outlineStyle = new Se(e.outline);
  }
  /** Returns the specified colour */
  get fillColour() {
  ...
  toESRI() {
    const e = this.outline.toESRI(), t = new xt(this.fillColour.rgba), i = new Ms();
  ...
  async projectExtent(e, t) {
    const i = (f, w, v) => {
      ...
      if (v === 1)
        return [f, R, w];
      if (v > 1) {
        const L = i(f, R, v - 1), C = i(R, w, v - 1);
        return L.concat(C.slice(1));
      }
      return [[]];
    }, s = t.toPolygonArray().pop() || [];
    let o = [];
    [0, 1, 2, 3].map((f) => i(s[f], s[f + 1], 3).slice(1)).forEach((f) => o = o.concat(f));
    const n = new ie("warpy", [o], t.sr, !0), l = await this.projectGeometry(e, n), a = l.toArray().pop() || [], c = a.map((f) => f[0]), u = a.map((f) => f[1]), p = Math.min.apply(null, c), d = Math.max.apply(null, c), b = Math.min.apply(null, u), g = Math.max.apply(null, u);
...
class Xs {
  ...
  sharedUtils;
  constructor() {
    this.proj = new Qs(), this.geom = new Js(), this.sharedUtils = new Zs();
  }
  defaultTileSchemas() {
...
const Tt = U("appbar", () => {
  ...
  const r = h([]), e = h([]), t = h([]);
  function i(p) {
    return Bt(r.value, (d) => d?.uid === p);
  }
  function s(p) {
    return Bt(r.value, (d) => d?.id === p);
  }
  function o(p) {
    return Bt(
      r.value,
  ...
  function i(n) {
    if (r.value = { ...r.value, [n.id]: se(n) }, n.id in e.value)
      e.value[n.id].resolveMe(se(n));
    else {
      const l = new Y();
      l.resolveMe(se(n)), e.value = {
        ...e.value,
        [n.id]: l
      };
    }
...
class rr extends J {
  ...
  _funCounter;
  constructor(e) {
    super(e), this._eventBus = new ls(), this._eventRegister = [], this._funCounter = 1, this._nameRegister = Object.values(E).filter((t) => typeof t == "string" && t.indexOf("/") > -1);
  }
  /**
   ...
   */
  addDefaultEvents(e) {
    return (!Array.isArray(e) || e.length === 0) && (e = Object.values(Yt)), e.map((t) => this.defaultHandlerFactory(t));
  }
  /**
      ...
      case "ramp_layer_remove_checks_grid":
        t = (i) => {
          if (this.$iApi.fixture.get("grid")) {
            const s = Ht(this.$vApp.$pinia), o = s.getGridId(i.id);
            if (o === void 0) return;
...
function ar() {
  return Us({
    ...
    locale: document.documentElement.getAttribute("lang") || mi,
    fallbackLocale: mi,
    globalInjection: !0,
    //@ts-ignore
    messages: or,
...
const Lt = U("maptip", () => {
  ...
  __name: "esri-map",
  setup(r) {
    const e = Lt(), t = be("iApi"), i = k(() => e.maptipPoint), s = k(() => e.maptipInstance), o = k(() => e.content), n = ye([]);
    n.push(
      Et(i, () => {
        if (i.value) {
          let a, c;
...
const cr = ["data-cy"], Ji = /* @__PURE__ */ O({
    ...
    return (a, c) => {
      ...
      return y(), A("div", {
        ...
        re(Ci, {
          ...
          default: ee(() => [
            P((y(), j(ps(r.panel.route.screen), ds({ class: "h-full" }, r.panel.route.props, { panel: r.panel }), null, 16, ["panel"])), [
              [u]
            ])
          ]),
          _: 1
  ...
  const r = h(void 0), e = h(void 0), t = h(0), i = h(0), s = h(!1), o = h(!0), n = h({}), l = h({}), a = h([]), c = h([]), u = h([]), p = h(1), d = k(() => i.value);
  function b(x) {
    return x === "xs" && u.value.length > 0 ? [u.value.slice().pop()] : u.value;
  }
  function g(x) {
    const $ = [];
    return x.forEach((de) => {
      de in l.value && $.push(l.value[de].getPromise());
    }), $;
  }
  function f(x) {
    Mt(x), Q(), e.value = void 0;
  }
  function w(x) {
    Pt(x), Q();
  }
  ...
  function Q() {
    let x = t.value;
    const $ = [], de = 350, Ze = 12, li = 600;
    for (let Me = a.value.length - 1; Me >= 0; Me--) {
      const Ke = a.value[Me];
      let Ie = Ke.width || de;
      if (s.value ? Ie = x : Ie += Ze, Ke.id === "grid" && (Ie = Math.max(Math.min(Ie, x), li)), (x >= Ie && !s.value || $.length === 0) && (x -= Ie, $.unshift(Ke)), Ke.id === "grid" && x < li)
        break;
    }
    if (r.value && //@ts-ignore
    !$.includes(r.value) && !s.value) {
      let Me;
      for (let ci = 0; ci < $.length - 1 && x < (r.value.width || de) + Ze; ci++)
        Me = $.shift(), x += Me.width || de;
      x >= (r.value.width || de) ? $.unshift(r.value) : e.value || (Me = $.shift(), $.unshift(r.value));
      const Ke = a.value.indexOf(r.value), Ie = a.value.indexOf(Me), Gt = a.value.slice();
      Ie > -1 && (Gt.splice(Ke, 1), Gt.splice(Ie, 0, r.value)), a.value = Gt;
    }
    i.value = x, u.value = $;
  }
  function pt(x) {
    if (n.value = { ...n.value, [x.id]: x }, x.id in l.value)
      l.value[x.id].resolveMe(x);
    else {
      const $ = new Y();
      $.resolveMe(x), l.value = {
        ...l.value,
  ...
  function Mt(x) {
    x.teleport ? c.value = [...c.value, x] : (a.value = [...a.value, x], e.value = x);
  }
  function Pt(x) {
    if (x.teleport) {
      const $ = c.value.indexOf(x);
      $ !== -1 && (c.value = [...c.value.slice(0, $), ...c.value.slice($ + 1)]);
    } else {
      const $ = a.value.indexOf(x);
      $ !== -1 && (a.value = [...a.value.slice(0, $), ...a.value.slice($ + 1)]);
    }
  }
  function Nt(x, $) {
    const de = a.value.indexOf(x), Ze = $ === "right" ? 1 : -1;
    u.value.includes(a.value[de + Ze]) && ([a.value[de], a.value[de + Ze]] = [
      a.value[de + Ze],
      a.value[de]
    ]);
  }
  function Ft(x) {
    n.value[x.id] !== void 0 && delete n.value[x.id], l.value[x.id] !== void 0 && delete l.value[x.id];
    const $ = u.value.indexOf(x);
    $ !== -1 && (u.value = [...u.value.slice(0, $), ...u.value.slice($ + 1)]), r.value && r.value.id == x.id && (r.value = void 0);
  }
  function Dt(x) {
    l.value = {
      ...l.value,
  ...
  setup(r) {
    ...
    const e = qe(), t = be("iApi"), i = h(), s = k(() => e.opacity), o = k(() => e.mobileView);
    We(() => {
    ...
    const n = (u) => (
      ...
      const [d, b] = [u.children[0].getBoundingClientRect(), u.parentElement.getBoundingClientRect()];
      u.style.width = `${d.width}px`, u.style.height = `${d.height}px`, u.style.left = `${d.left - b.left}px`, u.style.position = "absolute", c(u, p, [
        [0, -6],
        [1, 0]
      ]);
    }, c = (u, p, d) => {
    ...
    return (u, p) => (y(), j(Oi, {
      ...
      default: ee(() => [
        (y(!0), A(Ve, null, ut(n(_(t).screenSize), (d) => (y(), j(Ji, {
          key: `${d.id}`,
          panel: d
        }, null, 8, ["panel"]))), 128))
      ]),
  ...
  for (const [i, s] of e)
    t[i] = s;
  return t;
}, pr = /* @__PURE__ */ ke(ur, [["__scopeId", "data-v-5faba096"]]), dr = ["content", "aria-label"], ti = /* @__PURE__ */ O({
  ...
  setup(r) {
    const e = h(!1), t = h(null), i = ye([]), s = h(), o = h(), n = h(), l = r;
    i.push(
      Et(e, () => {
        t.value.update();
      })
    ...
    return We(() => {
      window.addEventListener(
        ...
        n.value && o.value && (t.value = qs(n.value, o.value, {
  ...
  const r = h([]), e = h({}), t = k(() => r.value.length >= 99 ? 99 : r.value.length);
  function i(c) {
    r.value = [c, ...r.value];
  }
  function s(c) {
    if (r.value.includes(c)) {
      ...
      c instanceof Zi && a(c), u > -1 && r.value.splice(u, 1);
    }
  }
  function o(c) {
    e.value[c.id] = c;
...
}), hr = { class: "h-full flex flex-col" }, fr = { class: "w-full flex mb-6" }, mr = ["content", "aria-label"], gr = /* @__PURE__ */ O({
  __name: "screen",
  props: {
    panel: {
      type: Object,
  ...
  setup(r) {
    const e = _e(), { t } = q(), i = k(() => e.notificationNumber), s = () => e.clearAll();
    return (o, n) => {
      const l = Z("panel-screen"), a = M("tippy");
...
const vr = ["content"], br = { class: "flex items-center text-left" }, Ar = { class: "select-text cursor-text" }, wr = ["content"], Er = {
  key: 0,
  class: "text-left"
}, xr = /* @__PURE__ */ O({
      ...
      return P((y(), A("li", {
        ...
        m("div", br, [
          m("span", null, [
            ...
            m("span", Ar, G(r.notification.message), 1)
          ]),
          ...
          P((y(), A("button", {
            type: "button",
            onClick: c[0] || (c[0] = Qt((p) => n(r.notification), ["stop"])),
        ...
        r.notification.messageList && s.value ? (y(), A("div", Er, [
          (y(!0), A(Ve, null, ut(r.notification.messageList, (p, d) => (y(), A("p", {
  ...
  setup(r) {
    ...
    const n = k(() => e.notificationStack);
    return (l, a) => {
      const c = M("focus-item"), u = M("focus-list"), p = M("tippy");
      return y(), A("div", null, [
        n.value.length > 0 ? P((y(), A("ul", {
          key: 0,
          content: _(t)("panels.controls.items"),
          ref_key: "el",
          ref: i
        }, [
          (y(!0), A(Ve, null, ut(n.value, (d, b) => (y(), A(Ve, {
            key: d.message + b
          }, [
            b > 0 ? (y(), A("div", _r)) : D("", !0),
            P(re(xr, {
...
}), Tr = { class: "flex items-center hover:text-white" }, Lr = ["aria-label"], $r = {
  key: 0,
  class: "number rounded-full w-18 text-white"
}, Rr = { class: "notification-dropdown pointer-events-auto bg-white rounded text-center text-black w-500 h-256 flex flex-col p-0" }, Cr = { class: "pb-8 border-b border-gray-600" }, Or = { class: "absolute flex right-3 top-3" }, kr = ["content", "aria-label"], Mr = /* @__PURE__ */ O({
  __name: "caption-button",
  setup(r) {
    const e = _e(), { t } = q(), i = k(() => e.notificationNumber), s = () => e.clearAll();
    return (o, n) => {
      const l = Z("close"), a = M("tippy");
      return y(), j(ti, {
        position: "top-start",
        ...
        header: ee(() => [
          m("div", Tr, [
            ...
            i.value && i.value > 0 ? (y(), A("span", $r, G(i.value), 1)) : D("", !0)
          ])
        ]),
        default: ee((c) => [
          m("div", Rr, [
            m("div", null, [
              m("h4", Cr, G(_(t)("notifications.title")), 1),
              m("div", Or, [
                P((y(), A("button", {
                  type: "button",
                  onClick: s,
            ...
            re(Ki, { class: "overflow-y-auto h-230" })
          ])
        ]),
        _: 1
      }, 8, ["tooltip"]);
...
}), Pr = /* @__PURE__ */ ke(Mr, [["__scopeId", "data-v-3623a7d2"]]), Nr = { class: "flex hover:text-white" }, Fr = ["aria-label"], Dr = { class: "about-ramp-dropdown pointer-events-auto bg-white rounded w-256 h-50" }, Gr = { class: "pb-8 border-b border-gray-600 mb-10" }, Ur = { class: "absolute right-5 top-5" }, Br = { class: "select-text" }, zr = { class: "font-bold cursor-text" }, Vr = { class: "text-sm cursor-text" }, jr = { class: "text-sm cursor-text" }, qr = /* @__PURE__ */ O({
  ...
  setup(r) {
    const { t: e } = q(), t = k(() => `${ht.major}.${ht.minor}.${ht.patch}`), i = k(() => ht.hash.slice(0, 9)), s = k(() => {
    ...
    return (o, n) => {
      const l = Z("close"), a = Z("dropdown-menu"), c = M("focus-item");
      return P((y(), j(a, {
        ...
        default: ee((u) => [
          m("div", Dr, [
            m("div", null, [
              ...
              m("div", Br, [
                m("div", null, [
                  m("span", zr, G(t.value), 1),
                  m("span", Vr, " [" + G(i.value) + "] ", 1)
                ]),
                m("div", null, [
                  m("span", jr, G(s.value), 1)
                ]),
...
}), Wr = /* @__PURE__ */ ke(qr, [["__scopeId", "data-v-dd0345a4"]]), Hr = { class: "map-caption absolute bottom-0 h-29 sm:h-38 flex justify-end pointer-events-auto cursor-default select-none text-gray-200 bg-black-75 left-0 right-0 py-2 sm:py-6" }, Yr = {
  key: 0,
  class: "relative top-2 sm:top-1 ml-4 sm:ml-0 shrink-0"
}, Jr = ["href", "aria-label"], Zr = ["src", "alt"], Kr = {
  key: 1,
  class: "relative ml-10 top-2 text-sm sm:text-base"
}, Qr = { class: "flex min-w-fit justify-end" }, Xr = {
  key: 0,
  class: "pl-8 px-14 sm:block display-none relative top-2"
}, eo = ["aria-pressed", "aria-label", "content"], to = { class: "relative top-1 text-sm sm:text-base" }, io = { class: "text-gray-200 hover:text-white text-sm sm:text-base pb-5" }, so = ["onClick"], ro = {
  key: 0,
  class: "sr-only"
}, oo = /* @__PURE__ */ O({
  __name: "map-caption",
  setup(r) {
    const e = Fe(), t = ue(), { t: i } = q(), s = be("iApi"), o = k(() => e.scale), n = k(() => e.attribution), l = k(() => e.coords), a = k(() => e.langtoggle), c = k(() => t.config.map), u = h([]), p = ye([]);
    p.push(
      Et(c, (f) => {
    ...
    return (f, w) => {
      const v = Z("dropdown-menu"), R = M("truncate"), L = M("tippy");
      return y(), A("div", Hr, [
        re(Wr, {
          class: "sm:block display-none ml-8 mr-4",
          position: "top-end"
        }),
        re(Pr, { class: "sm:block display-none" }),
        n.value?.logo.disabled ? D("", !0) : (y(), A("span", Yr, [
          m("a", {
        ...
        n.value?.text.disabled ? D("", !0) : P((y(), A("span", Kr, [
        ...
        m("div", Qr, [
          l.value?.disabled ? D("", !0) : P((y(), A("div", Xr, [
          ...
          o.value?.disabled ? D("", !0) : P((y(), A("button", {
            key: 1,
            type: "button",
          ...
          a.value?.disabled ? D("", !0) : (y(), j(v, {
            ...
            header: ee(() => [
              m("span", io, G(_(i)("map.language.short")), 1)
            ]),
            default: ee(() => [
              (y(!0), A(Ve, null, ut(u.value, (C, W) => (y(), A("a", {
                key: `${C}-${W}`,
                class: oe(["flex-auto items-center text-sm sm:text-base cursor-pointer", { "font-bold": C === _(s).$i18n.locale.value }]),
                href: "javascript:;",
                onClick: (Q) => d(C)
              }, [
                it(G(_(i)("map.language." + C)) + " ", 1),
                C === _(s).$i18n.locale.value ? (y(), A("span", ro, G(_(i)("map.language.curr")), 1)) : D("", !0)
              ], 10, so))), 128))
            ]),
            _: 1
          }, 8, ["tooltip", "ariaLabel"]))
  ...
  setup(r) {
    ...
    return (o, n) => {
      ...
      return P((y(), A("button", {
        ...
        s.value && s.value > 0 ? (y(), A("span", ao, G(s.value), 1)) : D("", !0)
      ], 8, no)), [
        [l]
      ]);
    };
  }
}), co = /* @__PURE__ */ ke(lo, [["__scopeId", "data-v-a451db5c"]]), uo = { class: "flex items-center mb-20" }, po = { class: "text-xl" }, ho = /* @__PURE__ */ O({
  __name: "keyboard-instructions",
  setup(r) {
    const e = be("iApi"), { t } = q(), i = h(!1), s = h(["app", "lists", "map"]), o = h([]), n = h(null), l = h(null);
    We(() => {
      o.value.push(
    ...
    return (c, u) => {
      ...
      return i.value ? (y(), A("div", {
        ...
        m("div", {
          ...
          m("div", uo, [
            m("h2", po, G(_(t)("keyboardInstructions.title")), 1),
            re(p, {
              class: "ml-auto",
              onClick: u[0] || (u[0] = (d) => i.value = !1)
            })
          ]),
          (y(!0), A(Ve, null, ut(s.value, (d) => (y(), A("p", {
...
}), Xe = U("instance", () => ({ started: h(!1) })), fo = { class: "h-full relative" }, mo = { class: "inner-shell absolute top-0 left-0 h-full w-full pointer-events-none" }, go = { class: "absolute top-8 w-full flex justify-center" }, yo = {
  key: 1,
  class: "w-full h-full"
}, vo = /* @__PURE__ */ O({
  __name: "shell",
  setup(r) {
    const e = be("iApi"), t = Xe(), i = me(), s = qe(), { t: o } = q(), n = k(() => i.items.appbar), l = () => {
      e?.event.emit("openKeyboardInstructions");
    }, a = () => (
      // @ts-ignore
      s.teleported
    );
    return (c, u) => (y(), A("div", fo, [
      m("div", mo, [
        ...
        re(ho),
        re(pr, { class: "panel-stack sm:flex absolute inset-0 overflow-hidden sm:p-12 z-10 sm:pl-80 xs:pl-40 sm:pb-48 xs:pb-28 xs:pr-0 sm:pr-40" }),
        n.value ? D("", !0) : (y(), j(co, { key: 0 })),
        re(oo, { class: "z-30" })
      ]),
      _(t).started ? (y(), j(lr, { key: 0 })) : (y(), A("div", yo, u[1] || (u[1] = [
        m("div", { class: "spinner relative inset-x-1/2 inset-y-9/20" }, null, -1)
      ]))),
      (y(!0), A(Ve, null, ut(a(), (p) => (y(), j(gs, {
...
}), bo = /* @__PURE__ */ ke(vo, [["__scopeId", "data-v-6c131943"]]), Ao = O({
  name: "App",
  components: { Shell: bo },
  setup() {
    const r = ys();
    We(() => {
      new Yi().observe(r?.proxy?.$refs["app-size"]), zs({
        aria: {
          content: "labelledby"
        },
        theme: "ramp4",
...
const So = /* @__PURE__ */ ke(Ao, [["render", xo]]), we = "focus-list", Be = "focus-item", _o = "focus-icon", Io = "focus-container", ot = `[${we}],[${Io}]`, vt = "truncate-text", bt = "show-truncate", tt = "focused", Jt = `button,input,select,a,textarea,[contenteditable],[${we}],[${_o}],[tabIndex]`, To = {
  mounted(r, e) {
    +r.getAttribute("tabindex") <= 0 && r.setAttribute("tabindex", "0"), r.toggleAttribute(we, !0), new Lo(r, e.value);
  },
  updated(r) {
    Qi(r);
  }
...
function Qi(r) {
  r.querySelectorAll(Jt).forEach((t) => {
...
class Lo {
  ...
  setTabIndex(e, t = this.element) {
    t.querySelectorAll(Jt).forEach((s) => {
    ...
    if (i.length !== 0)
      switch (e.key) {
        ...
        case " ":
          ...
          break;
        case "Tab":
          this.highlightedItem !== this.element && (this.highlightedItem.querySelectorAll(Jt).length === 0 && this.defocusItem(this.highlightedItem), e.shiftKey && (e.preventDefault(), e.stopPropagation(), this.defocusItem(this.highlightedItem), this.highlightedItem = this.element, this.element.removeAttribute("aria-activedescendant"), this.element.focus()));
      }
  }
  /**
   ...
   */
  onFocus() {
    this.highlightedItem && !this.isClicked && (this.highlightedItem._tippy && this.highlightedItem._tippy.show(), this.highlightedItem.getAttribute(Be) === bt && this.highlightedItem.querySelector(`[${vt}]`)?._tippy?.show()), this.isClicked = !1, this.element.hasAttribute("aria-activedescendant") || this.highlightedItem === this.element ? this.highlightedItem !== this.element && this.focusItem(this.highlightedItem) : this.setAriaActiveDescendant(this.highlightedItem), Qi(this.element), this.highlightedItem && this.highlightedItem !== this.element && this.highlightedItem.setAttribute("tabindex", "-1");
  }
  /**
...
const gi = "focus-item", $o = {
  beforeMount(r, e) {
    r.hasAttribute("id") || r.setAttribute("id", Ro()), e.value ? r.setAttribute(gi, e.value) : r.toggleAttribute(gi, !0);
  }
};
function Ro() {
  let r;
...
const ii = "focus-container", Xi = "focus-list", Co = "focus-icon", zt = `[${Xi}],[${ii}]`, yi = `button,input,select,a,textarea,[contenteditable],.ag-tab-guard,[${Xi}],[${ii}],[${Co}],[tabIndex]`;
let Vt = [];
const Oo = {
  mounted(r) {
    [...document.querySelectorAll(".inner-shell")].some((t) => t.contains(r)) && Vt.push(new ko(r));
  },
  beforeUnmount(r) {
    Vt = Vt.filter((e) => e.element === r ? (e.removeEventListeners(), !1) : !0);
  }
};
class ko {
  element;
   ...
   */
  constructor(e) {
    this.element = e, this.element.toggleAttribute(ii, !0), this.element.tabIndex = 0, setTimeout(() => this.disableTabbing(), 600);
    const t = this;
  ...
  enableTabbing() {
    ...
    return Array.prototype.map.call(this.element.querySelectorAll(yi), (t) => {
      (t.closest(zt) === this.element || t.closest(zt) === t && t.parentElement.closest(zt) === this.element) && t.offsetParent && (t.tabIndex = 0, e === void 0 && (e = t));
    }), e;
  }
}
const Mo = "truncate-text", Po = "truncate-trigger", No = {
  beforeMount(r, e) {
    !r.classList.contains("truncate") && !e.value?.noTruncateClass && r.classList.add("truncate"), r.toggleAttribute(Mo, !0);
  },
  mounted(r, e) {
    let t;
    e.value && e.value.externalTrigger && (t = r.closest(`[${Po}]`)), Vs(r, {
      content: vi(r.textContent),
      onShow: Fo,
      allowHTML: !0,
  ...
  updated(r, e) {
    r._tippy && (r._tippy.setContent(vi(r.textContent)), e.value && e.value.options && r._tippy.setProps(e.value.options));
  },
  unmounted(r) {
...
const Do = ["content"], Go = {
  ...
  setup(r, { expose: e }) {
    const { t } = q(), i = qe(), s = Tt(), o = be("iApi"), n = ui("el"), l = ui("contentEl"), a = h();
    e({ el: n });
    const c = r, u = k(() => o?.fixture.get("appbar") ? s.temporary : []), p = k(() => i.mobileView), d = k(() => i.reorderable), b = (v) => v.scrollHeight > v.clientHeight, g = () => !p.value && !c.panel.teleport, f = (v) => {
      c.panel.move(v), v === "left" && $t(() => {
        (n.value?.querySelector(".move-left")).focus();
      });
    }, w = k(() => c.screenId ? c.panel.screens[c.screenId][o?.$i18n.locale.value ?? "en"] : null);
    return We(() => {
      ...
      const L = Z("back"), C = Z("panel-options-menu"), W = Z("left"), Q = Z("right"), pt = Z("pin"), Mt = Z("expand"), Pt = Z("minimize"), Nt = Z("close"), Ft = M("truncate"), Dt = M("focus-item"), x = M("tippy");
      return P((y(), A("div", {
        ...
        r.header ? (y(), A("header", Go, [
          re(L, {
            class: oe(r.panel.teleport ? "display-none" : "block sm:display-none"),
            onClick: R[0] || (R[0] = ($) => r.panel.close())
          }, null, 8, ["class"]),
          P((y(), A("h2", Uo, [
            v.$slots.header ? Ce(v.$slots, "header", { key: 0 }) : (y(), A("div", Bo, G(_(t)(r.panel.alertName)), 1))
          ])), [
            [Ft]
          ]),
          v.$slots.controls ? (y(), j(C, { key: 0 }, {
            default: ee(() => [
              Ce(v.$slots, "controls")
            ]),
            _: 3
        ...
        r.content ? (y(), A("div", {
          ...
          v.$slots.content ? Ce(v.$slots, "content", { key: 0 }) : w.value ? (y(), A("div", {
            key: 1,
            innerHTML: w.value.innerHTML
          }, null, 8, Vo)) : D("", !0)
        ], 512)) : D("", !0),
        r.footer ? P((y(), A("div", jo, [
          Ce(v.$slots, "footer")
        ])), [
          [Dt]
        ]) : D("", !0)
...
}), Wo = { class: "relative" }, Ho = ["content", "aria-label"], Yo = ["transform"], Jo = /* @__PURE__ */ O({
  __name: "pin",
  props: {
    active: Boolean
  },
...
}), Xo = { class: "relative" }, en = ["content", "aria-label"], tn = /* @__PURE__ */ O({
  __name: "back",
  props: {
    active: Boolean
  },
...
}), sn = { class: "w-32 h-32" }, rn = ["content"], on = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
...
}), fn = { class: "relative" }, mn = ["content", "aria-label"], gn = /* @__PURE__ */ O({
  __name: "left",
  props: {
    active: Boolean
  },
...
}), vn = /* @__PURE__ */ ke(yn, [["__scopeId", "data-v-51e22a4a"]]), bn = {
  key: 0,
  xmlns: "http://www.w3.org/2000/svg",
  viewBox: "0 0 24 24",
  ...
  setup(r) {
    ...
    return (s, o) => {
      ...
      return y(), j(n, {
        ...
        default: ee(() => [
          _(t).isFullscreen ? (y(), A("svg", bn, o[0] || (o[0] = [
            m("path", {
              d: "M0 0h24v24H0z",
              fill: "none"
            }, null, -1),
  ...
  tabindex: "-1"
}, _n = ["content", "aria-label"], In = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  class: "relative",
  tabindex: "-1"
}, Ln = ["aria-label", "content"], $n = /* @__PURE__ */ O({
  __name: "button",
  props: {
    onClickFunction: {
      type: Function,
  ...
  setup(r) {
    const e = be("iApi"), t = r, i = () => e?.event.emit(E.APPBAR_BUTTON_CLICK, t.id);
    return (s, o) => {
      const n = M("focus-item"), l = M("tippy");
      return y(), A("div", Tn, [
        P((y(), A("button", {
          type: "button",
...
}), Rn = /* @__PURE__ */ ke($n, [["__scopeId", "data-v-457cd2d4"]]), Cn = U("areas-of-interest", () => ({ areas: h([]) })), On = U("export", () => {
  const r = h({
    title: !0,
    map: !0,
    mapElements: !0,
...
class Pn {
  ...
  constructor(e, t) {
    Rt.get(t).then((i) => {
      i.data.definitions.forEach((s) => jt[e][s.code] = s.description), Object.keys(jt[e]).forEach((s) => {
        this.list[s] = jt[e][s];
      }), this.listFetched = !0;
    });
  }
  ...
  fsaToProvinces(e) {
    const t = {};
    let i = Mn[e.substring(0, 1).toUpperCase()];
...
function Gn(r, e) {
  ...
  if (t.test(e) && !r.disabledSearchTypes.includes("LAT/LNG")) {
    const o = e.slice(0, -1);
    return new Un(r, o);
  } else return s.test(e) && !r.disabledSearchTypes.includes("FSA") ? new Bn(r, e) : i.test(e) && !r.disabledSearchTypes.includes("NTS") ? new zn(r, e.substring(0, 6).toUpperCase()) : new Vn(r, e);
}
class Ot {
  config;
  query;
...
const bi = "https://geogratis.gc.ca/services/geolocation/@{language}/locate", Ai = "https://geogratis.gc.ca/services/geoname/@{language}/geonames.json", wi = "https://geogratis.gc.ca/services/geoname/@{language}/codes/province.json", Ei = "https://geogratis.gc.ca/services/geoname/@{language}/codes/concise.json", jn = {
  10: "NL",
  11: "PE",
  12: "NS",
  13: "NB",
...
class xi {
  ...
  constructor(e, t) {
    ...
    l ? (i = l.geoLocation ? l.geoLocation : bi, s = l.geoNames ? l.geoNames : Ai, o = l.geoProvince ? l.geoProvince : wi, n = l.geoTypes ? l.geoTypes : Ei) : (i = bi, s = Ai, o = wi, n = Ei), i = i.replace("@{language}", e), s = s.replace("@{language}", e), o = o.replace("@{language}", e), n = n.replace("@{language}", e);
    const a = t?.settings;
    let c, u, p, d, b;
   ...
   */
  query(e) {
    return Gn(this.config, e.toUpperCase()).onComplete.then((t) => {
      let i = [];
...
const qn = U("geosearch", () => {
  const r = h(new xi("en", void 0)), e = h({
    type: "",
    province: "",
    extent: void 0
  }), t = h(!1), i = h(""), s = h(""), o = h(""), n = h([]), l = h([]), a = h(!1), c = h([]), u = k(
    () => new Promise((L) => {
      r.value.fetchProvinces().then((C) => {
        C.sort((W, Q) => W.name > Q.name ? 1 : -1), L(C);
      });
    })
  ), p = k(
    () => new Promise((L) => {
  ...
  function b(L) {
    ...
    else if (C && C !== o.value || L) {
      const W = setInterval(() => {
        r.value.config.provinces.listFetched && r.value.config.types.typesFetched && (clearInterval(W), r.value.query(`${C}*`).then((Q) => {
          c.value = Q.failedServs, o.value = C, l.value = Q.results;
          const pt = Si(
            t.value,
            //@ts-ignore
            e.value,
  ...
  function v(L) {
    ...
    L = L.normalize("NFD").replace(/[\u0300-\u036f]/g, "").toLowerCase(), s.value = Array.from(L).map((W) => Object.keys(C).includes(W) ? "[" + W + C[W] + "]" : W.replace(/["$!*+?^{}()|[\]\\]/g, "").replace(/[.\\]/g, "\\$&").trim()).join("");
  }
  function R(L) {
...
}), Wn = U("help", () => ({ location: h("./help/") }));
var es = /* @__PURE__ */ ((r) => (r.Visibility = "visibilityButton", r.Expand = "expandButton", r))(es || {}), Zt = /* @__PURE__ */ ((r) => (r.Item = "item", r.Placeholder = "placeholder", r.Error = "error", r))(Zt || {});
class ts extends J {
  _uid;
  _name;
  _type;
  ...
  toggleVisibility(e, t = !0) {
    if (this.visibility !== e) {
      if (this._visibility = e ?? !this.visibility, !this.exclusive)
        ...
        if (this._lastVisible && (!(this._lastVisible instanceof Pe) || this._lastVisible.layerControlAvailable(V.Visibility)))
          this._lastVisible.toggleVisibility(!0);
        else {
          const i = this.children.find(
            (s) => !(s instanceof Pe) || s.layerControlAvailable(V.Visibility)
          );
   ...
   */
  checkVisibility(e) {
    this instanceof Pe && !this.layerControlAvailable(V.Visibility) || (this.exclusive ? e.visibility ? (this.children.forEach((t) => {
...
var Hn = /* @__PURE__ */ ((r) => (r.Title = "title", r.Text = "text", r.Image = "image", r.Markdown = "markdown", r.Template = "template", r))(Hn || {});
class _i extends ts {
  _infoType;
  ...
  constructor(e, t, i) {
    ...
    }), (t.infoType || t.content) && (this._controls = t.controls?.slice() ?? [es.Expand]), super.load();
  }
...
const Yn = U("legend", () => {
  ...
  function o(a) {
    if (a.parent === void 0)
      ...
      if (!(a.item instanceof _i) && !(a.item instanceof Pe)) {
  ...
  function a(c) {
    switch (l.value) {
      ...
      case te.FORMAT:
        ...
        break;
      case te.CONFIGURE:
        c === te.UPLOAD ? (t.value = "", i.value = "", o.value = null, s.value = !0, n.value = {
          config: r,
          configOptions: []
        }, l.value = te.UPLOAD) : c === te.FORMAT && (n.value = {
          config: r,
          configOptions: []
...
class ta {
  ...
  _isFullscreen;
  constructor(e, t, i) {
    this.event = new rr(this);
    const s = ia(e, this);
    this.$vApp = s.app, this.$element = s.element, this.$i18n = s.i18n, this.$rootEl = s.app.$root?.$el, this.fixture = new Za(this), this.panel = new Ka(this), this.geo = new Ya(this), this.ui = {
      ...
      escapeHtml: () => "",
      isPlainText: () => !0
    }, this.notify = new yr(this), this._isFullscreen = Ae.isEnabled && !!this.$vApp.$root && Ae.isFullscreen && Ae.element === this.$vApp.$root.$el, Ae.isEnabled && Ae.onchange(() => {
   ...
   */
  initialize(e, t, i) {
    const s = ue(this.$vApp.$pinia), o = qe(this.$vApp.$pinia), n = Lt(this.$vApp.$pinia);
    if (t?.configs !== void 0) {
   ...
   */
  reload(e, t) {
    const i = Xe(this.$vApp.$pinia), s = _e(this.$vApp.$pinia), o = ue(this.$vApp.$pinia), n = me(this.$vApp.$pinia), l = xe(this.$vApp.$pinia), a = Ht(this.$vApp.$pinia), c = !!e;
    ...
    if (!([
      ...
      switch (e) {
        ...
        case "overviewmap":
          return Qn(this.$vApp.$pinia);
        case "scrollguard":
          return Xn(this.$vApp.$pinia);
        case "wizard":
          return ea(this.$vApp.$pinia);
        // core stores
        case "config":
  ...
  setLanguage(e) {
    if (this.$i18n.locale.value === e)
      return;
    const t = ue(this.$vApp.$pinia), i = _e(this.$vApp.$pinia), s = t.registeredLangs;
...
function ia(r, e) {
  ...
  t.use(({ store: n }) => {
    const l = hi(n.$state);
    n.$reset = () => n.$patch(hi(l));
  });
  const i = ar(), s = ki(So).use(i).use(Bs, {
    directive: "tippy",
    // => v-tippy
    component: "tippy"
    // => <tippy/>
  }).use(t);
  s.directive("focus-container", Oo), s.directive("focus-list", To), s.directive("focus-item", $o), s.directive("truncate", No), s.component("panel-screen", qo), s.component("pin", Jo), s.component("close", Qo), s.component("back", tn), s.component("expand", an), s.component("panel-options-menu", vn), s.component("dropdown-menu", ti), s.component("minimize", un), s.component("right", hn), s.component("left", gn), s.component("fullscreen-nav-button", wn), s.component("geolocator-nav-button", En), s.component("home-nav-button", xn), s.component("mapnav-button", In), s.component("appbar-button", Rn), s.component("transition", Ci), s.component("transition-group", Oi), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.provide("iApi", e);
  const o = s.mount(r);
...
class sa {
  ...
  config;
  constructor(e) {
    this.config = e, this.esriBasemap = new As({
...
class ra extends J {
  ...
  createMap(e, t) {
    ...
    const i = {};
    this.esriMap = se(new Rs(i)), this.pointZoomScale = e.pointZoomScale && e.pointZoomScale > 0 ? e.pointZoomScale : 5e4, this._targetDiv = t, this.createMapView(e.initialBasemapId);
  }
  /**
  ...
  updateAttribution(e) {
    ...
    if (e ? (e.logo ? e.logo.disabled ? s.logo.disabled = !0 : (s.logo.altText = e.logo.altText || i.altText, s.logo.link = e.logo.link || i.link, s.logo.value = e.logo.value || i.value) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value), e.text ? e.text.disabled ? s.text.disabled = !0 : s.text.value = e.text.value || t.value : s.text.value = t.value, Fe(this.$vApp.$pinia).setAttribution(s)) : (s.logo.altText = i.altText, s.logo.link = i.link, s.logo.value = i.value, s.text.value = t.value), !e || e.text?.disabled || !e.text) {
      ...
      Promise.all(a).then((c) => {
        o = c.filter((p) => p?.copyright).map((p) => p.copyright).join(" | "), s.text.value = o || s.text.value || t.value, Fe(this.$vApp.$pinia).setAttribution(s);
      });
    }
  }
  /**
...
class aa extends ra {
   ...
   */
  constructor(e) {
    super(e), this.maptip = new oa(e), this.caption = new na(e), this.mapMouseThrottle = 0;
  }
  /**
   * Will generate the actual Map control objects and construct it on the page
   * @param {RampMapConfig} config the config for the map
  ...
  setBasemap(e) {
    ...
    if (o) {
      ...
      this.applyBasemap(i), this.esriView.background = new Ds({
  ...
  addLayer(e, t = void 0) {
    return new Promise((i, s) => {
      ...
      xe(this.$vApp.$pinia).addLayer(e, t), this.$iApi.event.emit(E.LAYER_REGISTERED, e);
      const n = Date.now();
      let l = 0;
      const a = setInterval(() => {
...
const la = { geometryType: "point", renderer: { type: "simple", symbol: { type: "esriSMS", style: "esriSMSCircle", color: [67, 100, 255, 200], size: 7, outline: { color: [0, 0, 0, 255], width: 1 } } } }, ca = { geometryType: "polyline", renderer: { type: "simple", symbol: { type: "esriSLS", style: "esriSLSSolid", color: [90, 90, 90, 200], width: 2 } } }, ua = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [76, 76, 125, 200], outline: { type: "esriSLS", style: "esriSLSSolid", color: [110, 110, 110, 255], width: 1 } } } }, pa = { geometryType: "polygon", renderer: { type: "simple", symbol: { type: "esriSFS", style: "esriSFSSolid", color: [255, 0, 0, 64], outline: { type: "esriSLS", style: "esriSLSSolid", color: [240, 128, 128, 255], width: 1 } } } }, da = {
  circlePoint: la,
  solidLine: ca,
  outlinedPoly: ua,
  boundingBoxPoly: pa
...
class va extends J {
  ...
  extractCsvFields(e, t = ",") {
    return fi.dsvFormat(t).parseRows(e)[0].map((s) => ({ name: s, type: Le.STRING }));
  }
  /**
  ...
  filterCsvLatLonFields(e, t = ",") {
    const i = fi.dsvFormat(t).parseRows(e), s = i[0], o = {
  ...
  async geoJsonToEsriJson(e, t) {
    ...
    fa(e);
    const l = e.features[0].geometry.type, a = ha[l], c = JSON.parse(
      // @ts-ignore
      JSON.stringify(da[a])
    );
    if (t) {
    ...
    s || (s = I.parseGeoJsonCrs(e.crs)), n.renderer = Cs.fromJSON(c.renderer), n.fields = (n.fields || []).concat(
...
class Aa extends J {
  ...
  async loadWfsData(e, t = -1, i = 0, s = 1e3, o = {
    ...
    const c = new It(e).updateQuery(l), [u, p] = await je(Rt.get(c));
    if (!p)
...
class wa extends J {
  ...
  ogc;
  constructor(e) {
    super(e), this.files = new va(e), this.ogc = new Aa(e);
  }
  /**
  ...
  async loadLayerMetadata(e) {
    ...
    if (o.name = s.name || "", o.currentVersion = s.currentVersion || -1, o.minScale = s.effectiveMinScale || s.minScale || 0, o.maxScale = s.effectiveMaxScale || s.maxScale || 0, o.extent = s.extent ? F.fromArcServer(s.extent, "layer_extent") : void 0, o.defaultVisibility = s.defaultVisibility ?? !0, o.canModifyLayer = s.canModifyLayer ?? !0, s.type === "Feature Layer" || s.type === "Table") {
      if (o.dataFormat = X.ESRI_FEATURE, o.displayField = s.displayField || "", Array.isArray(s.fields)) {
        const n = s.fields.map((a) => $s.fromJSON(a));
        o.fields = n.map((a) => ({
          name: a.name,
          alias: a.alias,
          type: a.type,
...
class is extends si {
  ...
  constructor(e, t) {
    super(e, t), this.name = e.name || "", this.geomType = T.NONE, this.dataFormat = X.UNKNOWN, this.layerType = S.UNKNOWN, this.layerFormat = fe.UNKNOWN;
...
class ri extends Ye {
  ...
  filter;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.geomType = T.UNKNOWN, this.serviceUrl = "", this.fieldList = "", this.canModifyLayer = !0, this.filter = new qi(e.permanentFilteredQuery || "", e.initialFilteredQuery || ""), this.hovertips = e.state?.hovertips ?? !0, this.attribs = new rs();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  async loadLayerMetadata(e = {}) {
    ...
    if (!(t < this.lastCancel))
      if (this.geomType = i.geometryType, this.attribs.quickCache = new ns(this.geomType), this.scaleSet.minScale = i.minScale, this.scaleSet.maxScale = i.maxScale, this.dataFormat = i.dataFormat, this.extent = this.extent ?? i.extent, this._serverVisibility = i.defaultVisibility, this.dataFormat === X.ESRI_FEATURE) {
        ...
        this.attribs.attLoader = new os(this.$iApi, o), this.origRampConfig.name || (this.name = i.name ?? this.id);
      } else
  ...
  async getGraphic(e, t) {
    ...
    if (t.getStyle) {
      const u = Ee(this.renderer.getGraphicSymbol(i));
...
class Ea extends Ye {
  constructor(e, t) {
    super(e, t), this.dataFormat = X.ESRI_FEATURE, this.layerFormat = fe.GRAPHIC, this.hovertips = !1;
  }
  _graphics = [];
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
  ...
  async addGraphic(e) {
    ...
    const i = t.filter((a) => this._graphics.findIndex((u) => u.id === a.id) === -1 ? (this._graphics.push(a), !0) : (console.error(`Attempting to add graphic with id '${a.id}' that has already been added.`), !1)), s = this.$iApi.geo.map.getSR(), o = i.map((a) => this.$iApi.geo.proj.projectGeometry(s, a.geometry)), n = await Promise.all(o), l = i.map((a, c) => {
      const u = new ve(n[c], a.id, a.attributes);
...
class xa extends Ea {
  ...
  async onInitiate() {
    this.esriLayer = se(new Is(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Je extends ri {
  ...
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.isFile = !0, this.dataFormat = X.ESRI_FEATURE, this.layerFormat = fe.FEATURE, this.tooltipField = "", this.layerIdx = 0, e.identifyMode && e.identifyMode !== K.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = K.HYBRID;
  }
  async reload() {
  ...
  async onInitiate() {
    ...
    this.esriJson = await this.$iApi.geo.layer.files.geoJsonToEsriJson(this.sourceGeoJson, e), this.esriLayer = se(new Pi(this.makeEsriLayerConfig(this.origRampConfig))), this.esriJson = void 0, this.origRampConfig.caching || delete this.origRampConfig.rawData, delete this.sourceGeoJson, await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  extractLayerMetadata() {
    ...
    this.attribs.attLoader = new Ba(this.$iApi, i);
  }
  async getGraphic(e, t) {
    let i;
  ...
  applySqlFilter(e = []) {
    ...
    Ee(this.esriView).filter = new Ns({
      where: t
    });
  }
}
...
class Ra extends ri {
  tooltipField;
  constructor(e, t) {
    super(e, t), this.dataFormat = X.ESRI_FEATURE, this.tooltipField = "", this.supportsIdentify = !0, this.layerType = S.FEATURE, this.layerFormat = fe.FEATURE, e.identifyMode && e.identifyMode !== K.NONE ? this.identifyMode = e.identifyMode : this.identifyMode = K.HYBRID;
  }
  async onInitiate() {
    se(this.esriLayer = new Pi(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Ca extends Ye {
  ...
  async onInitiate() {
    this.esriLayer = se(new Ni(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  onLoadActions() {
    ...
    const o = [], n = (a, c) => {
      ...
      if (a.sublayers && a.sublayers.length > 0) {
        ...
        this._sublayers[u] || (this._sublayers[u] = new Oa(
          {
            id: `${this.id}-${u}`,
            index: u,
...
class Oa extends ri {
  tooltipField;
  constructor(e, t, i) {
    if (super(e, t), this.layerType = S.SUBLAYER, this.layerFormat = fe.MAPIMAGE, this.isSublayer = !0, this.layerIdx = e.index, this.parentLayer = i, this.dataFormat = X.ESRI_FEATURE, this.supportsFeatures = !0, this.tooltipField = "", this.hovertips = !1, this.url = this.parentLayer?.url, this.canReload = !!(this.url || this.origRampConfig.caching), !i.esriLayer)
...
class ka extends Ye {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.OSM, this.layerFormat = fe.OSM, this.dataFormat = X.OSM_TILE, this.supportsFeatures = !1;
  }
  async onInitiate() {
    this.esriLayer = se(new Fi(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Ma extends Ye {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.IMAGERY, this.layerFormat = fe.IMAGERY, this.dataFormat = X.ESRI_RASTER;
  }
  async onInitiate() {
    this.esriLayer = se(new Ts(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Pa extends Ye {
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !1, this.layerType = S.TILE, this.layerFormat = fe.TILE, this.dataFormat = X.ESRI_TILE;
  }
  async onInitiate() {
    this.esriLayer = se(new Di(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
...
class Na extends Ye {
  ...
  mimeType;
  constructor(e, t) {
    super(e, t), this.supportsIdentify = !0, this.layerType = S.WMS, this.layerFormat = fe.WMS, this.mimeType = e.featureInfoMimeType || "", this.sublayerNames = [], this.dataFormat = X.OGC_RASTER, this.identifyMode = K.GEOMETRIC;
  }
  async onInitiate() {
    this.esriLayer = se(new Ls(this.makeEsriLayerConfig(this.origRampConfig))), await super.onInitiate();
  }
  /**
   * Take a layer config from the RAMP application and derives a configuration for an ESRI layer
   *
  ...
  getFeatureInfo(e, t, i) {
    ...
    }), Object.keys(v).forEach((L) => l[L] = v[L]), Ge(o.url.split("?")[0], {
      query: l,
      responseType: f
    });
  }
...
class ss extends is {
  ...
  // ----------- LAYER CONSTRUCTION AND INITIALIZAION -----------
  constructor(e, t) {
    super(e, t), this.dataFormat = X.ESRI_FEATURE, this.layerFormat = fe.NOLAYER, this.drawState = ce.NOT_VISUAL, this.attribs = new rs(), this.supportsFeatures = !0, this.mapLayer = !1, this.isFile = !1, this._visibility = e.state?.visibility ?? !0, this.expectedTime.draw = 0;
  }
  async onInitiate() {
    if (this.sourceJson) {
...
class Ga extends ss {
  ...
  serviceUrl;
  constructor(e, t) {
    super(e, t), this.layerType = S.DATATABLE, this.serviceUrl = e.url, this.filter = new qi(e.permanentFilteredQuery || "", e.initialFilteredQuery || "");
  }
  async onInitiate() {
  }
  onLoadActions() {
    const e = super.onLoadActions(), t = Date.now(), s = this.$iApi.geo.shared.parseUrlIndex(this.serviceUrl).index || 0, o = this.$iApi.geo.layer.loadLayerMetadata(this.serviceUrl).then((l) => {
      ...
      this.attribs.attLoader = new os(this.$iApi, a), this.attribs.quickCache = new ns(this.geomType);
...
class kt {
  ...
  parent;
  constructor(e) {
    this.parent = e, this.symbol = new Wt();
  }
  match(e) {
    return !!e;
  }
...
class qa extends ni {
  ...
  constructor(e, t, i = !1) {
    if (super(e, t, i), this.valField = this.cleanFieldName(e.field, t), e.classBreakInfos.forEach((s, o) => {
      const n = o === 0, l = new Li(this, s.minValue, s.maxValue, n);
  ...
  async symbolToSvg(e) {
    ...
    const o = Qe(s).size(this.CONTAINER_SIZE, this.CONTAINER_SIZE).viewbox(0, 0, this.CONTAINER_SIZE, this.CONTAINER_SIZE), n = {
      ...
      "picture-fill"() {
        ...
        return t.$iApi.geo.shared.convertImagetoDataURL(g).then((C) => {
          const W = o.pattern(
            f,
            w,
            (Q) => (
...
class Ya extends J {
   ...
   */
  constructor(e) {
    super(e), this.geom = nt.geom, this.proj = nt.proj, this.shared = nt.sharedUtils, this.map = new aa(e), this.layer = new wa(e), this.attributes = new Ua(e), this.query = new Ha(e), this.symbology = new Wa(e), Array.isArray(dt.request.interceptors) || (dt.request.interceptors = []), dt.request.interceptors.push({
      before: (t) => {
...
const Ja = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-_PGyK2Z0.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-DreT2RLw.js"), "../fixtures/basemap/index.ts": () => import("./index-CXiSjRtv.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BxFEJcfS.js"), "../fixtures/details/index.ts": () => import("./index-Dt9hsYIJ.js"), "../fixtures/export-footnote/index.ts": () => import("./index-BI7QYf6n.js"), "../fixtures/export-legend/index.ts": () => import("./index-U8Y-OD7Y.js"), "../fixtures/export-map/index.ts": () => import("./index-DMeDuvGU.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-CyLPIaxg.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-DpUb3jWO.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-BGqeJrVz.js"), "../fixtures/export-title/index.ts": () => import("./index-2XfzGabY.js"), "../fixtures/export/index.ts": () => import("./index-Q6HquP0y.js"), "../fixtures/extentguard/index.ts": () => import("./index-DPspA4Rv.js"), "../fixtures/gazebo/index.ts": () => import("./index-D9fEuhoq.js"), "../fixtures/geosearch/index.ts": () => import("./index-l2oymGXL.js"), "../fixtures/grid/index.ts": () => import("./index-XNFDyU6W.js"), "../fixtures/help/index.ts": () => import("./index-DL26EcCx.js"), "../fixtures/hilight/index.ts": () => import("./index-CoDT_b7J.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-CEGwJrwZ.js"), "../fixtures/legend/index.ts": () => import("./index-Cy61eb8B.js"), "../fixtures/mapnav/index.ts": () => import("./index-DHYUzdcD.js"), "../fixtures/metadata/index.ts": () => import("./index-DoeNmZIA.js"), "../fixtures/northarrow/index.ts": () => import("./index-BTmp_Hxk.js"), "../fixtures/overviewmap/index.ts": () => import("./index-D2U0LzUt.js"), "../fixtures/panguard/index.ts": () => import("./index-Dc0CL_-1.js"), "../fixtures/scrollguard/index.ts": () => import("./index-DxmByTzn.js"), "../fixtures/settings/index.ts": () => import("./index-BTN4QwoQ.js"), "../fixtures/snowman/index.ts": () => import("./index-Dszj5IWP.js"), "../fixtures/swipe/index.ts": () => import("./index-DJriMkct.js"), "../fixtures/wizard/index.ts": () => import("./index-CF3LwtpP.js") });
class Za extends J {
  /**
  ...
  async add(e, t) {
    ...
    if (t) {
      ...
      const s = (await Ja[`../fixtures/${e}/index.ts`]()).default;
      i = new s(e, this.$iApi);
    }
    return me(this.$vApp.$pinia).addFixture(i), this.$iApi.event.emit(E.FIXTURE_ADDED, i), this.$iApi.geo.map.created && i.initialized?.(), i;
  }
  /**
  ...
  remove(e) {
    ...
    return me(this.$vApp.$pinia).removeFixture(t), this.$iApi.event.emit(E.FIXTURE_REMOVED, t), t;
  }
...
class ai extends J {
  ...
  mount(e, { props: t, children: i, element: s, app: o } = {}) {
    let n = s, l = vs(e, t, i);
    return o && o._context && (l.appContext = o._context), n ? Ut(l, n) : Ut(l, n = document.createElement("div")), { vNode: l, destroy: () => {
      n && Ut(null, n), n = null, l = null;
    }, el: n };
  }
  /**
...
const tl = /* @__PURE__ */ ke(Xa, [["render", el], ["__scopeId", "data-v-a3c61802"]]), il = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-B5k8dqtm.js"), "../fixtures/basemap/screen.vue": () => import("./screen-B8nISW-W.js"), "../fixtures/export/screen.vue": () => import("./screen-B1fUhPOl.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-ChA7Nrkz.js"), "../fixtures/grid/screen.vue": () => import("./screen-BFRRfaTk.js"), "../fixtures/help/screen.vue": () => import("./screen-DMWE3V-z.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-5VgTlP7G.js"), "../fixtures/legend/screen.vue": () => import("./screen-Kf0444zk.js"), "../fixtures/metadata/screen.vue": () => import("./screen-zSfN3k0o.js"), "../fixtures/settings/screen.vue": () => import("./screen-CrGfit5Z.js"), "../fixtures/wizard/screen.vue": () => import("./screen-CiNAUbtZ.js") });
class wt extends J {
  /**
   * ID of this panel.
   *
  ...
  registerScreen(e) {
    ...
    if (tr(t) || er(t))
      ...
      let s;
      typeof t == "string" ? s = il[`../fixtures/${t}`]() : s = t();
      const o = new Promise((n, l) => {
        s.then((a) => {
          this.loadedScreens.push(e), n(ir(a) ? a.default : a);
        }), s.catch((a) => l(a));
      });
      i = bs({
...
function rl(r) {
  ...
  return nl(r.services, e), ol(r.map, e), al(r.ui, e), r.plugins && ll(r.plugins, e), e;
}
function ol(r, e) {
  ...
  return r.controls && r.controls.length > 0 && (e.controls = lt(r.controls, t), r.controls.includes("visibility") && e.controls.push("visibilityButton"), (r.controls.length !== 1 || r.controls[0] !== "visibility") && console.warn(
    ...
    if (i.layerId)
      ...
      typeof i.collapse < "u" && console.warn(
        ...
        o.layerId ? s.children.push($i(o)) : s.children.push(Kt(o));
      }), e.children.push(s);
    } else
...
function qt(r) {
  ...
  )), typeof r.stateOnly < "u" && (e.cosmetic = r.stateOnly), r.initialFilteredQuery && (e.initialFilteredQuery = r.initialFilteredQuery), cl(r, e), (typeof r.toggleSymbology < "u" || r.table) && (e.fixtures = {}, typeof r.toggleSymbology < "u" && (e.fixtures.legend = {
...
var et = { major: "4", minor: "11", patch: "0-beta", timestamp: "Fri Dec 20 17:27:58 2024 -0500", hash: "b253f5d5d60dc592f2a57810083786406ce4a462" };
console.info(
...
const pc = (r, e, t) => new ta(r, e, t), nt = new Xs();
export {
  te as $,
  Wr as A,
  sa as B,
