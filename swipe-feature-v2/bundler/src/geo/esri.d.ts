...
import { default as EsriSwipe } from '@arcgis/core/widgets/Swipe.js';
declare class EsriAPI {
    ...
    static Swipe(prams: __esri.SwipeProperties): Promise<EsriSwipe>;
    static Collection(): Promise<EsriCollection>;
}
export { EsriAPI, type EsriBasemap, type EsriClassBreakInfo, type EsriClassBreaksRenderer, type EsriCollection, EsriColour, type EsriColorBackground, EsriConfig, EsriExtent, type EsriFeatureFilter, type EsriFeatureLayer, type EsriField, type EsriGeometry, EsriGeometryFromJson, EsriGraphic, type EsriGraphicsLayer, type EsriImageryLayer, type EsriLOD, type EsriMap, type EsriMapImageLayer, type EsriMapView, EsriMultipoint, type EsriOpenStreetMapLayer, EsriPictureMarkerSymbol, EsriPoint, EsriPolygon, EsriPolyline, type EsriQuery, type EsriRenderer, EsriRequest, EsriSimpleFillSymbol, EsriSimpleLineSymbol, EsriSimpleMarkerSymbol, type EsriSimpleRenderer, EsriSpatialReference, type EsriSwipe, type EsriSymbol, EsriSymbolFromJson, type EsriTileLayer, type EsriUniqueValueInfo, type EsriUniqueValueRenderer, type EsriWMSLayer, type EsriWMSSublayer };
