import { fq as q, bx as v, cy as K } from "./main-BinSYbpH.js";
import { y as Q } from "./DoubleArray-DlsUhFmB.js";
import { i as W, a as X } from "./MeshLocalVertexSpace-CFeSyhxi.js";
import { f as Z, l as ee } from "./vec3-DS396eh9.js";
import "./sphere-jbQXLe9L.js";
import "./I3SUtil-Bzimg_ZX.js";
var U, D;
(function(e) {
...
function te() {
  return _ || (_ = new Promise((e) => import("./i3s-B4JLSg43.js").then((t) => t.i).then(({ default: t }) => {
...
async function pe(e) {
  ...
  let s;
  const [{ projectBuffer: I }, { initializeProjection: M }] = await Promise.all([import("./main-BinSYbpH.js").then((a) => a.r9), import("./main-BinSYbpH.js").then((a) => a.ra)]);
  await M(c, l);
  const g = [0, 0, 0];
  ...
  if (i.type === "georeferenced" && i.origin == null) {
    ...
    const a = i.type === "georeferenced" ? W.fromJSON(i) : X.fromJSON(i), { project: m } = await import("./projection-DIa9tJ4R.js"), d = m({ positions: f, transform: t ? { localMatrix: t } : void 0, vertexSpace: a, inSpatialReference: c, outSpatialReference: l, localMode: u });
...
//# sourceMappingURL=SceneLayerWorker-DtrB9w4p.js.map
