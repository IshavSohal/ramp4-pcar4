import { jr as A, js as y, bY as M, fU as $, hG as O, g1 as D, hH as j } from "./main-BinSYbpH.js";
import { _ as k } from "./screen.vue_vue_type_script_setup_true_lang-Ct61Tp6n.js";
var H = { exports: {} };
(function(S, i) {
  (function(n, a) {
    a();
...
class _ extends M {
   ...
   */
  async make(i, n) {
    const { fabric: a } = await import("./fabric-CXQnHAT1.js").then((g) => g.f);
...
class I extends _ {
  ...
  async needed() {
    const i = (await import("./index-D_tTI5aD.js")).default, n = (await import("./index-CvyQyctE.js")).default, a = (await import("./index-Dj3txnVy.js")).default, w = (await import("./index-CmpXQYR0.js")).default, p = (await import("./index-B73c6ki-.js")).default, r = (await import("./index-D7blEWqK.js")).default, b = (await import("./index-Cjc0iXDs.js")).default;
...
//# sourceMappingURL=index-BAD7Gzst.js.map
