import { a9 as Et, fq as bt } from "./main-BinSYbpH.js";
...
async function Mt() {
  gt = await (Et("esri-csp-restrictions") ? await import("./libtess-asm-D7efyNC_.js").then((i) => i.l) : await import("./libtess-UPSPL5LW.js").then((i) => i.l)).default({ locateFile: (i) => bt(`esri/core/libs/libtess/${i}`) });
}
function $t(x, i) {
...
//# sourceMappingURL=TurboLine-ghiGZvT2.js.map
