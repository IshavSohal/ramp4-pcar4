import { C as x, a1 as C, bn as J, bo as K, bp as E, bx as I, Z as M, eU as W, eY as Q, eZ as U } from "./main-BinSYbpH.js";
import { a as G, b as u, r as c, I as j, m as P, G as w, ab as V, P as Z, N as T, U as v, A as H, E as D, X as k, w as X, v as Y, ac as _, ad as F, ae as z } from "./arcadeUtils-rxEEvlHv.js";
import { l as B } from "./portalUtils-D1YCey6F.js";
import { p as L, n as O } from "./project-Bt40Pl-5.js";
import { s as $, m as nn, t as tn, p as en, c as an } from "./GraphQueryStreaming-Dv00P8ci.js";
let f = null;
async function rn(n) {
...
async function q(n, t) {
  ...
  return await a.load(), f === null && (f = await import("./knowledgeGraphService-D0_s6LrR.js").then((i) => i.k)), await f.fetchKnowledgeGraph(a.url);
}
...
function pn(n) {
  n.mode === "async" && (n.functions.knowledgegraphbyportalitem = function(t, a) {
    ...
    return n.standardFunctionAsync(t, a, async (i, s, e) => {
      ...
      f === null && (f = await import("./knowledgeGraphService-D0_s6LrR.js").then((o) => o.k));
      let p = null;
      const m = Z(e[2], null);
...
//# sourceMappingURL=knowledgegraph-ZS12HEME.js.map
