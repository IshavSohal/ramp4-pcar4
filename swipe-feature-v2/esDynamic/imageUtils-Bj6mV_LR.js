import { ag as m, aJ as d, $ as u, M as w, s as p } from "./main-BinSYbpH.js";
let r = null, s = !0;
function T(e, a, t) {
...
async function B(e, a) {
  ...
  if (n === "image/gif") {
    const { isAnimatedGIF: o, parseGif: c } = await import("./gif-CX6kvrBP.js");
    if (o(t)) return c(t, a);
  }
  if (i) {
    const { isAnimatedPNG: o, parseApng: c } = await import("./apng-C6s3IMpD.js");
    if (o(t)) return c(t, a);
  }
...
//# sourceMappingURL=imageUtils-Bj6mV_LR.js.map
