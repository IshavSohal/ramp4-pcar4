import { defineComponent as _, inject as C, resolveDirective as l, openBlock as i, createElementBlock as n, withDirectives as s, normalizeClass as v, unref as d, createElementVNode as o, createCommentVNode as g, toDisplayString as x, withModifiers as b, withKeys as T, vShow as z, computed as I, ref as j, onMounted as A, resolveComponent as B, createBlock as M, withCtx as w, createTextVNode as O, Fragment as S, renderList as V, createVNode as $ } from "vue";
import { E, _ as N, c as D } from "./main-BrQ-0Xn5.js";
    ...
    return (a, t) => {
      ...
      return i(), n("div", K, [
        s((i(), n("button", {
          ...
          "aria-label": d(c)("areas-of-interest.select"),
...
}), R = /* @__PURE__ */ N(Q, [["__scopeId", "data-v-d6bb6779"]]), U = { class: "h-600 overflow-y-auto" }, W = { class: "mx-5" }, X = { key: 0 }, ge = /* @__PURE__ */ _({
  __name: "screen",
  props: {
    panel: {
      type: Object
  ...
  setup(e) {
    ...
    return A(() => {
      ...
      return i(), M(u, { panel: e.panel }, {
        header: w(() => [
          O(x(d(c)("areas-of-interest.title")), 1)
        ]),
        content: w(() => [
          o("div", U, [
            o("div", W, [
