...
function Ua(r, e) {
  ...
  s.directive("focus-container", go), s.directive("focus-list", po), s.directive("focus-item", fo), s.directive("truncate", Ao), s.component("panel-screen", $o), s.component("pin", Mo), s.component("close", Fo), s.component("back", Uo), s.component("expand", qo), s.component("panel-options-menu", ia), s.component("dropdown-menu", ei), s.component("minimize", Yo), s.component("right", Ko), s.component("left", ea), s.component("fullscreen-nav-button", oa), s.component("geolocator-nav-button", aa), s.component("home-nav-button", na), s.component("mapnav-button", ua), s.component("appbar-button", fa), s.component("transition", $i), s.component("transition-group", Ci), s.config.globalProperties.$iApi = e, s.config.globalProperties.$pinia = t, s.config.idPrefix = `ramp-${r.id || e.geo.shared.generateUUID()}`, s.provide("iApi", e);
  const o = s.mount(r);
...
const kn = /* @__PURE__ */ Object.assign({ "../fixtures/appbar/index.ts": () => import("./index-DNkdvRRv.js"), "../fixtures/areas-of-interest/index.ts": () => import("./index-ShxY7-TH.js"), "../fixtures/basemap/index.ts": () => import("./index-C1BiVR3j.js"), "../fixtures/crosshairs/index.ts": () => import("./index-BrNvJxC0.js"), "../fixtures/details/index.ts": () => import("./index-BuzWM2mg.js"), "../fixtures/export-footnote/index.ts": () => import("./index-SbBVDOCi.js"), "../fixtures/export-legend/index.ts": () => import("./index-DCQ-nN1T.js"), "../fixtures/export-map/index.ts": () => import("./index-CUCoxfjR.js"), "../fixtures/export-northarrow/index.ts": () => import("./index-9RwwacsL.js"), "../fixtures/export-scalebar/index.ts": () => import("./index-CM_qSZJo.js"), "../fixtures/export-timestamp/index.ts": () => import("./index-DvpGFCVm.js"), "../fixtures/export-title/index.ts": () => import("./index-BCccn46_.js"), "../fixtures/export/index.ts": () => import("./index-B5le2iNF.js"), "../fixtures/extentguard/index.ts": () => import("./index-lYx0JeDM.js"), "../fixtures/gazebo/index.ts": () => import("./index-4AJ3E8qf.js"), "../fixtures/geosearch/index.ts": () => import("./index-DTeAmV_i.js"), "../fixtures/grid/index.ts": () => import("./index-7OJgb7is.js"), "../fixtures/help/index.ts": () => import("./index-JrtYvGZh.js"), "../fixtures/hilight/index.ts": () => import("./index-DqaYXS8E.js"), "../fixtures/layer-reorder/index.ts": () => import("./index-UEE9-KAl.js"), "../fixtures/legend/index.ts": () => import("./index-1I1SNq8d.js"), "../fixtures/mapnav/index.ts": () => import("./index-AZH9TOoK.js"), "../fixtures/metadata/index.ts": () => import("./index-B7k74XIR.js"), "../fixtures/northarrow/index.ts": () => import("./index-DcSGM7UB.js"), "../fixtures/overviewmap/index.ts": () => import("./index-6p9eRlVN.js"), "../fixtures/panguard/index.ts": () => import("./index-CtvuYaiT.js"), "../fixtures/scrollguard/index.ts": () => import("./index-DlSRrkxu.js"), "../fixtures/settings/index.ts": () => import("./index-CMGr8cej.js"), "../fixtures/snowman/index.ts": () => import("./index-jt2qW8jA.js"), "../fixtures/wizard/index.ts": () => import("./index-M4YFLp0X.js") });
class Mn extends Z {
  /**
...
const Gn = /* @__PURE__ */ Ne(Fn, [["render", Dn], ["__scopeId", "data-v-a3c61802"]]), Un = /* @__PURE__ */ Object.assign({ "../fixtures/areas-of-interest/screen.vue": () => import("./screen-B_6PJ-Gl.js"), "../fixtures/basemap/screen.vue": () => import("./screen-CGLOjfVQ.js"), "../fixtures/export/screen.vue": () => import("./screen-ZHKvdbsa.js"), "../fixtures/geosearch/screen.vue": () => import("./screen-1V72qXGV.js"), "../fixtures/grid/screen.vue": () => import("./screen-9JxLs2nm.js"), "../fixtures/help/screen.vue": () => import("./screen-njT6uJVK.js"), "../fixtures/layer-reorder/screen.vue": () => import("./screen-5f4R1rs7.js"), "../fixtures/legend/screen.vue": () => import("./screen-YnICy8ax.js"), "../fixtures/metadata/screen.vue": () => import("./screen-C4Al9Zpn.js"), "../fixtures/settings/screen.vue": () => import("./screen-C4mbas2-.js"), "../fixtures/wizard/screen.vue": () => import("./screen-CrCraJvn.js") });
class Et extends Z {
  /**
   * ID of this panel.
   *
...
var rt = { major: "4", minor: "12", patch: "0-beta", timestamp: "Wed Apr 16 14:44:31 2025 -0400", hash: "f750e8fb2c373763a82ad8abfde5d9d27cc553e9" };
console.info(
